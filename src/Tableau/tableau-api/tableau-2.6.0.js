...
!(function () {
  ...
  !(function (e) {
    ...
    var O = (a.ArgumentException = a.mkType(
      ...
      function (e, t, i) {
        k.call(this, e || 'Value does not fall within the expected range.', i),
  ...
  (e.tableauSoftware = e.tableauSoftware || {}),
    ...
    (function () {
        ...
        $ = (e.tab._Utility = t.mkType(n, 'tab._Utility', null, null, {
          ...
          noResultPromiseHelper: function (e, n, r) {
            var a = new i._Deferred(),
              s = new (t.makeGenericType(E, [Object]))(
                e,
                1,
                function (e) {
                  a.resolve();
        ...
        O = (e.tab.FilterCommandsBuilder = t.mkType(
          ...
          function () {},
          {
            ...
            createFilterCommandReturnHandler: function (e, i, n) {
              return new (t.makeGenericType(E, [Object]))(
                e,
                0,
      ...
      t.initClass(r),
        ...
        (r.$nextCommandId = 0),
        (k = window._ApiObjectRegistryGlobalState),
        t.isNullOrUndefined(k) && (k = new Object()),
        (window._ApiObjectRegistryGlobalState = k),
    ...
    (function () {
      ...
      var r = (e.tab._ApiBootstrap = t.mkType(
        ...
        k = (e.tab.FirstVizSizeKnownEvent = t.mkType(
          n,
              ...
              if (
                ...
                if (t.isValue(i)) {
                  var a = t.cast(
                    ...
                    l = a[1];
                  this.$1$FilterChangeField(
                    new E('filterchange', this.$viz, i, o, l),
                  );
                }
              }
            },
              ...
              (this.$vizSize = j.$ctor(n, e.chromeHeight)),
                t.isValue(this.$onFirstVizSizeKnownCallback) &&
                  this.$onFirstVizSizeKnownCallback(
                    new k('firstvizsizeknown', this.$viz, this.$vizSize),
                  ),
                this.$parameters.fixedSize ||
                  (this.$refreshSize(),
      ...
      t.initClass(r),
        ...
        (le.$currentVersion = new le(2, 6, 0, 'null'));
    })(),
