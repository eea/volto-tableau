...
!(function () {
  ...
  !(function (e) {
    ...
    (E.__typeName = 'ss.Exception'),
      ...
      (E.wrap = function (e) {
        return a.isInstanceOfType(e, E)
          ...
          ? new M(e.message, new T(e))
          : e instanceof RangeError
          ? new D(null, e.message, new T(e))
          : e instanceof Error
          ? new T(e)
          : new E(e.toString());
      });
    ...
    (O.__typeName = 'ss.PromiseException'),
      (a.PromiseException = O),
      a.initClass(
        O,
        a,
        {
    ...
    (T.__typeName = 'ss.JsErrorException'),
      (a.JsErrorException = T),
      a.initClass(
        T,
        a,
        {
    ...
    (D.__typeName = 'ss.ArgumentOutOfRangeException'),
      (a.ArgumentOutOfRangeException = D),
      a.initClass(D, a, {}, F);
    var z = function (e, t) {
    ...
    (j.__typeName = 'ss.AmbiguousMatchException'),
      (a.AmbiguousMatchException = j),
      a.initClass(j, a, {}, E);
    var H = function (e, t) {
      (this._getEnumerator = e), (this._this = t);
    };
    (H.__typeName = 'ss.IteratorBlockEnumerable'),
      (a.IteratorBlockEnumerable = H),
      a.initClass(
        H,
        a,
        {
  ...
  /*! API */ !(function () {
    ...
    (u.__typeName = 'tab.$DeferredUtil'),
      (u.$coerceToTrustedPromise = function (e) {
        var i;
        if (e instanceof tableauSoftware.Promise) i = t.cast(e, V);
        else if (
          (t.isValue(e) && 'function' == typeof e.valueOf && (e = e.valueOf()),
          u.$isPromise(e))
        ) {
          var n = new N();
          t.cast(e, V).then(t.mkdel(n, n.resolve), t.mkdel(n, n.reject)),
            (i = n.get_promise());
        } else i = u.$resolved(e);
        return i;
      }),
      ...
      if (
        ...
        for (var i = e, n = 0; n < i.length; n++) {
          ...
          if (!t.isValue(a.fieldName))
            throw z.createInvalidParameter('pair.fieldName');
          if (!t.isValue(a.value)) throw z.createInvalidParameter('pair.value');
          var s = new xe(a.fieldName, a.value);
          this.$collection._add(s.fieldName, s);
        }
      else this.$tupleId = e;
    };
    (m.__typeName = 'tab.$MarkImpl'),
      (m.$processSelectedMarks = function (e) {
        var i = new r._Collection();
        if (t.isNullOrUndefined(e) || P.isNullOrEmpty(e.marks)) return i;
        for (var n = 0; n < e.marks.length; n++) {
          ...
          for (var l = 0; l < a.pairs.length; l++) {
            var u = a.pairs[l],
              c = P.convertRawValue(u.value, u.valueDataType),
              h = new xe(u.fieldName, c);
    ...
    d.__typeName = 'tab.$MarksEventContext';
    var p = function (e, t) {
      (this.$parameterName = null),
        ue.call(this, e, null),
        (this.$parameterName = t);
    };
    p.__typeName = 'tab.$ParameterEventContext';
    var f = function (e) {
      if (
        ((this.$parameter = null),
        (this.$name = null),
        ...
        (this.$name = e.name),
        (this.$currentValue = P.getDataValue(e.currentValue)),
        (this.$dataType = W.convertParameterDataType(e.dataType)),
        (this.$allowableValuesType = W.convertParameterAllowableValuesType(
        ...
        for (var i = 0; i < e.allowableValues.length; i++) {
          ...
          this.$allowableValues.push(P.getDataValue(n));
        }
      }
      'range' === this.$allowableValuesType &&
        ((this.$minValue = P.getDataValue(e.minValue)),
        (this.$maxValue = P.getDataValue(e.maxValue)),
        (this.$stepSize = e.stepSize),
        ('date' === this.$dataType || 'datetime' === this.$dataType) &&
          t.isValue(this.$stepSize) &&
          t.isValue(e.dateStepPeriod) &&
          (this.$dateStepPeriod = W.convertPeriodType(e.dateStepPeriod)));
    };
    f.__typeName = 'tab.$ParameterImpl';
    var g = function () {};
    (g.__typeName = 'tab.$PublicEnums'),
      (g.$tryNormalizeEnum = function (e) {
        return function (i, n) {
          if (t.isValue(i))
            for (
      ...
      (g.$normalizeEnum = function (e) {
        return function (t, i) {
          var n = {};
          if (!g.$tryNormalizeEnum(e).call(null, t, n))
            throw z.createInvalidParameter(i);
          return n.$;
        };
      }),
      (g.$isValidEnum = function (e) {
        return function (t) {
          return g.$tryNormalizeEnum(e).call(null, t, {});
        };
      });
    var $ = function () {};
    ($.__typeName = 'tab._ApiBootstrap'),
      ($.initialize = function () {
        v.registerCrossDomainMessageRouter(function () {
          return new s();
        });
      }),
      (e.tab._ApiBootstrap = $);
    ...
    (_.__typeName = 'tab._ApiCommand'),
      (_.generateNextCommandId = function () {
        var e = 'cmd' + _.$nextCommandId;
        return _.$nextCommandId++, e;
      }),
      (_.parse = function (e) {
        var i,
          n,
          r = e.indexOf(String.fromCharCode(44));
        if (r < 0) return (i = t.cast(e, String)), new _(i, null, null, null);
        i = t.cast(e.substr(0, r), String);
        var a,
          s = e.substr(r + 1);
        if ((r = s.indexOf(String.fromCharCode(44))) < 0)
          return new _(i, (n = s), null, null);
        n = s.substr(0, r);
        var o = s.substr(r + 1);
        if ((r = o.indexOf(String.fromCharCode(44))) < 0)
          return new _(i, n, (a = o), null);
        a = o.substr(0, r);
        var l = o.substr(r + 1);
        return (
          (_.lastResponseMessage = e),
          'api.GetClientInfoCommand' === i &&
            (_.lastClientInfoResponseMessage = e),
          new _(i, n, a, l)
        );
      }),
      (e.tab._ApiCommand = _);
    var v = function () {};
    (v.__typeName = 'tab._ApiObjectRegistry'),
      (v.registerCrossDomainMessageRouter = function (e) {
        return v.$registerType(de).call(null, e);
      }),
      (v.getCrossDomainMessageRouter = function () {
        return v.$getSingleton(de).call(null);
      }),
      (v.disposeCrossDomainMessageRouter = function () {
        v.$clearSingletonInstance(de).call(null);
      }),
      (v.$registerType = function (e) {
        return function (i) {
          t.isNullOrUndefined(v.$creationRegistry) &&
            (v.$creationRegistry = {});
          var n = t.getTypeFullName(e),
            r = v.$creationRegistry[n];
          return (v.$creationRegistry[n] = i), r;
        };
      }),
      (v.$createType = function (e) {
        return function () {
          if (t.isNullOrUndefined(v.$creationRegistry))
            throw z.createInternalError('No types registered');
          var i = t.getTypeFullName(e),
            n = v.$creationRegistry[i];
          if (t.isNullOrUndefined(n))
            throw z.createInternalError(
      ...
      (v.$getSingleton = function (e) {
        return function () {
          t.isNullOrUndefined(v.$singletonInstanceRegistry) &&
            (v.$singletonInstanceRegistry = {});
          var i = t.getTypeFullName(e),
            n = t.cast(v.$singletonInstanceRegistry[i], e);
          return (
            t.isNullOrUndefined(n) &&
              ((n = v.$createType(e).call(null)),
              (v.$singletonInstanceRegistry[i] = n)),
            n
          );
        };
      }),
      (v.$clearSingletonInstance = function (e) {
        return function () {
          if (t.isNullOrUndefined(v.$singletonInstanceRegistry)) return null;
          var i = t.getTypeFullName(e),
            n = t.cast(v.$singletonInstanceRegistry[i], e);
          return delete v.$singletonInstanceRegistry[i], n;
        };
      }),
      (e.tab._ApiObjectRegistry = v);
    ...
    (y.__typeName = 'tab._ApiServerNotification'),
      (y.deserialize = function (e) {
        var i = JSON.parse(e),
      ...
      (e.tab._ApiServerNotification = y);
    var w = function (e) {
    ...
    (w.__typeName = 'tab._ApiServerResultParser'),
      (e.tab._ApiServerResultParser = w);
    var S = function () {
      (this.$items = []), (this.$itemMap = {});
    };
    (S.__typeName = 'tab._CollectionImpl'), (e.tab._CollectionImpl = S);
    ...
    (b.__typeName = 'tab._CustomViewImpl'),
      (b._getAsync = function (e) {
        var t = new r._Deferred();
        return (
          t.resolve(e.get__customViewImpl().get_$customView()), t.get_promise()
        );
      }),
      (b._createNew = function (e, i, n, r) {
        var a = new b(e, n.name, i);
        return (
      ...
      (b._saveNewAsync = function (e, i, n) {
        var a = new r._Deferred(),
          s = {};
        s['api.customViewName'] = n;
        var o = b.$createCustomViewCommandReturnHandler(
          'api.SaveNewCustomViewCommand',
          a,
          function (n) {
            b._processCustomViewUpdate(e, i, n, !0);
            var r = null;
      ...
      (b._showCustomViewAsync = function (e, i, n) {
        var a = new r._Deferred(),
          s = {};
      ...
      (b._makeCurrentCustomViewDefaultAsync = function (e, t) {
        var i = new r._Deferred(),
          n = b.$createCustomViewCommandReturnHandler(
      ...
      (b._getCustomViewsAsync = function (e, i) {
        var n = new r._Deferred(),
          a = new (t.makeGenericType(ae, [Object]))(
            'api.FetchCustomViewsCommand',
            0,
            function (t) {
              b._processCustomViews(e, i, t),
                n.resolve(e.get_$customViews()._toApiCollection());
            },
            function (e, t) {
              n.reject(z.create('serverError', t));
            },
          );
        return i.sendCommand(Object).call(i, null, a), n.get_promise();
      }),
      (b._processCustomViews = function (e, t, i) {
        b._processCustomViewUpdate(e, t, i, !1);
      }),
      (b._processCustomViewUpdate = function (e, i, n, a) {
        ...
        if (a && t.isValue(n.newView)) {
          var l = b._createNew(e, i, n.newView, o);
      ...
      (b.$createCustomViewCommandReturnHandler = function (e, i, n) {
        return new (t.makeGenericType(ae, [Object]))(e, 0, n, function (e, t) {
          i.reject(z.create('serverError', t));
        });
      });
    ...
    (I.__typeName = 'tab._DashboardImpl'), (e.tab._DashboardImpl = I);
    var C = function (e, t) {
      (this.$name = null),
        (this.$fields = new r._Collection()),
        (this.$isPrimary = !1),
        (this.$dataSource = null),
        A.verifyString(e, 'name'),
        (this.$name = e),
        (this.$isPrimary = t);
    };
    (C.__typeName = 'tab._DataSourceImpl'),
      (C.processDataSource = function (e) {
        for (
          var i = new C(e.name, e.isPrimary),
          ...
          var a = n[r],
            s = W.convertFieldRole(a.role),
            o = W.convertFieldAggregation(a.aggregation),
            l = new Re(i.get_dataSource(), a.name, s, o);
          i.addField(l);
        }
        return i;
      }),
      (C.processDataSourcesForWorksheet = function (e) {
        for (
      ...
      (e.tab._DataSourceImpl = C);
    var N = function () {
      (this.$promise = null),
        (this.$thenFunc = null),
        (this.$listeners = []),
        (this.$resolveFunc = null),
        (this.$promise = new V(t.mkdel(this, this.then))),
        (this.$thenFunc = t.mkdel(this, this.$preResolutionThen)),
        (this.$resolveFunc = t.mkdel(this, this.$transitionToFulfilled));
    };
    (N.__typeName = 'tab._DeferredImpl'), (e.tab._DeferredImpl = N);
    var E = function () {};
    (E.__typeName = 'tab._jQueryShim'),
      (E.isFunction = function (e) {
        return t.referenceEquals(E.type(e), E.$functionType);
      }),
      (E.isArray = function (e) {
        return t.isValue(Array.isArray)
          ? t.unbox(t.cast(Array.isArray(e), Boolean))
          : t.referenceEquals(E.type(e), E.$arrayType);
      }),
      (E.type = function (e) {
        return t.isNullOrUndefined(e)
          ? String(e)
          : E.$class2type[t.cast(E.$toString.call(e), String)] || E.$objectType;
      }),
      (E.trim = function (e) {
        return t.isValue(E.$trim)
          ? t.isNullOrUndefined(e)
            ? ''
            : t.cast(E.$trim.call(e), String)
          : t.isNullOrUndefined(e)
          ? ''
          : e.toString().replace(E.$trimLeft, '').replace(E.$trimRight, '');
      }),
      (E.parseJSON = function (e) {
        if ('string' != typeof e || t.isNullOrUndefined(e)) return null;
        if (((e = E.trim(e)), t.isValue(JSON) && t.isValue(JSON.parse)))
          return JSON.parse(e);
        if (
          E.$rvalidchars.test(
            e
              .replace(E.$rvalidescape, '@')
              .replace(E.$rvalidtokens, ']')
              .replace(E.$rvalidbraces, ''),
          )
        )
      ...
      (e.tab._jQueryShim = E);
    var A = function () {};
    (A.__typeName = 'tab._Param'),
      (A.verifyString = function (e, i) {
        if (t.isNullOrUndefined(e) || 0 === e.length)
          throw z.createInternalStringArgumentException(i);
      }),
      (A.verifyValue = function (e, i) {
        if (t.isNullOrUndefined(e))
          throw z.createInternalNullArgumentException(i);
      }),
      (e.tab._Param = A);
    var V = function (e) {
      (this.then = null), (this.then = e);
    };
    (V.__typeName = 'tab._PromiseImpl'), (e.tab._PromiseImpl = V);
    ...
    (k.__typeName = 'tab._Rect'), (e.tab._Rect = k);
    var O = function (e, t, i) {
      (this.$name = null),
        (this.$index = 0),
        (this.$isActive = !1),
        ...
        (this.$zoneId = 0),
        A.verifyValue(e, 'sheetInfoImpl'),
        A.verifyValue(t, 'workbookImpl'),
        A.verifyValue(i, 'messagingOptions'),
        (this.$name = e.name),
        (this.$index = e.index),
    ...
    (O.__typeName = 'tab._SheetImpl'),
      (O.$convertValueToIntIfValid = function (e) {
        return t.isValue(e) ? P.toInt(e) : e;
      }),
      (O.$normalizeSheetSize = function (e) {
        var i = g.$normalizeEnum(te).call(null, e.behavior, 'size.behavior'),
          n = e.minSize;
        t.isValue(n) &&
          (n = ye.$ctor(
            O.$convertValueToIntIfValid(e.minSize.width),
            O.$convertValueToIntIfValid(e.minSize.height),
          ));
        var r = e.maxSize;
        return (
          t.isValue(r) &&
            (r = ye.$ctor(
              O.$convertValueToIntIfValid(e.maxSize.width),
              O.$convertValueToIntIfValid(e.maxSize.height),
            )),
          _e.$ctor(i, n, r)
        );
      }),
      (e.tab._SheetImpl = O);
    var T = function () {};
    (T.__typeName = 'tab._SheetInfoImpl'),
      (T.$ctor = function (e, t, i, n, r, a, s, o, l) {
        var u = new Object();
        return (
          (u.name = null),
          (u.index = 0),
    ...
    var F = function (e, t, i, n, r) {
      (this.$activeStoryPointImpl = null),
        ...
        O.call(this, e, t, i),
        A.verifyValue(n, 'storyPm'),
        A.verifyValue(r, 'findSheetFunc'),
        (this.$findSheetFunc = r),
        this.update(n);
    };
    (F.__typeName = 'tab._StoryImpl'), (e.tab._StoryImpl = F);
    var R = function (e, i) {
      if (
        ((this.$caption = null),
        (this.$index = 0),
        ...
        for (
          var n = t.cast(this.$containedSheetImpl, I), r = 0;
    ...
    (R.__typeName = 'tab._StoryPointImpl'),
      (R.createContainedSheet = function (e, i, n, r) {
        var a = W.convertSheetType(e.sheetType),
          s = ve.createAutomatic(),
          o = r(e.name),
          l = t.isNullOrUndefined(o),
          u = l ? '' : o.getUrl(),
          c = T.$ctor(e.name, a, -1, s, i.get_workbook(), u, !1, l, e.zoneId);
        if ('worksheet' === e.sheetType) {
          return new L(c, i, n, null);
        }
        if ('dashboard' === e.sheetType) {
          var h = new I(c, i, n),
            m = M.$createDashboardZones(e.dashboardZones);
          return h.$addObjects(m, r), h;
        }
        throw 'story' === e.sheetType
          ? z.createInternalError(
              'Cannot have a story embedded within another story.',
            )
          : z.createInternalError("Unknown sheet type '" + e.sheetType + "'");
      }),
      (e.tab._StoryPointImpl = R);
    var D = function () {};
    (D.__typeName = 'tab._StoryPointInfoImpl'),
      (D.$ctor = function (e, t, i, n, r, a) {
        var s = new Object();
        return (
          (s.storyPointId = 0),
      ...
      (e.tab._StoryPointInfoImpl = D);
    var z = function () {};
    (z.__typeName = 'tab._TableauException'),
      (z.create = function (e, i) {
        var n = new t.Exception(i);
        return (n.tableauSoftwareErrorCode = e), n;
      }),
      (z.createInternalError = function (e) {
        return t.isValue(e)
          ? z.create(
              'internalError',
      ...
      (z.createInternalNullArgumentException = function (e) {
        return z.createInternalError("Null/undefined argument '" + e + "'.");
      }),
      (z.createInternalStringArgumentException = function (e) {
        return z.createInternalError("Invalid string argument '" + e + "'.");
      }),
      (z.createServerError = function (e) {
        return z.create('serverError', e);
      }),
      (z.createNotActiveSheet = function () {
        return z.create(
          'notActiveSheet',
          'Operation not allowed on non-active sheet',
        );
      }),
      (z.createInvalidCustomViewName = function (e) {
        return z.create(
          'invalidCustomViewName',
          'Invalid custom view name: ' + e,
        );
      }),
      (z.createInvalidParameter = function (e) {
        return z.create('invalidParameter', 'Invalid parameter: ' + e);
      }),
      (z.createInvalidFilterFieldNameOrValue = function (e) {
        return z.create(
          'invalidFilterFieldNameOrValue',
          'Invalid filter field name or value: ' + e,
        );
      }),
      (z.createInvalidDateParameter = function (e) {
        return z.create('invalidDateParameter', 'Invalid date parameter: ' + e);
      }),
      (z.createNullOrEmptyParameter = function (e) {
        return z.create(
          'nullOrEmptyParameter',
          'Parameter cannot be null or empty: ' + e,
        );
      }),
      (z.createMissingMaxSize = function () {
        return z.create(
          'missingMaxSize',
          'Missing maxSize for SheetSizeBehavior.ATMOST',
        );
      }),
      (z.createMissingMinSize = function () {
        return z.create(
          'missingMinSize',
          'Missing minSize for SheetSizeBehavior.ATLEAST',
        );
      }),
      (z.createMissingMinMaxSize = function () {
        return z.create(
          'missingMinMaxSize',
          'Missing minSize or maxSize for SheetSizeBehavior.RANGE',
        );
      }),
      (z.createInvalidRangeSize = function () {
        return z.create(
          'invalidSize',
          'Missing minSize or maxSize for SheetSizeBehavior.RANGE',
        );
      }),
      (z.createInvalidSizeValue = function () {
        return z.create('invalidSize', 'Size value cannot be less than zero');
      }),
      (z.createInvalidSheetSizeParam = function () {
        return z.create('invalidSize', 'Invalid sheet size parameter');
      }),
      (z.createSizeConflictForExactly = function () {
        return z.create(
          'invalidSize',
          'Conflicting size values for SheetSizeBehavior.EXACTLY',
        );
      }),
      (z.createInvalidSizeBehaviorOnWorksheet = function () {
        return z.create(
          'invalidSizeBehaviorOnWorksheet',
          'Only SheetSizeBehavior.AUTOMATIC is allowed on Worksheets',
        );
      }),
      (z.createNoUrlForHiddenWorksheet = function () {
        return z.create(
          'noUrlForHiddenWorksheet',
          'Hidden worksheets do not have a URL.',
        );
      }),
      (z.$createInvalidAggregationFieldName = function (e) {
        return z.create(
          'invalidAggregationFieldName',
          "Invalid aggregation type for field '" + e + "'",
        );
      }),
      (z.createIndexOutOfRange = function (e) {
        return z.create(
          'indexOutOfRange',
          "Index '" + e + "' is out of range.",
        );
      }),
      (z.createUnsupportedEventName = function (e) {
        return z.create(
          'unsupportedEventName',
          "Unsupported event '" + e + "'.",
        );
      }),
      (z.createBrowserNotCapable = function () {
        return z.create(
          'browserNotCapable',
          'This browser is incapable of supporting the Tableau JavaScript API.',
        );
      }),
      (e.tab._TableauException = z);
    var P = function () {};
    (P.__typeName = 'tab._Utility'),
      (P.isNullOrEmpty = function (e) {
      ...
      (P.isDateValid = function (e) {
        return !isNaN(e.getTime());
      }),
      (P.indexOf = function (e, i, n) {
      ...
      (P.contains = function (e, t, i) {
        return P.indexOf(e, t, i) >= 0;
      }),
      (P.getTopmostWindow = function () {
        for (
          var e = window.self;
      ...
      (P.toInt = function (e) {
        if (P.isNumber(e)) return t.Int32.trunc(e);
        var i = parseInt(e.toString(), 10);
        return isNaN(i) ? 0 : i;
      }),
      (P.hasClass = function (e, i) {
        var n = new RegExp('[\\n\\t\\r]', 'g');
        return (
          t.isValue(e) &&
      ...
      (P.hasDocumentAttachEvent = function () {
        return !!t.isValue(document.attachEvent);
      }),
      (P.hasWindowAddEventListener = function () {
        return !!t.isValue(window.addEventListener);
      }),
      (P.isElementOfTag = function (e, i) {
        return (
          t.isValue(e) &&
          1 === e.nodeType &&
      ...
      (P.elementToString = function (e) {
        var i = new t.StringBuilder();
        if (
          (i.append(e.tagName.toLowerCase()),
          P.isNullOrEmpty(e.id) || i.append('#').append(e.id),
          !P.isNullOrEmpty(e.className))
        ) {
      ...
      (P.visibleContentRectInDocumentCoordinates = function (e) {
        for (
          var i = P.contentRectInDocumentCoordinates(e), n = e.parentElement;
          t.isValue(n) && t.isValue(n.parentElement);
          n = n.parentElement
        ) {
          var a = P.$getComputedStyle(n).overflow;
          ('auto' !== a && 'scroll' !== a && 'hidden' !== a) ||
            (i = i.intersect(P.contentRectInDocumentCoordinates(n)));
        }
        var s = P.contentRectInDocumentCoordinates(document.documentElement),
      ...
      (P.contentRectInDocumentCoordinates = function (e) {
        var t = P.getBoundingClientRect(e),
          i = P.$getComputedStyle(e),
          n = P.toInt(i.paddingLeft),
          a = P.toInt(i.paddingTop),
          s = P.toInt(i.borderLeftWidth),
          o = P.toInt(i.borderTopWidth),
          l = P.computeContentSize(e),
          u = new r.WindowHelper(window.self),
          c = t.left + n + s + u.get_pageXOffset(),
          h = t.top + a + o + u.get_pageYOffset();
        return new k(c, h, l.width, l.height);
      }),
      (P.getBoundingClientRect = function (e) {
        var i = e.getBoundingClientRect(),
          n = t.Int32.trunc(i.top),
          r = t.Int32.trunc(i.left),
          a = t.Int32.trunc(i.right),
          s = t.Int32.trunc(i.bottom);
        return new k(r, n, a - r, s - n);
      }),
      (P.convertRawValue = function (e, i) {
      ...
      (P.getDataValue = function (e) {
        return t.isNullOrUndefined(e)
          ? le.$ctor(null, null, null)
          : le.$ctor(
      ...
      (P.serializeDateForServer = function (e) {
        var i = '';
        t.isValue(e) &&
          P.isDate(e) &&
          (i =
      ...
      (P.computeContentSize = function (e) {
        var t = P.$getComputedStyle(e),
      ...
      (e.tab._Utility = P);
    var x = function () {};
    (x.__typeName = 'tab._VizManagerImpl'),
      (x.get_$clonedVizs = function () {
        return x.$vizs.concat();
      }),
      (x.$registerViz = function (e) {
        x.$verifyVizNotAlreadyParented(e), x.$vizs.push(e);
      }),
      (x.$unregisterViz = function (e) {
        for (var i = 0, n = x.$vizs.length; i < n; i++)
          if (t.referenceEquals(x.$vizs[i], e)) {
            x.$vizs.splice(i, 1);
            break;
          }
      }),
      (x.$sendVisibleRects = function () {
        for (var e = 0, t = x.$vizs.length; e < t; e++)
          x.$vizs[e]._impl.$sendVisibleRect();
      }),
      (x.$verifyVizNotAlreadyParented = function (e) {
        for (
          var i = e.getParentElement(), n = 0, r = x.$vizs.length;
          n < r;
          n++
        )
          if (t.referenceEquals(x.$vizs[n].getParentElement(), i)) {
            var a =
              "Another viz is already present in element '" +
              P.elementToString(i) +
              "'.";
            throw z.create('vizAlreadyInManager', a);
          }
      });
    var U = function (e, i, n) {
      ...
      t.isNullOrUndefined(n) &&
        ...
        t.isValue(n.height) || t.isValue(n.width)
          ? ((this.fixedSize = !0),
            P.isNumber(n.height) && (n.height = n.height.toString() + 'px'),
            P.isNumber(n.width) && (n.width = n.width.toString() + 'px'),
            (this.height = t.isValue(n.height) ? n.height.toString() : null),
            (this.width = t.isValue(n.width) ? n.width.toString() : null))
          : (this.fixedSize = !1),
    ...
    (M.__typeName = 'tab._WorkbookImpl'),
      (M.$createDashboardZones = function (e) {
        e = t.coalesce(e, []);
        for (var i = [], n = 0; n < e.length; n++) {
          var r = e[n],
            a = W.convertDashboardObjectType(r.zoneType),
            s = ye.$ctor(r.width, r.height),
            o = $e.$ctor(r.x, r.y),
            l = {
              name: r.name,
              objectType: a,
      ...
      (M.$extractSheetName = function (e) {
        if (t.isNullOrUndefined(e)) return null;
        if (P.isString(e)) return e;
        var i = t.safeCast(e, je);
        if (t.isValue(i)) return i.getName();
        var n = t.safeCast(e, He);
        return t.isValue(n) ? n.getName() : null;
      }),
      (M.$createSheetSize = function (e) {
        return t.isNullOrUndefined(e)
          ? ve.createAutomatic()
          : ve.fromSizeConstraints(e.sizeConstraints);
      }),
      (M.$processParameters = function (e) {
      ...
      (M.$findAndCreateParameterImpl = function (e, i) {
        for (var n = 0; n < i.parameters.length; n++) {
          var r = i.parameters[n];
          if (t.referenceEquals(r.name, e)) return new f(r);
        }
        return null;
      }),
      (e.tab._WorkbookImpl = M);
    ...
    (L.__typeName = 'tab._WorksheetImpl'),
      (L.$filterCommandError = function (e) {
        var i = e;
        if (t.isValue(i) && t.isValue(i.errorCode)) {
          ...
          switch (i.errorCode) {
            case 'invalidFilterFieldName':
              return z.create('invalidFilterFieldName', n);
            case 'invalidFilterFieldValue':
              return z.create('invalidFilterFieldValue', n);
            case 'invalidAggregationFieldName':
              return z.$createInvalidAggregationFieldName(n);
            default:
              return z.createServerError(n);
          }
        }
        return null;
      }),
      (L.$normalizeRangeFilterOption = function (e) {
        if (t.isNullOrUndefined(e))
          throw z.createNullOrEmptyParameter('filterOptions');
      ...
      (L.$normalizeRelativeDateFilterOptions = function (e) {
        if (t.isNullOrUndefined(e))
          throw z.createNullOrEmptyParameter('filterOptions');
        var i = new Object();
        if (
          ...
          i.rangeN = P.toInt(e.rangeN);
        }
        if (t.isValue(e.anchorDate)) {
          if (!P.isDate(e.anchorDate) || !P.isDateValid(e.anchorDate))
            throw z.createInvalidDateParameter('filterOptions.anchorDate');
          i.anchorDate = e.anchorDate;
        }
        return i;
      }),
      (L.$createFilterCommandReturnHandler = function (e, i, n) {
        return new (t.makeGenericType(ae, [Object]))(
          e,
          1,
          function (e) {
            var r = L.$filterCommandError(e);
            t.isNullOrUndefined(r) ? n.resolve(i) : n.reject(r);
          },
          function (e, t) {
            if (e) n.reject(z.createInvalidFilterFieldNameOrValue(i));
            else {
              var r = z.create('filterCannotBePerformed', t);
              n.reject(r);
            }
          },
        );
      }),
      (L.$createSelectionCommandError = function (e) {
        var i = e;
        if (t.isValue(i) && t.isValue(i.errorCode)) {
          var n = t.isValue(i.additionalInformation)
            ? i.additionalInformation.toString()
          ...
          switch (i.errorCode) {
            case 'invalidSelectionFieldName':
              return z.create('invalidSelectionFieldName', n);
            case 'invalidSelectionValue':
              return z.create('invalidSelectionValue', n);
            case 'invalidSelectionDate':
              return z.create('invalidSelectionDate', n);
          }
        }
        return null;
      }),
      (e.tab._WorksheetImpl = L);
    var j = function () {};
    (j.__typeName = 'tab.ApiDashboardObjectType'),
      (e.tab.ApiDashboardObjectType = j);
    var H = function () {};
    (H.__typeName = 'tab.ApiDateRangeType'), (e.tab.ApiDateRangeType = H);
    var W = function () {};
    (W.__typeName = 'tab.ApiEnumConverter'),
      (W.convertDashboardObjectType = function (e) {
        switch (e) {
          case 'blank':
            return 'blank';
          case 'image':
      ...
      (W.convertFieldAggregation = function (e) {
        switch (e) {
          case 'ATTR':
            return 'ATTR';
          case 'AVG':
      ...
      (W.convertFilterType = function (e) {
        switch (e) {
          case 'categorical':
            return 'categorical';
          case 'hierarchical':
      ...
      (W.convertParameterAllowableValuesType = function (e) {
        switch (e) {
          case 'all':
            return 'all';
          case 'list':
      ...
      (W.convertParameterDataType = function (e) {
        switch (e) {
          case 'boolean':
            return 'boolean';
          case 'date':
      ...
      (W.convertPeriodType = function (e) {
        switch (e) {
          case 'year':
            return 'year';
          case 'quarter':
      ...
      (e.tab.ApiEnumConverter = W);
    var q = function () {};
    (q.__typeName = 'tab.ApiErrorCode'), (e.tab.ApiErrorCode = q);
    var G = function () {};
    (G.__typeName = 'tab.ApiFieldAggregationType'),
      (e.tab.ApiFieldAggregationType = G);
    var K = function () {};
    (K.__typeName = 'tab.ApiFieldRoleType'), (e.tab.ApiFieldRoleType = K);
    var J = function () {};
    (J.__typeName = 'tab.ApiFilterType'), (e.tab.ApiFilterType = J);
    var Q = function () {};
    (Q.__typeName = 'tab.ApiFilterUpdateType'), (e.tab.ApiFilterUpdateType = Q);
    var B = function () {};
    (B.__typeName = 'tab.ApiNullOption'), (e.tab.ApiNullOption = B);
    var Y = function () {};
    (Y.__typeName = 'tab.ApiParameterAllowableValuesType'),
      (e.tab.ApiParameterAllowableValuesType = Y);
    var X = function () {};
    (X.__typeName = 'tab.ApiParameterDataType'),
      (e.tab.ApiParameterDataType = X);
    var Z = function () {};
    (Z.__typeName = 'tab.ApiPeriodType'), (e.tab.ApiPeriodType = Z);
    var ee = function () {};
    (ee.__typeName = 'tab.ApiSelectionUpdateType'),
      (e.tab.ApiSelectionUpdateType = ee);
    var te = function () {};
    (te.__typeName = 'tab.ApiSheetSizeBehavior'),
      (e.tab.ApiSheetSizeBehavior = te);
    var ie = function () {};
    (ie.__typeName = 'tab.ApiSheetType'), (e.tab.ApiSheetType = ie);
    var ne = function () {};
    (ne.__typeName = 'tab.ApiTableauEventName'),
      (e.tab.ApiTableauEventName = ne);
    var re = function () {};
    (re.__typeName = 'tab.ApiToolbarPosition'), (e.tab.ApiToolbarPosition = re);
    var ae = function (e) {
    ...
    (ae.__typeName = 'tab.CommandReturnHandler$1'),
      t.initGenericClass(ae, a, 1),
      (e.tab.CommandReturnHandler$1 = ae);
    var se = function (e, t) {
      (this.$router = null),
        (this.$handler = null),
        A.verifyValue(e, 'router'),
        A.verifyValue(t, 'handler'),
        (this.$router = e),
        (this.$handler = t);
    };
    (se.__typeName = 'tab.CrossDomainMessagingOptions'),
      (e.tab.CrossDomainMessagingOptions = se);
    var oe = function (e, t, i) {
      (this.$context = null),
        be.call(this, e, t),
        (this.$context = new o(t._impl.get__workbookImpl(), i));
    };
    (oe.__typeName = 'tab.CustomViewEvent'), (e.tab.CustomViewEvent = oe);
    var le = function () {};
    (le.__typeName = 'tab.DataValue'),
      (le.$ctor = function (e, t, i) {
        var n = new Object();
        return (
          (n.value = null),
          (n.formattedValue = null),
          (n.value = e),
          P.isNullOrEmpty(i) ? (n.formattedValue = t) : (n.formattedValue = i),
          n
        );
      }),
      (e.tab.DataValue = le);
    ...
    (ue.__typeName = 'tab.EventContext'), (e.tab.EventContext = ue);
    ...
    (ce.__typeName = 'tab.FilterEvent'), (e.tab.FilterEvent = ce);
    var he = function (e, t, i) {
      (this.$vizSize = null), be.call(this, e, t), (this.$vizSize = i);
    };
    (he.__typeName = 'tab.FirstVizSizeKnownEvent'),
      (e.tab.FirstVizSizeKnownEvent = he);
    var me = function () {};
    (me.__typeName = 'tab.ICrossDomainMessageHandler'),
      (e.tab.ICrossDomainMessageHandler = me);
    var de = function () {};
    (de.__typeName = 'tab.ICrossDomainMessageRouter'),
      (e.tab.ICrossDomainMessageRouter = de);
    var pe = function () {};
    (pe.__typeName = 'tab.JsonUtil'),
      (pe.parseJson = function (e) {
        return t.isNullOrEmptyString(e) ? null : E.parseJSON(e);
      }),
      (pe.toJson = function (e, t, i) {
        return pe.$serialize(e, (t = t || !1), (i = i || ''), []);
      }),
      (pe.$indexOf = function (e, i, n) {
        if (t.isValue(Array.prototype.indexOf)) return e.indexOf(i, n);
        n = n || 0;
        var r = e.length;
        if (r > 0)
          for (var a = n; a < r; a++) if (t.referenceEquals(e[a], i)) return a;
      ...
      (pe.$contains = function (e, t, i) {
        return pe.$indexOf(e, t, i) >= 0;
      }),
      (pe.$serialize = function (e, i, n, r) {
        if (pe.$contains(r, e))
          throw new t.Exception(
            'The object contains recursive reference of sub-objects',
          );
        if (void 0 === e) return 'undefined';
        if (t.isNullOrUndefined(e)) return 'null';
        var a,
          s = E.type(e);
        if ('number' === s || 'boolean' === s) return e.toString();
        if ('string' === s) return pe.$escapeString(t.cast(e, String));
        r.push(e), (n = n || '');
        var o = i ? n + pe.$defaultIndentStr : '',
          l = e.__json__ || e.json;
        if (
          E.isFunction(l) &&
          ((a = t.cast(l, Function)(e)), !t.referenceEquals(e, a))
        ) {
          var u = pe.$serialize(a, i, o, r);
          return r.pop(), u;
        }
        if (t.isValue(e.nodeType) && t.isValue(e.cloneNode))
          throw new t.Exception("Can't serialize DOM nodes");
        var c = i ? ' ' : '',
          h = i ? '\n' : '';
        return E.isArray(e)
          ? pe.$serializeArray(e, i, n, r, o, h)
          : 'function' === s
          ? (r.pop(), null)
          : pe.$serializeGeneric(e, i, n, r, o, h, c);
      }),
      (pe.$serializeGeneric = function (e, i, n, r, a, s, o) {
        var l = e,
          u = new t.StringBuilder('{'),
          c = !1,
          h = new t.ObjectEnumerator(l);
        try {
          for (; h.moveNext(); ) {
            var m,
              d,
              p = h.current();
            if ('number' == typeof p.key) m = '"' + p.key + '"';
            else {
              if ('string' != typeof p.key) continue;
              m = pe.$escapeString(p.key);
            }
            (d = pe.$serialize(p.value, i, a, r)),
        ...
        return u.append(s + n + '}'), r.pop(), u.toString();
      }),
      (pe.$serializeArray = function (e, i, n, r, a, s) {
        for (
          var o = !1, l = new t.StringBuilder('['), u = t.cast(e, Array), c = 0;
          c < u.length;
          c++
        ) {
          var h = u[c],
            m = pe.$serialize(h, i, a, r);
          t.isNullOrUndefined(m) && (m = 'undefined'),
            o && l.append(','),
            l.append(s + a + m),
            (o = !0);
        }
        return l.append(s + n + ']'), r.pop(), l.toString();
      }),
      (pe.$escapeString = function (e) {
        return (e = (e = (e = (e = (e = (e =
          '"' + e.replace(new RegExp('(["\\\\])', 'g'), '\\$1') + '"').replace(
          new RegExp('[\f]', 'g'),
          '\\f',
    ...
    var fe = function (e, t, i) {
      (this.$context = null),
        Ae.call(this, e, t, i),
        (this.$context = new d(t._impl.get__workbookImpl(), i));
    };
    (fe.__typeName = 'tab.MarksEvent'), (e.tab.MarksEvent = fe);
    var ge = function (e, t, i) {
      (this.$context = null),
        be.call(this, e, t),
        (this.$context = new p(t._impl.get__workbookImpl(), i));
    };
    (ge.__typeName = 'tab.ParameterEvent'), (e.tab.ParameterEvent = ge);
    var $e = function () {};
    ($e.__typeName = 'tab.Point'),
      ($e.$ctor = function (e, t) {
        var i = new Object();
      ...
      (e.tab.Point = $e);
    var _e = function () {};
    (_e.__typeName = 'tab.SheetSize'),
      (_e.$ctor = function (e, i, n) {
        var r = new Object();
        return (
          (r.behavior = null),
          (r.minSize = null),
      ...
      (e.tab.SheetSize = _e);
    var ve = function () {};
    (ve.__typeName = 'tab.SheetSizeFactory'),
      (ve.createAutomatic = function () {
        return _e.$ctor('automatic', null, null);
      }),
      (ve.fromSizeConstraints = function (e) {
        var t = e.minHeight,
          i = e.minWidth,
          n = e.maxHeight,
          r = e.maxWidth,
        ...
        return (
          0 === t && 0 === i
            ? (0 === n && 0 === r) || ((a = 'atmost'), (o = ye.$ctor(r, n)))
            : 0 === n && 0 === r
            ? ((a = 'atleast'), (s = ye.$ctor(i, t)))
            : n === t && r === i
            ? ((a = 'exactly'), (s = ye.$ctor(i, t)), (o = ye.$ctor(i, t)))
            : ((a = 'range'), (s = ye.$ctor(i, t)), (o = ye.$ctor(r, n))),
          _e.$ctor(a, s, o)
        );
      }),
      (e.tab.SheetSizeFactory = ve);
    var ye = function () {};
    (ye.__typeName = 'tab.Size'),
      (ye.$ctor = function (e, t) {
        var i = new Object();
        return (i.width = 0), (i.height = 0), (i.width = e), (i.height = t), i;
      }),
      (e.tab.Size = ye);
    var we = function () {};
    (we.__typeName = 'tab.StoryPointInfoImplUtil'),
      (we.clone = function (e) {
        return D.$ctor(
          e.caption,
          e.index,
      ...
      (e.tab.StoryPointInfoImplUtil = we);
    ...
    (Se.__typeName = 'tab.StoryPointSwitchEvent'),
      (e.tab.StoryPointSwitchEvent = Se);
    var be = function (e, t) {
      (this.$viz = null),
        (this.$eventName = null),
        (this.$viz = t),
    ...
    (be.__typeName = 'tab.TableauEvent'), (e.tab.TableauEvent = be);
    ...
    (Ie.__typeName = 'tab.TabSwitchEvent'), (e.tab.TabSwitchEvent = Ie);
    var Ce = function (e, i, n, r, a) {
      if (
        ...
        !P.hasWindowPostMessage() || !P.hasJsonParse())
      )
        throw z.createBrowserNotCapable();
      (this.$messagingOptions = new se(e, this)),
        (this.$viz = i),
        (t.isNullOrUndefined(n) || 1 !== n.nodeType) && (n = document.body),
        (this.$parameters = new U(n, r, a)),
        t.isValue(a) &&
          ((this.$onFirstInteractiveCallback = a.onFirstInteractive),
          (this.$onFirstVizSizeKnownCallback = a.onFirstVizSizeKnown));
    };
    (Ce.__typeName = 'tab.VizImpl'), (e.tab.VizImpl = Ce);
    var Ne = function (e, t, i) {
      (this.$availableSize = null),
        be.call(this, e, t),
        (this.$availableSize = i);
    };
    (Ne.__typeName = 'tab.VizResizeEvent'), (e.tab.VizResizeEvent = Ne);
    var Ee = function () {};
    (Ee.__typeName = 'tab.VizSize'),
      (Ee.$ctor = function (e, t) {
        var i = new Object();
        return (
          (i.sheetSize = null),
          (i.chromeHeight = 0),
    ...
    (Ae.__typeName = 'tab.WorksheetEvent'), (e.tab.WorksheetEvent = Ae);
    var Ve = function (e, t) {
      (this.$isExclude = !1),
    ...
    (Ve.__typeName = 'tableauSoftware.CategoricalFilter'),
      (e.tableauSoftware.CategoricalFilter = Ve);
    var ke = function (e) {
      (this._impl = null), (this._impl = e);
    };
    (ke.__typeName = 'tableauSoftware.CustomView'),
      (e.tableauSoftware.CustomView = ke);
    var Oe = function (e) {
      (this._impl = null), je.call(this, e);
    };
    (Oe.__typeName = 'tableauSoftware.Dashboard'),
      (e.tableauSoftware.Dashboard = Oe);
    var Te = function (e, i, n) {
      if (
        ((this.$zoneInfo = null),
        (this.$dashboard = null),
        (this.$worksheet = null),
    ...
    (Te.__typeName = 'tableauSoftware.DashboardObject'),
      (e.tableauSoftware.DashboardObject = Te);
    var Fe = function (e) {
      (this.$impl = null), (this.$impl = e);
    };
    (Fe.__typeName = 'tableauSoftware.DataSource'),
      (e.tableauSoftware.DataSource = Fe);
    ...
    (Re.__typeName = 'tableauSoftware.Field'), (e.tableauSoftware.Field = Re);
    var De = function (e, t) {
      (this.$worksheetImpl = null),
        (this.$type = null),
        (this.$caption = null),
    ...
    (De.__typeName = 'tableauSoftware.Filter'),
      (De.$createFilter = function (e, t) {
        switch (t.filterType) {
          case 'categorical':
            return new Ve(e, t);
          case 'relativedate':
      ...
      (De.$processFiltersList = function (e, t) {
        for (var i = new r._Collection(), n = 0; n < t.filters.length; n++) {
          var a = t.filters[n],
            s = De.$createFilter(e, a);
          i._add(a.caption, s);
        }
        return i;
      }),
      (e.tableauSoftware.Filter = De);
    var ze = function (e, t) {
      (this.$levels = 0), De.call(this, e, t), this.$initializeFromJson$1(t);
    };
    (ze.__typeName = 'tableauSoftware.HierarchicalFilter'),
      (e.tableauSoftware.HierarchicalFilter = ze);
    var Pe = function (e) {
      (this.$impl = null), (this.$impl = new m(e));
    };
    (Pe.__typeName = 'tableauSoftware.Mark'), (e.tableauSoftware.Mark = Pe);
    var xe = function (e, i) {
      (this.fieldName = null),
        (this.value = null),
    ...
    (xe.__typeName = 'tableauSoftware.Pair'), (e.tableauSoftware.Pair = xe);
    var Ue = function (e) {
      (this._impl = null), (this._impl = e);
    };
    (Ue.__typeName = 'tableauSoftware.Parameter'),
      (e.tableauSoftware.Parameter = Ue);
    var Me = function (e, t) {
      (this.$domainMin = null),
        (this.$domainMax = null),
        (this.$min = null),
    ...
    (Me.__typeName = 'tableauSoftware.QuantitativeFilter'),
      (e.tableauSoftware.QuantitativeFilter = Me);
    var Le = function (e, t) {
    ...
    (Le.__typeName = 'tableauSoftware.RelativeDateFilter'),
      (e.tableauSoftware.RelativeDateFilter = Le);
    var je = function (e) {
      (this._impl = null), A.verifyValue(e, 'sheetImpl'), (this._impl = e);
    };
    (je.__typeName = 'tableauSoftware.Sheet'), (e.tableauSoftware.Sheet = je);
    var He = function (e) {
      (this.$impl = null), (this.$impl = e);
    };
    (He.__typeName = 'tableauSoftware.SheetInfo'),
      (e.tableauSoftware.SheetInfo = He);
    var We = function (e) {
      (this._impl = null), je.call(this, e);
    };
    (We.__typeName = 'tableauSoftware.Story'), (e.tableauSoftware.Story = We);
    var qe = function (e) {
      (this.$impl = null), (this.$impl = e);
    };
    (qe.__typeName = 'tableauSoftware.StoryPoint'),
      (e.tableauSoftware.StoryPoint = qe);
    var Ge = function (e) {
      (this._impl = null), (this._impl = e);
    };
    (Ge.__typeName = 'tableauSoftware.StoryPointInfo'),
      (e.tableauSoftware.StoryPointInfo = Ge);
    var Ke = function (e, i, n, r) {
      (this.$major = 0),
        (this.$minor = 0),
        (this.$patch = 0),
        (this.$metadata = null),
    ...
    (Ke.__typeName = 'tableauSoftware.Version'),
      (Ke.getCurrent = function () {
        return Ke.$currentVersion;
      }),
      (e.tableauSoftware.Version = Ke);
    var Je = function (e, t, i) {
      this._impl = null;
      var n = v.getCrossDomainMessageRouter();
      (this._impl = new Ce(n, this, e, t, i)), this._impl.$create();
    };
    (Je.__typeName = 'tableauSoftware.Viz'),
      (Je.getLastRequestMessage = function () {
        return _.lastRequestMessage;
      }),
      (Je.getLastResponseMessage = function () {
        return _.lastResponseMessage;
      }),
      (Je.getLastClientInfoResponseMessage = function () {
        return _.lastClientInfoResponseMessage;
      }),
      (e.tableauSoftware.Viz = Je);
    var Qe = function () {};
    (Qe.__typeName = 'tableauSoftware.VizManager'),
      (Qe.getVizs = function () {
        return x.get_$clonedVizs();
      }),
      (e.tableauSoftware.VizManager = Qe);
    var Be = function (e) {
      (this.$workbookImpl = null), (this.$workbookImpl = e);
    };
    (Be.__typeName = 'tableauSoftware.Workbook'),
      (e.tableauSoftware.Workbook = Be);
    var Ye,
      Xe = function (e) {
        (this._impl = null), je.call(this, e);
      };
    (Xe.__typeName = 'tableauSoftware.Worksheet'),
      (e.tableauSoftware.Worksheet = Xe),
      t.initInterface(de, a, {
      ...
      t.initClass(
        ...
        a,
        {
          registerHandler: function (e) {
            var i = 'handler' + this.$nextHandlerId;
            if (
              t.isValue(e.get_handlerId()) ||
              t.isValue(this.$handlers[e.get_handlerId()])
            )
              throw z.createInternalError(
                "Handler '" + e.get_handlerId() + "' is already registered.",
              );
            this.$nextHandlerId++,
              e.set_handlerId(i),
              (this.$handlers[i] = e),
          ...
          unregisterHandler: function (e) {
            (t.isValue(e.get_handlerId()) ||
              t.isValue(this.$handlers[e.get_handlerId()])) &&
              (delete this.$handlers[e.get_handlerId()],
          ...
          sendCommand: function (e) {
            return function (e, i, n) {
              ...
              if (
                ...
                var c = null;
                t.isValue(i) && (c = pe.toJson(i, !1, ''));
                var h = new _(l, s, a, c).serialize();
                P.isPostMessageSynchronous()
          ...
          $handleStateReadyForQuery: function (e) {
            var i = this.$commandReturnAfterStateReadyQueues[e.get_handlerId()];
            if (!P.isNullOrEmpty(i))
              for (; i.length > 0; ) {
                var n = i.pop();
                t.isValue(n) && n();
              }
          ...
          $handleCrossDomainMessage: function (e) {
            ...
            if (!t.isNullOrUndefined(i.data)) {
              var r = _.parse(i.data.toString()),
                a = r.get_rawName(),
                s = r.get_handlerId(),
                o = this.$handlers[s];
              (!t.isNullOrUndefined(o) &&
                t.referenceEquals(o.get_handlerId(), r.get_handlerId())) ||
                (o = new c()),
                r.get_isApiCommandName()
                  ? t.referenceEquals(
                      r.get_commandId(),
                      _.crossDomainEventNotificationId,
                    )
          ...
          $handleCrossDomainResponse: function (e) {
            var i = this.$commandCallbacks[e.get_handlerId()],
          ...
          $handleLegacyNotifications: function (e, i) {
            t.referenceEquals(e, 'layoutInfoReq'.toString())
              ? x.$sendVisibleRects()
              : t.referenceEquals(e, 'tableau.completed'.toString()) ||
                t.referenceEquals(e, 'completed'.toString())
              ? i.handleVizLoad()
              : 'tableau.listening' === e && i.handleVizListening();
          },
        },
        null,
        [de],
      ...
      t.initClass(_, a, {
        ...
        serialize: function () {
          var e = [];
          e.push(this.$name),
            e.push(this.$commandId),
            e.push(this.$handlerId),
            t.isValue(this.$parameters) && e.push(this.$parameters);
          var i = e.join(',');
          return (_.lastRequestMessage = i), i;
        },
      }),
      t.initClass(v, a, {}),
      t.initClass(y, a, {
      ...
      t.initClass(S, a, {
        ...
        $verifyUniqueKeyParameter: function (e) {
          if (P.isNullOrEmpty(e)) throw new t.Exception('Null key');
      ...
      t.initClass(b, a, {
        ...
        set_$name: function (e) {
          if (this.$isStale) throw z.create('staleDataReference', 'Stale data');
          this.$name = e;
        },
        ...
        $saveAsync: function () {
          if (this.$isStale || t.isNullOrUndefined(this.$presModel))
            throw z.create('staleDataReference', 'Stale data');
          ...
          var n = b.$createCustomViewCommandReturnHandler(
            'api.UpdateCustomViewCommand',
            e,
            t.mkdel(this, function (t) {
              b._processCustomViewUpdate(
                this.$workbookImpl,
      ...
      t.initClass(O, a, {
        ...
        get_url: function () {
          if (this.$isHidden) throw z.createNoUrlForHiddenWorksheet();
          return this.$url;
        },
        get_size: function () {
          return this.$size;
        ...
        changeSizeAsync: function (e) {
          if (
            ((e = O.$normalizeSheetSize(e)),
            'worksheet' === this.$sheetType && 'automatic' !== e.behavior)
          )
            throw z.createInvalidSizeBehaviorOnWorksheet();
          var i = new r._Deferred();
          ...
          var s = new (t.makeGenericType(ae, [Object]))(
            ...
            function (e, t) {
              i.reject(z.createServerError(t));
            },
          );
        ...
        $processSheetSize: function (e) {
          ...
          if (
            ...
            throw z.createInvalidSheetSizeParam();
          var n = 0,
            r = 0,
            a = 0,
            s = 0,
          ...
          if ('automatic' === e.behavior)
            i = _e.$ctor('automatic', void 0, void 0);
            ...
            if (
              ...
              throw z.createMissingMinMaxSize();
            if (
              e.minSize.width < 0 ||
              e.minSize.height < 0 ||
              e.maxSize.width < 0 ||
              ...
              throw z.createInvalidRangeSize();
            (o['api.minWidth'] = e.minSize.width),
              (o['api.minHeight'] = e.minSize.height),
              (o['api.maxWidth'] = e.maxSize.width),
              (o['api.maxHeight'] = e.maxSize.height),
              (i = _e.$ctor('range', e.minSize, e.maxSize));
            ...
            if (
              ...
              if (
                ...
                throw z.createSizeConflictForExactly();
            } else
              t.isValue(e.minSize) &&
              t.isValue(e.minSize.width) &&
              t.isValue(e.minSize.height)
            ...
            (o['api.minWidth'] = n),
              ...
              (o['api.maxWidth'] = a),
              (o['api.maxHeight'] = s),
              (i = _e.$ctor('exactly', ye.$ctor(n, r), ye.$ctor(a, s)));
          }
        ...
        a,
        {
          ...
          $addObjects: function (e, i) {
            ...
            for (var n = 0; n < e.length; n++) {
              ...
              var f = new Te(a, this.get_dashboard(), s);
      ...
      t.initClass(V, a, {
        always: function (e) {
          return t.cast(this.then(e, t.cast(e, Function)), V);
        },
        otherwise: function (e) {
          return t.cast(this.then(null, e), V);
        },
      }),
      t.initClass(k, a, {
      ...
      t.initClass(
        ...
        a,
        {
          ...
          get_story: function () {
            return (
              t.isNullOrUndefined(this.$story) && (this.$story = new We(this)),
              this.$story
            );
          },
          ...
          update: function (e) {
            ...
            for (var r = 0; r < e.storyPoints.length; r++) {
              var a = e.storyPoints[r],
                ...
                l = D.$ctor(s, r, a.storyPointId, o, a.isUpdated, this);
              if (t.isNullOrUndefined(this.$storyPointsInfo[r]))
                this.$storyPointsInfo[r] = new Ge(l);
              else if (
              ...
              } else this.$storyPointsInfo[r] = new Ge(l);
            ...
            if (h) {
              var d = R.createContainedSheet(
                i,
                this.get_workbookImpl(),
                this.get_messagingOptions(),
                this.$findSheetFunc,
              );
              this.$activeStoryPointImpl = new R(n, d);
            } else
          ...
          activateStoryPointAsync: function (e) {
            ...
            if (e < 0 || e >= this.$storyPointsInfo.length)
              throw z.createIndexOutOfRange(e);
          ...
          revertStoryPointAsync: function (e) {
            ...
            var a = new (t.makeGenericType(ae, [Object]))(
          ...
          $updateActiveState: function (e, t) {
            ...
            if (e.get_index() !== i) {
              ...
              (r.isActive = !0),
                (this.$activeStoryPointImpl = new R(r, a)),
                e.set_isActive(!1),
                (n._impl.isActive = !1),
                this.$raiseActiveStoryPointChange(
                  n,
      ...
      t.initClass(M, a, {
        ...
        $findActiveSheetOrSheetWithinActiveDashboard: function (e) {
          ...
          if (this.$activeSheetImpl.get_isDashboard()) {
            var n = t.cast(this.$activeSheetImpl, I).get_worksheets()._get(i);
        ...
        _setActiveSheetAsync: function (e) {
          if (P.isNumber(e)) {
            ...
            throw z.createIndexOutOfRange(i);
          }
          var n = M.$extractSheetName(e),
            r = this.$publishedSheetsInfo._get(n);
          if (t.isValue(r)) return this.$activateSheetWithInfoAsync(r.$impl);
          if (this.$activeSheetImpl.get_isDashboard()) {
            var a = t.cast(this.$activeSheetImpl, I).get_worksheets()._get(n);
            if (t.isValue(a)) {
              this.$activatingHiddenSheetImpl = null;
              var s = '';
              return (
        ...
        _revertAllAsync: function () {
          var e = new r._Deferred(),
            i = new (t.makeGenericType(ae, [Object]))(
              ...
              function (t, i) {
                e.reject(z.createServerError(i));
              },
            );
        ...
        $activateSheetInternalAsync: function (e, i) {
          ...
          var s = new (t.makeGenericType(ae, [Object]))(
            ...
            function (e, t) {
              n.reject(z.createServerError(t));
            },
          );
        ...
        _updateActiveSheetAsync: function () {
          ...
          var n = new (t.makeGenericType(ae, [Object]))(
        ...
        $getClientInfo: function (e) {
          var i = new (t.makeGenericType(ae, [Object]))(
          ...
          if (
            ...
            if (t.isValue(this.$activeSheetImpl)) {
              ...
              if (
                ...
                t.cast(this.$activeSheetImpl, F).remove_activeStoryPointChange(
            ...
            if (t.isValue(this.$activatingHiddenSheetImpl)) {
              ...
              if ('dashboard' === s.sheetType) {
                var c = new I(n.$impl, this, this.$messagingOptions);
                this.$activeSheetImpl = c;
                var h = M.$createDashboardZones(e.dashboardZones);
                c.$addObjects(h, u);
          ...
          if (!t.isNullOrUndefined(i))
            for (var n = 0; n < i.length; n++) {
              var r = i[n],
                ...
                o = M.$createSheetSize(r);
              if (t.isNullOrUndefined(s)) {
                var l = t.referenceEquals(a, e.currentSheetName),
                  u = W.convertSheetType(r.sheetType),
                  c = T.$ctor(
                    a,
                    u,
                    n,
                ...
                (s = new He(c)), this.$publishedSheetsInfo._add(a, s);
              } else s.$impl.size = o;
            }
        },
        ...
        $getCustomViewsAsync: function () {
          return b._getCustomViewsAsync(this, this.$messagingOptions);
        },
        $showCustomViewAsync: function (e) {
          if (t.isNullOrUndefined(e) || P.isNullOrEmpty(e))
            return b._showCustomViewAsync(this, this.$messagingOptions, null);
          var i = this.$customViews._get(e);
          if (t.isNullOrUndefined(i)) {
            var n = new r._Deferred();
            return n.reject(z.createInvalidCustomViewName(e)), n.get_promise();
          }
          return i._impl._showAsync();
        },
        $removeCustomViewAsync: function (e) {
          if (P.isNullOrEmpty(e))
            throw z.createNullOrEmptyParameter('customViewName');
          var i = this.$customViews._get(e);
          if (t.isNullOrUndefined(i)) {
            var n = new r._Deferred();
            return n.reject(z.createInvalidCustomViewName(e)), n.get_promise();
        ...
        $rememberCustomViewAsync: function (e) {
          if (P.isNullOrEmpty(e))
            throw z.createInvalidParameter('customViewName');
          return b._saveNewAsync(this, this.$messagingOptions, e);
        },
        $setActiveCustomViewAsDefaultAsync: function () {
          return b._makeCurrentCustomViewDefaultAsync(
            this,
            this.$messagingOptions,
          );
        },
        ...
        $getSingleParameterAsync: function (e) {
          ...
          var n = new (t.makeGenericType(ae, [Object]))(
            ...
            0,
            t.mkdel(this, function (t) {
              var n = M.$findAndCreateParameterImpl(e, t);
        ...
        $getParametersAsync: function () {
          var e = new r._Deferred(),
            i = new (t.makeGenericType(ae, [Object]))(
              ...
              0,
              t.mkdel(this, function (t) {
                (this.$parameters = M.$processParameters(t)),
        ...
        $changeParameterValueAsync: function (e, i) {
          ...
          if (t.isValue(this.$parameters)) {
            if (t.isNullOrUndefined(this.$parameters._get(e)))
              return n.reject(z.createInvalidParameter(e)), n.get_promise();
        ...
        a,
        {
          ...
          $getDataSourcesAsync: function () {
            ...
            var n = new (t.makeGenericType(ae, [Object]))(
              ...
              0,
              function (t) {
                var i = C.processDataSourcesForWorksheet(t);
          ...
          $getDataSourceAsync: function (e) {
            ...
            var a = new (t.makeGenericType(ae, [Object]))(
              ...
              0,
              function (n) {
                var r = C.processDataSource(n);
                t.isValue(r)
                  ? i.resolve(r.get_dataSource())
                  : i.reject(
                      z.createServerError("Data source '" + e + "' not found"),
                    );
              },
              function (e, t) {
                i.reject(z.createServerError(t));
            ...
            var e = this.get_isActive(),
              ...
              n =
                ...
                this.get_parentStoryPointImpl()
                  .get_parentStoryImpl()
                  .get_isActive();
            if (!e && !i && !n) throw z.createNotActiveSheet();
          },
          ...
          $getFilterAsync: function (e, i, n) {
            if (!P.isNullOrEmpty(e) && !P.isNullOrEmpty(i))
              throw z.createInternalError(
            ...
            this.$addVisualIdToCommand(s),
              ...
              P.isNullOrEmpty(e) || (s['api.fieldName'] = e),
              (s['api.filterHierarchicalLevels'] = 0),
              (s['api.ignoreDomain'] = n.ignoreDomain || !1);
            var o = new (t.makeGenericType(ae, [Object]))(
              'api.GetOneFilterInfoCommand',
              0,
              t.mkdel(this, function (e) {
                var i = L.$filterCommandError(e);
                if (t.isNullOrUndefined(i)) {
                  var n = e,
                    r = De.$createFilter(this, n);
                  a.resolve(r);
                } else a.reject(i);
              }),
              function (e, t) {
                a.reject(z.createServerError(t));
              },
            );
          ...
          $getFiltersAsync: function (e) {
            ...
            var a = new (t.makeGenericType(ae, [Object]))(
              ...
              0,
              t.mkdel(this, function (e) {
                this.set__filters(De.$processFiltersList(this, e)),
          ...
          $applyHierarchicalFilterAsync: function (e, i, n, r) {
            if (t.isNullOrUndefined(i) && 'all' !== n)
              throw z.createInvalidParameter('values');
          ...
          $clearFilterInternalAsync: function (e) {
            if (
              ...
              throw z.createNullOrEmptyParameter('fieldName');
            var t = new r._Deferred(),
              i = {};
            (i['api.fieldCaption'] = e), this.$addVisualIdToCommand(i);
            var n = L.$createFilterCommandReturnHandler(
          ...
          $applyFilterWithValuesInternalAsync: function (e, i, n, a) {
            if (
              ...
              throw z.createNullOrEmptyParameter('fieldName');
            n = g.$normalizeEnum(Q).call(null, n, 'updateType');
            var s = [];
            if (E.isArray(i))
            ...
            var c = L.$createFilterCommandReturnHandler(
          ...
          $applyRangeFilterInternalAsync: function (e, i) {
            ...
            if (((n['api.fieldCaption'] = e), t.isValue(i.min)))
              if (P.isDate(i.min)) {
                ...
                if (!P.isDateValid(a))
                  throw z.createInvalidDateParameter('filterOptions.min');
                n['api.filterRangeMin'] = P.serializeDateForServer(a);
              } else n['api.filterRangeMin'] = i.min;
            if (t.isValue(i.max))
              if (P.isDate(i.max)) {
                var s = t.cast(i.max, t.JsDate);
                if (!P.isDateValid(s))
                  throw z.createInvalidDateParameter('filterOptions.max');
                n['api.filterRangeMax'] = P.serializeDateForServer(s);
              } else n['api.filterRangeMax'] = i.max;
            t.isValue(i.nullOption) &&
              (n['api.filterRangeNullOption'] = i.nullOption),
              this.$addVisualIdToCommand(n);
            var o = new r._Deferred(),
              l = L.$createFilterCommandReturnHandler(
          ...
          $applyRelativeDateFilterInternalAsync: function (e, i) {
            if (
              ...
              throw z.createInvalidParameter('fieldName');
            if (t.isNullOrUndefined(i))
              throw z.createInvalidParameter('filterOptions');
            var n = {};
            if (((n['api.fieldCaption'] = e), t.isValue(i))) {
              ...
              t.isValue(i.anchorDate) &&
                (n['api.filterDateArchorValue'] = P.serializeDateForServer(
                  i.anchorDate,
                ));
            }
            this.$addVisualIdToCommand(n);
            var a = new r._Deferred(),
              s = L.$createFilterCommandReturnHandler(
          ...
          $applyHierarchicalFilterInternalAsync: function (e, i, n, a) {
            ...
            } else if (P.isString(i)) (s = []).push(i.toString());
            ...
            } else if (t.isValue(i)) throw z.createInvalidParameter('values');
            var d = {};
            (d['api.fieldCaption'] = e),
              (d['api.filterUpdateType'] = n),
              (d['api.exclude'] = !(!t.isValue(a) || !a.isExcludeMode)),
              t.isValue(s) &&
                (d['api.filterHierarchicalValues'] = pe.toJson(s, !1, '')),
              t.isValue(o) &&
                (d['api.filterHierarchicalLevels'] = pe.toJson(o, !1, '')),
              this.$addVisualIdToCommand(d);
            var p = new r._Deferred(),
              f = L.$createFilterCommandReturnHandler(
          ...
          $clearSelectedMarksAsync: function () {
            ...
            this.$addVisualIdToCommand(i),
              (i['api.filterUpdateType'] = 'replace');
            var n = new (t.makeGenericType(ae, [Object]))(
          ...
          $getSelectedMarksAsync: function () {
            ...
            var n = new (t.makeGenericType(ae, [Object]))(
              ...
              0,
              t.mkdel(this, function (t) {
                (this.$selectedMarks = m.$processSelectedMarks(t)),
              ...
              if (
                ...
                for (
                  ...
                  p.hasOwnProperty('fieldName') &&
                    ...
                    !E.isFunction(p.fieldName) &&
                    !E.isFunction(p.value) &&
          ...
          $parseMarksParam: function (e, i, n, r, a, s, o, l) {
            var u = l;
            if (L.$regexHierarchicalFieldName.test(o))
              ...
              if (t.isValue(u.min))
                if (P.isDate(u.min)) {
                  ...
                  if (!P.isDateValid(h))
                    throw z.createInvalidDateParameter('options.min');
                  c.min = P.serializeDateForServer(h);
                } else c.min = u.min;
              if (t.isValue(u.max))
                if (P.isDate(u.max)) {
                  var m = t.cast(u.max, t.JsDate);
                  if (!P.isDateValid(m))
                    throw z.createInvalidDateParameter('options.max');
                  c.max = P.serializeDateForServer(m);
                } else c.max = u.max;
              if (t.isValue(u.nullOption)) {
                var d = g
                  .$normalizeEnum(B)
                  .call(null, u.nullOption, 'options.nullOption');
                c.nullOption = d;
          ...
          $selectMarksWithValuesAsync: function (e, i, n, a, s, o, l, u) {
            ...
            if (
              ...
              (u = g.$normalizeEnum(ee).call(null, u, 'updateType')),
              (c['api.filterUpdateType'] = u),
              P.isNullOrEmpty(e) || (c['api.tupleIds'] = pe.toJson(e, !1, '')),
              !P.isNullOrEmpty(i) && !P.isNullOrEmpty(n))
            ) {
              c['api.categoricalFieldCaption'] = pe.toJson(i, !1, '');
              for (var h = [], m = 0; m < n.length; m++) {
                var d = pe.toJson(n[m], !1, '');
                h.push(d);
              }
              c['api.categoricalMarkValues'] = pe.toJson(h, !1, '');
            }
            if (!P.isNullOrEmpty(a) && !P.isNullOrEmpty(s)) {
              c['api.hierarchicalFieldCaption'] = pe.toJson(a, !1, '');
              for (var p = [], f = 0; f < s.length; f++) {
                var $ = pe.toJson(s[f], !1, '');
                p.push($);
              }
              c['api.hierarchicalMarkValues'] = pe.toJson(p, !1, '');
            }
            if (!P.isNullOrEmpty(o) && !P.isNullOrEmpty(l)) {
              c['api.rangeFieldCaption'] = pe.toJson(o, !1, '');
              for (var _ = [], v = 0; v < l.length; v++) {
                var y = pe.toJson(l[v], !1, '');
                _.push(y);
              }
              c['api.rangeMarkValues'] = pe.toJson(_, !1, '');
            }
            if (
              P.isNullOrEmpty(c['api.tupleIds']) &&
              P.isNullOrEmpty(c['api.categoricalFieldCaption']) &&
              P.isNullOrEmpty(c['api.hierarchicalFieldCaption']) &&
              P.isNullOrEmpty(c['api.rangeFieldCaption'])
            )
              throw z.createInvalidParameter('fieldNameOrFieldValuesMap');
            var w = new r._Deferred(),
              S = new (t.makeGenericType(ae, [Object]))(
                'api.SelectMarksCommand',
                1,
                function (e) {
                  var i = L.$createSelectionCommandError(e);
                  t.isNullOrUndefined(i) ? w.resolve() : w.reject(i);
                },
                function (e, t) {
                  w.reject(z.createServerError(t));
                },
              );
      ...
      t.initEnum(Y, a, { all: 'all', list: 'list', range: 'range' }, !0),
      t.initEnum(
        X,
        a,
        {
      ...
      t.initEnum(re, a, { top: 'top', bottom: 'bottom' }, !0),
      t.initClass(se, a, {
        get_router: function () {
          return this.$router;
        },
      ...
      t.initClass($e, a, {}, Object),
      t.initClass(_e, a, {}, Object),
      t.initClass(ve, a, {}),
      t.initClass(ye, a, {}, Object),
      t.initClass(we, a, {}),
      t.initClass(
        Se,
        a,
      ...
      t.initClass(
        ...
        a,
        {
          ...
          getCurrentUrlAsync: function () {
            var e = new r._Deferred(),
              i = new (t.makeGenericType(ae, [String]))(
                ...
                function (t, i) {
                  e.reject(z.createInternalError(i));
                },
              );
            return (
            ...
            return (
              t.isValue(this.$initialAvailableSize)
                ? ((e = this.$initialAvailableSize),
                  (this.$initialAvailableSize = null))
                : (e = P.computeContentSize(this.get_$parentElement())),
          ...
          addEventListener: function (e, i) {
            var n = {};
            if (!g.$tryNormalizeEnum(ne).call(null, e, n))
              throw z.createUnsupportedEventName(e.toString());
            switch (n.$) {
              case 'marksselection':
          ...
          $setFrameSizeAndUpdate: function (e, t) {
            this.$raiseVizResizeEvent(ye.$ctor(-1, -1)),
          ...
          $sendVisibleRect: function () {
            ...
            var e = P.visibleContentRectInDocumentCoordinates(
                this.get_iframe(),
              ),
              i = P.contentRectInDocumentCoordinates(this.get_iframe()),
              n = [];
          ...
          $raiseParameterValueChange: function (e) {
            t.staticEquals(this.$1$ParameterValueChangeField, null) ||
              this.$1$ParameterValueChangeField(
                new ge('parametervaluechange', this.$viz, e),
              );
          },
            ...
            this.get__workbookImpl()._update(
              t.mkdel(this, function () {
                t.staticEquals(this.$1$CustomViewSaveField, null) ||
                  this.$1$CustomViewSaveField(
                    new oe('customviewsave', this.$viz, e._impl),
                  );
              }),
            );
          },
          ...
          $raiseVizResizeEvent: function (e) {
            t.staticEquals(this.$1$VizResizeField, null) ||
              this.$1$VizResizeField(new Ne('vizresize', this.$viz, e));
          },
          ...
          $verifyOperationAllowedOnActiveSheetOrSheetWithinActiveDashboard: function (
            ...
            if (t.isNullOrUndefined(i)) throw z.createNotActiveSheet();
            return i.get_name();
          },
          $invokeAutomaticUpdatesCommandAsync: function (e) {
            if (
              ...
              throw z.createInternalError(null);
            var i = {};
          ...
          $invokeCommand: function (e, i) {
            ...
            var r = new (t.makeGenericType(ae, [Object]))(
              'api.InvokeCommandCommand',
              0,
              null,
              null,
          ...
          $handleMarksSelectionChangedEvent: function (e) {
            if (
              ...
              if (
                ...
                i = t.cast(n, I).get_worksheets()._get(e.get_worksheetName())
                  ._impl;
              }
              t.isValue(i) &&
                (i.set_selectedMarks(null),
                this.$1$MarksSelectionField(
                  new fe('marksselection', this.$viz, i),
                ));
            }
          },
            ...
            if (
              ...
              if (t.isValue(i)) {
                var r = t.cast(JSON.parse(t.cast(e.get_data(), String)), Array),
                  ...
                  s = r[1];
                this.$1$FilterChangeField(
                  new ce('filterchange', this.$viz, i, a, s),
                );
              }
            }
          },
          ...
          $handleStorytellingStateChangedEvent: function (e) {
            var i = t.cast(this.$workbookImpl.get_activeSheetImpl(), F);
              ...
              window.setTimeout(
                t.mkdel(this, function () {
                  t.staticEquals(i, null) ||
                    i(new be('firstinteractive', this.$viz)),
          ...
          $handleInitialVizSize: function (e) {
            var i = ve.fromSizeConstraints(e.sizeConstraints);
            (this.$vizSize = Ee.$ctor(i, e.chromeHeight)),
              t.isValue(this.$onFirstVizSizeKnownCallback) &&
                this.$onFirstVizSizeKnownCallback(
                  new he('firstvizsizeknown', this.$viz, this.$vizSize),
                ),
              this.$parameters.fixedSize ||
                (this.$refreshSize(),
      ...
      t.initClass(De, a, {
        ...
        $initializeFromJson: function (e) {
          (this.$caption = e.caption),
            (this.$type = W.convertFilterType(e.filterType)),
            (this.$field = null),
            (this.$dataSourceName = e.dataSourceName),
            (this.$fieldRole = W.convertFieldRole(
              t.coalesce(e.fieldRole, 'unknown'),
            )),
            (this.$fieldAggregation = W.convertFieldAggregation(
          ...
          $initializeFromJson$1: function (e) {
            if (((this.$isExclude = e.isExclude), t.isValue(e.appliedValues))) {
              ...
              for (var i = 0; i < e.appliedValues.length; i++) {
                ...
                this.$appliedValues.push(P.getDataValue(n));
              }
            }
          },
        },
      ...
      t.initClass(
        ...
        a,
        {
          ...
          $initializeFromJson$1: function (e) {
            (this.$domainMin = P.getDataValue(e.domainMinValue)),
              (this.$domainMax = P.getDataValue(e.domainMaxValue)),
              (this.$min = P.getDataValue(e.minValue)),
              (this.$max = P.getDataValue(e.maxValue)),
        ...
        a,
        {
          ...
          $initializeFromJson$1: function (e) {
            t.isValue(e.periodType) &&
              (this.$periodType = W.convertPeriodType(t.unbox(e.periodType))),
              t.isValue(e.rangeType) &&
                (this.$rangeType = W.convertDateRange(t.unbox(e.rangeType))),
      ...
      t.initClass(Je, a, {
        ...
        setFrameSize: function (e, t) {
          var i = e,
            n = t;
          P.isNumber(e) && (i = e.toString() + 'px'),
            P.isNumber(t) && (n = t.toString() + 'px'),
      ...
      (_.crossDomainEventNotificationId = 'xdomainSourceId'),
      (_.lastRequestMessage = null),
      (_.lastResponseMessage = null),
      (_.lastClientInfoResponseMessage = null),
      (_.$nextCommandId = 0),
      (E.$arrayType = 'array'),
      (E.$booleanType = 'boolean'),
      (E.$dateType = 'date'),
      (E.$functionType = 'function'),
      (E.$numberType = 'number'),
      (E.$objectType = 'object'),
      (E.$regExpType = 'regexp'),
      (E.$stringType = 'string'),
      (E.$class2type = t.mkdict([
        '[object Boolean]',
        E.$booleanType,
        '[object Number]',
        E.$numberType,
      ...
      (E.$trim = t.cast(String.prototype.trim, Function)),
      (E.$toString = t.cast(Object.prototype.toString, Function)),
      (E.$trimLeft = new RegExp('^[\\s\\xA0]+')),
      (E.$trimRight = new RegExp('[\\s\\xA0]+$')),
      (E.$rvalidchars = new RegExp('^[\\],:{}\\s]*$')),
      (E.$rvalidescape = new RegExp(
        '\\\\(?:["\\\\\\/bfnrt]|u[0-9a-fA-F]{4})',
        'g',
      )),
      (E.$rvalidtokens = new RegExp(
        '"[^"\\\\\\n\\r]*"|true|false|null|-?\\d+(?:\\.\\d*)?(?:[eE][+\\-]?\\d+)?',
        'g',
      )),
      (E.$rvalidbraces = new RegExp('(?:^|:|,)(?:\\s*\\[)+', 'g')),
      (pe.$defaultIndentStr = '\t'),
      (x.$vizs = []),
      ((Ye = e.tableauSoftware).DashboardObjectType = {
        BLANK: 'blank',
        WORKSHEET: 'worksheet',
      ...
      (Ye.ParameterAllowableValuesType = {
        ALL: 'all',
        LIST: 'list',
        RANGE: 'range',
      }),
      (Ye.ParameterDataType = {
        FLOAT: 'float',
        INTEGER: 'integer',
        STRING: 'string',
        BOOLEAN: 'boolean',
      ...
      (Ye.SelectionUpdateType = {
        REPLACE: 'replace',
        ADD: 'add',
        REMOVE: 'remove',
      }),
      (Ye.SheetSizeBehavior = {
        AUTOMATIC: 'automatic',
        EXACTLY: 'exactly',
        RANGE: 'range',
        ATLEAST: 'atleast',
      ...
      (Ye.ToolbarPosition = { TOP: 'top', BOTTOM: 'bottom' }),
      (v.$creationRegistry = null),
      (v.$singletonInstanceRegistry = null),
      (O.noZoneId = 4294967295),
      (L.$regexHierarchicalFieldName = new RegExp('\\[[^\\]]+\\]\\.', 'g')),
      (Ke.$currentVersion = new Ke(2, 0, 3, 'null'));
  })(),
