...
!(function () {
  ...
  !(function (e) {
    ...
    (a.sxb = function (e) {
      ...
      (a.ck = function (e, t) {
        if (a.isValue(e) && !t.isInstanceOfType(e)) throw new z();
        return e;
      }),
      (a.trunc = function (e) {
    ...
    a.initClass(R, E);
    var P = (a.ArithmeticException = a.mkType(
      a,
    ...
    a.initClass(P, E);
    var z = (a.OverflowException = a.mkType(
      a,
      'ss.OverflowException',
      function (e, t) {
        P.call(this, e || 'Arithmetic operation resulted in an overflow.', t);
      },
    ));
    a.initClass(z, P);
    var x = (a.DivideByZeroException = a.mkType(
      a,
      'ss.DivideByZeroException',
      function (e, t) {
        P.call(this, e || 'Division by 0.', t);
      },
    ));
    a.initClass(x, P);
  ...
  (e.tableauSoftware = e.tableauSoftware || {}),
    ...
    (function () {
      ...
      var E,
        ...
        z = (e.tab.NonApiCommand = t.mkType(
          n,
          'tab.NonApiCommand',
          function (e, t) {
        ...
        x = (e.tab.Point = t.mkType(n, 'tab.Point', null, null, {
          $ctor: function (e, t) {
            var i = new Object();
        ...
        q = (e.tableauSoftware.Mark = t.mkType(
          ...
          function (e) {
            (this.impl = null), (this.impl = new P(e));
          },
          {
            getPairs: function () {
    ...
    (function () {
      ...
      var r = (e.tab._ApiBootstrap = t.mkType(
        ...
        E = (e.tab.FirstVizSizeKnownEvent = t.mkType(
          ...
          function (e, t, i) {
            (this.$vizSize = null), z.call(this, e, t), (this.$vizSize = i);
          },
          {
            getVizSize: function () {
              return this.$vizSize;
        ...
        P = (e.tab.StoryPointSwitchEvent = t.mkType(
          n,
        ...
        x = (e.tab.TabSwitchEvent = t.mkType(
          n,
          'tab.TabSwitchEvent',
          function (e, t, i, n) {
            (this.$oldName = null),
          ...
          },
          {
            ...
            $raiseTabSwitch: function (e, i) {
              t.staticEquals(this.$1$TabSwitchField, null) ||
                this.$1$TabSwitchField(new x('tabswitch', this.$viz, e, i));
            },
            raiseStoryPointSwitch: function (e, i) {
              t.staticEquals(this.$1$StoryPointSwitchField, null) ||
                this.$1$StoryPointSwitchField(
                  new P('storypointswitch', this.$viz, e, i),
                );
            },
                  ...
                  t.mkdel(this, function () {
                    this.$onFirstInteractiveAlreadyCalled ||
                      (t.staticEquals(i, null) ||
                        i(new z('firstinteractive', this.$viz)),
      ...
      t.initClass(r),
        ...
        (le.$currentVersion = new le(2, 5, 0, 'null'));
    })(),
