...
!(function () {
  ...
  !(function (e) {
    ...
    (r.initAssembly = function (e, t, i) {
      (i = i || {}),
        ...
        (e.getResourceData = function (e) {
          var t = i[e];
          return t ? r.dec64(t) : null;
        }),
        (r.__assemblies[t] = e);
    }),
      r.initAssembly(r, 'mscorlib'),
      (r.getAssemblies = function () {
      ...
      (r.equals = function (e, t) {
        if (!r.isValue(e)) throw new M('Object is null');
        return e !== r && 'function' == typeof e.equals
          ? e.equals(t)
          : r.isDate(e) && r.isDate(t)
          ? e.valueOf() === t.valueOf()
          : 'function' == typeof e && 'function' == typeof t
          ? r.delegateEquals(e, t)
          : !(!r.isNullOrUndefined(e) || !r.isNullOrUndefined(t)) || e === t;
      }),
        ...
        (Object.keys =
          ...
          function (e) {
            ...
            var r,
              s,
              o = [];
            for (r in e) t.call(e, r) && o.push(r);
            if (i) for (s = 0; s < a; s++) t.call(e, n[s]) && o.push(n[s]);
            return o;
          })),
      ...
      (r.__genericCache = {}),
      (r._makeGenericTypeName = function (e, t) {
        for (var i = e.__typeName, n = 0; n < t.length; n++)
          i += (0 === n ? '[' : ',') + '[' + r.getTypeQName(t[n]) + ']';
        return (i += ']');
      }),
      (r.makeGenericType = function (e, t) {
        var i = r._makeGenericTypeName(e, t);
        return r.__genericCache[i] || e.apply(null, t);
      }),
      (r.registerGenericClassInstance = function (e, t, i, n, a, s) {
        var o = r._makeGenericTypeName(t, i);
        (r.__genericCache[o] = e),
          (e.__typeName = o),
          (e.__genericTypeDefinition = t),
          (e.__typeArguments = i),
          r.initClass(e, t.__assembly, n, a(), s());
      }),
      (r.registerGenericInterfaceInstance = function (e, t, i, n, a) {
        var s = r._makeGenericTypeName(t, i);
        (r.__genericCache[s] = e),
          (e.__typeName = s),
          (e.__genericTypeDefinition = t),
          (e.__typeArguments = i),
          r.initInterface(e, t.__assembly, n, a());
      }),
        ...
        (e.__metadata = t),
          t.variance &&
            (e.isAssignableFrom = function (e) {
              var t = function (e, t) {
                if (
                  ...
                  for (var i = 0; i < e.__typeArguments.length; i++) {
                    ...
                    switch (n) {
                      case 1:
                        if (!r.isAssignableFrom(a, s)) return !1;
                        break;
                      case 2:
                        if (!r.isAssignableFrom(s, a)) return !1;
                        break;
                      default:
                        if (s !== a) return !1;
                    }
              ...
              for (var i = r.getInterfaces(e), n = 0; n < i.length; n++)
                if (i[n] === this || t(this, i[n])) return !0;
              return !1;
            });
      }),
      (r.setMetadata = function (e, t) {}),
      (r.initClass = function (e, t, i, n, a) {
        if (
          ((e.__class = !0),
          (e.__assembly = t),
      ...
      (r.getTypeQName = function (e) {
        return (
          r.getTypeFullName(e) + (e.__assembly ? ', ' + e.__assembly.name : '')
        );
      }),
      ...
      (r.getTypeAssembly = function (e) {
        return r.contains([Date, Number, Boolean, String, Function, Array], e)
          ? r
          : e.__assembly || null;
      }),
      ...
      (r.createAssemblyInstance = function (e, t) {
        var i = r.getType(t, e);
        return i ? r.createInstance(i) : null;
      }),
      ...
      (r.isInstanceOfType = function (e, t) {
        return (
          ...
          ('function' == typeof t.isInstanceOfType
            ...
            : r.isAssignableFrom(t, r.getInstanceType(e)))
        );
      }),
      ...
      (r.safeCast = function (e, t) {
        return !0 === t
          ...
          : !1 === t
          ? null
          : r.isInstanceOfType(e, t)
          ? e
          : null;
      }),
      (r.cast = function (e, t) {
        if (null == e) return e;
        if (!0 === t || (!1 !== t && r.isInstanceOfType(e, t))) return e;
        throw new P('Cannot cast object to type ' + r.getTypeFullName(t));
      }),
      (r.getInstanceType = function (e) {
        if (!r.isValue(e)) throw new M('Cannot get type of null');
        try {
      ...
      (r._getType = function (t, i, n) {
        var a,
          ...
          u = [];
        if (l)
          switch (((a = t.substring(o, l.index)), l[0])) {
            case '[':
              if ('[' != t[l.index + 1]) return null;
              for (;;) {
                if ((n.exec(t), !(c = r._getType(t, e, n)))) return null;
        ...
        else a = t.substring(o);
        if (s && n.lastIndex) return null;
        var c = r._getAssemblyType(i, a.trim());
        return u.length ? r.makeGenericType(c, u) : c;
      }),
    ...
    (s.__typeName = 'ss.IFormattable'),
      (r.IFormattable = s),
      r.initInterface(s, r, { format: null });
    var o = function () {};
    (o.__typeName = 'ss.IComparable'),
      (r.IComparable = o),
      r.initInterface(o, r, { compareTo: null });
    var l = function () {};
    (l.__typeName = 'ss.IEquatable'),
      (r.IEquatable = l),
      r.initInterface(l, r, { equalsT: null }),
      (r.isNullOrEmptyString = function (e) {
        return !e || !e.length;
      }),
      ...
      Array.prototype.forEach ||
        (Array.prototype.forEach = function (e, t) {
          ...
          for (arguments.length > 1 && (i = t), n = 0; n < r; ) {
            var s;
            n in a && ((s = a[n]), e.call(i, s, n, a)), n++;
          }
        }),
      ...
      (r._mkdel = function (e) {
        var t = function () {
          ...
          for (var t = r.arrayClone(e), i = 0; i < t.length; i += 2)
            r._delegateContains(e, t[i], t[i + 1]) &&
      ...
      (r.delegateCombine = function (e, t) {
        if (!e) return t._targets ? t : r.mkdel(null, t);
        if (!t) return e._targets ? e : r.mkdel(null, e);
        var i = e._targets ? e._targets : [null, e],
          n = t._targets ? t._targets : [null, t];
        return r._mkdel(i.concat(n));
      }),
      (r.delegateRemove = function (e, t) {
        ...
        var i,
          n = e._targets,
          a = null;
        t._targets ? ((a = t._targets[0]), (i = t._targets[1])) : (i = t);
        for (var s = 0; s < n.length; s += 2)
          if (n[s] === a && n[s + 1] === i) {
            if (2 == n.length) return null;
            var o = r.arrayClone(n);
            return o.splice(s, 2), r._mkdel(o);
          }
        return e;
      }),
      (r.delegateEquals = function (e, t) {
        ...
        for (var a = 0; a < i.length; a++) if (i[a] !== n[a]) return !1;
        return !0;
      });
    var u = function () {};
    ...
    (c.__typeName = 'ss.IEnumerator'),
      (r.IEnumerator = c),
      r.initInterface(c, r, { current: null, moveNext: null, reset: null }, [
        C,
      ]);
    var h = function () {};
    (h.__typeName = 'ss.IEnumerable'),
      (r.IEnumerable = h),
      r.initInterface(h, r, { getEnumerator: null }),
      (r.getEnumerator = function (e) {
    ...
    (d.__typeName = 'ss.IEqualityComparer'),
      (r.IEqualityComparer = d),
      r.initInterface(d, r, { areEqual: null, getObjectHashCode: null });
    var p = function () {};
    (p.__typeName = 'ss.IComparer'),
      (r.IComparer = p),
      r.initInterface(p, r, { compare: null }),
      (r.unbox = function (e) {
        if (!r.isValue(e)) throw new U('Nullable object must have a value.');
        return e;
      });
    var f = function (e) {
      var t = function () {};
      return (
        ...
        r.registerGenericClassInstance(
          t,
          f,
          [e],
          {},
    ...
    (_.__typeName = 'ss.Int32'),
      ...
      (_.div = function (e, t) {
        if (!r.isValue(e) || !r.isValue(t)) return null;
        if (0 === t) throw new x();
        return _.trunc(e / t);
      }),
      (_.trunc = function (e) {
      ...
      (_.tryParse = function (e, t, i, n) {
        ...
        var a = parseInt(e, 10);
        return !(a < i || a > n) && ((t.$ = a), !0);
      });
    var v = function () {};
    (v.__typeName = 'ss.JsDate'),
      (r.JsDate = v),
      r.initClass(v, r, {}, Object, [l, o]),
    ...
    var b = function () {};
    (b.__typeName = 'ss.EqualityComparer'),
      (r.EqualityComparer = b),
      r.initClass(
        b,
        r,
        {
    ...
    var C = function () {};
    (C.__typeName = 'ss.IDisposable'),
      (r.IDisposable = C),
      r.initInterface(C, r, { dispose: null });
    var I = function (e) {
      (this._parts = r.isValue(e) && '' != e ? [e] : []),
        (this.length = r.isValue(e) ? e.length : 0);
    };
    (I.__typeName = 'ss.StringBuilder'),
      (r.StringBuilder = I),
      r.initClass(I, r, {
        append: function (e) {
          if (r.isValue(e)) {
            var t = e.toString();
            r.add(this._parts, t), (this.length += t.length);
          }
          return this;
        },
    ...
    (N.__typeName = 'ss.Exception'),
      ...
      r.initClass(N, r, {
        ...
        toString: function () {
          var e = this._message,
            t = this;
          return (
            r.isNullOrEmptyString(e) &&
              (e =
                r.isValue(r.getInstanceType(t)) &&
                r.isValue(r.getTypeFullName(r.getInstanceType(t)))
                  ? r.getTypeFullName(r.getInstanceType(t))
                  : '[object Exception]'),
            e
          );
        },
      ...
      (N.wrap = function (e) {
        return r.isInstanceOfType(e, N)
          ? e
          : e instanceof TypeError
          ? new M(e.message, new O(e))
          : e instanceof RangeError
          ? new D(null, e.message, new O(e))
          : e instanceof Error
          ? new O(e)
          : new N(e.toString());
      });
    ...
    (A.__typeName = 'ss.NotImplementedException'),
      (r.NotImplementedException = A),
      r.initClass(A, r, {}, N);
    var T = function (e, t) {
      N.call(this, e || 'Specified method is not supported.', t);
    };
    (T.__typeName = 'ss.NotSupportedException'),
      (r.NotSupportedException = T),
      r.initClass(T, r, {}, N);
    var V = function (e, t) {
      (this.innerExceptions = r.isValue(t) ? r.arrayFromEnumerable(t) : []),
        N.call(
          this,
    ...
    (V.__typeName = 'ss.AggregateException'),
      (r.AggregateException = V),
      r.initClass(
        V,
        r,
        {
    ...
    var k = function (e, t, i) {
      N.call(
        ...
        (this.arguments = r.arrayClone(e));
    };
    (k.__typeName = 'ss.PromiseException'),
      (r.PromiseException = k),
      r.initClass(
        k,
        r,
        {
    ...
    var F = function (e, t, i) {
      N.call(this, e || 'Value does not fall within the expected range.', i),
        (this.paramName = t || null);
    };
    (F.__typeName = 'ss.ArgumentException'),
      (r.ArgumentException = F),
      r.initClass(F, r, {}, N);
    ...
    (R.__typeName = 'ss.ArgumentNullException'),
      (r.ArgumentNullException = R),
      r.initClass(R, r, {}, F);
    ...
    (D.__typeName = 'ss.ArgumentOutOfRangeException'),
      (r.ArgumentOutOfRangeException = D),
      r.initClass(D, r, {}, F);
    var z = function (e, t) {
    ...
    (x.__typeName = 'ss.DivideByZeroException'),
      (r.DivideByZeroException = x),
      r.initClass(x, r, {}, N);
    var P = function (e, t) {
      N.call(this, e || 'The cast is not valid.', t);
    };
    (P.__typeName = 'ss.InvalidCastException'),
      (r.InvalidCastException = P),
      r.initClass(P, r, {}, N);
    var U = function (e, t) {
      N.call(
        this,
    ...
    (U.__typeName = 'ss.InvalidOperationException'),
      (r.InvalidOperationException = U),
      r.initClass(U, r, {}, N);
    var M = function (e, t) {
      N.call(this, e || 'Object is null.', t);
    };
    (M.__typeName = 'ss.NullReferenceException'),
      (r.NullReferenceException = M),
      r.initClass(M, r, {}, N);
    var H = function (e, t) {
      N.call(this, e || 'Key not found.', t);
    };
    (H.__typeName = 'ss.KeyNotFoundException'),
      (r.KeyNotFoundException = H),
      r.initClass(H, r, {}, N);
    var L = function (e, t) {
      N.call(this, e || 'Ambiguous match.', t);
    };
    (L.__typeName = 'ss.AmbiguousMatchException'),
      (r.AmbiguousMatchException = L),
      r.initClass(L, r, {}, N);
    var j = function (e, t) {
      (this._getEnumerator = e), (this._this = t);
    };
    (j.__typeName = 'ss.IteratorBlockEnumerable'),
      (r.IteratorBlockEnumerable = j),
      r.initClass(
        j,
        r,
        {
  ...
  !(function () {
    ...
    (n.__typeName = 'tab.BaseLogAppender'), (e.tab.BaseLogAppender = n);
    var a = function () {
      (this.$levelMethods = null), n.call(this);
    };
    (a.__typeName = 'tab.ConsoleLogAppender'), (e.tab.ConsoleLogAppender = a);
    var r = function () {};
    (r.__typeName = 'tab.CookieHelper'),
      (r.getValueForCookie = function (e) {
        var i = s
          .getCookie()
          .match(new RegExp('(?:^|;) ?' + e + '=([^;]*)(?:;|$)'));
      ...
      (r.setCookie = function (e, i, n, a) {
        var r = e + '=' + i + ';path=' + n + ';';
        t.staticEquals(a, null) || (r += 'expires=' + a.toUTCString()),
          s.setCookie(r);
      }),
      ...
      (e.tab.CookieHelper = r);
    var s = function () {};
    (s.__typeName = 'tab.DocumentHelper'),
      (s.get_documentClientWidth = function () {
      ...
      (e.tab.DocumentHelper = s);
    var o = function () {};
    (o.__typeName = 'tab.EscapingUtil'),
      ...
      (e.tab.EscapingUtil = o);
    var l = function () {};
    (l.__typeName = 'tab.LazyUtil'),
      (l.lazyInitStaticField = function (e, i, n) {
        var a = e[i];
        return t.isNullOrUndefined(a) && ((a = n()), (e[i] = a)), a;
      }),
      (e.tab.LazyUtil = l);
    var u = function () {};
    (u.__typeName = 'tab.Log'),
      (u.get = function (e) {
    ...
    (c.__typeName = 'tab.LogAppenderInstance'), (e.tab.LogAppenderInstance = c);
    var h = function (e) {
      (this.$name = null), (this.$name = e);
    };
    (h.__typeName = 'tab.Logger'),
      (h.get_globalLog = function () {
        return h.global;
      }),
      ...
      (h.get_$nullLog = function () {
        return t.cast(
          l.lazyInitStaticField(h, 'nullLog', function () {
            return new h('');
          }),
          h,
        );
      ...
      (h.removeAppender = function (e) {
        var t = h.get_$appenders().indexOf(e);
        t > -1 && h.get_$appenders().splice(t, 1);
      }),
      ...
      (h.getLogger = function (e, i) {
        var n = h.getLoggerWithName(t.getTypeName(e));
        return t.isValue(i) && h.filterByLogger(n, t.unbox(i)), n;
      }),
      (h.getLoggerWithName = function (e) {
        return new h(e);
      }),
      (h.$setupUrlFilters = function () {
        var e = p.getUriQueryParameters(window.self.location.search);
        if (t.keyExists(e, h.$logQueryParam)) {
          h.clearFilters();
          var i = e[h.$logQueryParam];
          0 === i.length && h.filterByName('.*', 0);
          for (var n = 0; n < i.length; n++) {
            var a = i[n].split(String.fromCharCode(58)),
              r = 1;
            if (a.length > 0 && t.isValue(a[1])) {
              var s = a[1].toLowerCase(),
                o = h.loggerLevelNames.indexOf(s);
              o >= 0 && (r = o);
            }
      ...
      (h.$addFilter = function (e) {
        h.get_$filters().push(e);
        for (var t = h.get_$appenders(), i = 0; i < t.length; i++) {
          t[i].addFilter(e);
        }
      }),
      (e.tab.Logger = h);
    var m = function () {};
    (m.__typeName = 'tab.LoggerLevel'), (e.tab.LoggerLevel = m);
    var d = function () {};
    (d.__typeName = 'tab.ScriptEx'), (e.tab.ScriptEx = d);
    var p = function () {};
    (p.__typeName = 'tab.UriExtensions'),
      (p.getUriQueryParameters = function (e) {
        var i = {};
        ...
        var a = e.substr(n + 1),
          r = a.indexOf('#');
        if ((r >= 0 && (a = a.substr(0, r)), t.isNullOrEmptyString(a)))
          return i;
        for (var s = a.split('&'), o = 0; o < s.length; o++) {
          var l,
            u = s[o].split('='),
      ...
      (e.tab.UriExtensions = p);
    var f = function (e) {
      (this.$window = null), (this.$window = e);
    };
    (f.__typeName = 'tab.WindowHelper'),
      (f.get_windowSelf = function () {
        return window.self;
      }),
      ...
      (f.$setDefaultRequestAnimationFrameImpl = function () {
        var e = 0;
        f.$requestAnimationFrameFunc = function (t) {
      ...
      t.initClass(n, i, {
        ...
        formatMessage: function (e, i) {
          ...
          for (
            var n = new t.StringBuilder(), a = 0, r = !1, s = 0;
            s < e.length;
            s++
          ) {
            var o = e.charCodeAt(s);
            if (37 === o) r ? (n.append('%'), (r = !1)) : (r = !0);
            else {
              if (r)
                switch (o) {
                  case 98:
      ...
      t.initClass(c, i, {
        ...
        enableLogging: function (e) {
          t.isNullOrUndefined(this.get_instance())
            ? (this.set_instance(this.$appenderFactoryFunc()),
              h.addAppender(this.get_instance()))
            : h.hasAppender(this.get_instance()) ||
              h.addAppender(this.get_instance()),
        ...
        disableLogging: function () {
          t.isNullOrUndefined(this.get_instance()) ||
            (h.removeAppender(this.get_instance()), this.set_instance(null));
        },
      }),
      t.initClass(h, i, {
        get_name: function () {
      ...
      (h.global = h.getLoggerWithName('global')),
      (h.loggerLevelNames = []),
      (h.$logQueryParam = ':log'),
      h.$setupUrlFilters(),
      (h.loggerLevelNames[0] = 'all'),
      (h.loggerLevelNames[1] = 'debug'),
      (h.loggerLevelNames[2] = 'info'),
      (h.loggerLevelNames[3] = 'warn'),
      (h.loggerLevelNames[4] = 'error'),
      (h.loggerLevelNames[5] = 'off'),
      (a.globalAppender = new c(function () {
        return new a();
      ...
      (function () {
        (f.blank = '_blank'),
          (f.$innerWidthFunc = null),
          (f.$innerHeightFunc = null),
          (f.$clientWidthFunc = null),
          (f.$clientHeightFunc = null),
          (f.$pageXOffsetFunc = null),
          (f.$pageYOffsetFunc = null),
          (f.$screenLeftFunc = null),
          (f.$screenTopFunc = null),
          (f.$outerWidthFunc = null),
          (f.$outerHeightFunc = null),
          (f.$requestAnimationFrameFunc = null),
          (f.$cancelAnimationFrameFunc = null),
          (f.$innerWidthFunc =
          ...
          (f.$pageXOffsetFunc = t.isValue(window.self.pageXOffset)
            ? function (e) {
          ...
          (f.$pageYOffsetFunc = t.isValue(window.self.pageYOffset)
            ? function (e) {
        ...
        var e = 'requestAnimationFrame',
          ...
          a = null,
          r = null;
        e in window && (a = e), i in window && (r = i);
        for (
          var s = 0;
          s < n.length && (t.isNullOrUndefined(a) || t.isNullOrUndefined(r));
          ++s
        ) {
          var o = n[s],
            l = o + 'RequestAnimationFrame';
          t.isNullOrUndefined(a) && l in window && (a = l),
            t.isNullOrUndefined(r) &&
              ((l = o + 'CancelAnimationFrame') in window && (r = l),
              (l = o + 'CancelRequestAnimationFrame') in window && (r = l));
        }
        t.isValue(a)
          ? (f.$requestAnimationFrameFunc = function (e) {
              return window[a](e);
            })
          : f.$setDefaultRequestAnimationFrameImpl(),
          (f.$cancelAnimationFrameFunc = t.isValue(r)
            ? function (e) {
                window[r](e);
              }
            : window.clearTimeout);
  ...
  (e.tableauSoftware = e.tableauSoftware || {}),
    ...
    (function () {
      ...
      (e.tab = e.tab || {}),
        (e.tableauSoftware = e.tableauSoftware || {}),
        t.initAssembly(r, 'vqlapishared');
      var s = function () {};
      (s.__typeName = 'tab.$DeferredUtil'),
        (s.$coerceToTrustedPromise = function (e) {
          var i;
          if (e instanceof tableauSoftware.Promise) i = t.cast(e, _);
          else if (
            (t.isValue(e) &&
            ...
            var n = new f();
            t.cast(e, _).then(t.mkdel(n, n.resolve), t.mkdel(n, n.reject)),
              (i = n.get_promise());
          } else i = s.$resolved(e);
          return i;
        }),
      ...
      o.__typeName = 'tab.$DoNothingCrossDomainHandler';
      ...
      (l.__typeName = 'tab._ApiCommand'),
        (l.generateNextCommandId = function () {
          var e = 'cmd' + l.$nextCommandId;
          return l.$nextCommandId++, e;
        }),
        (l.parse = function (e) {
          var i,
            n,
            a = e.indexOf(String.fromCharCode(44));
          if (a < 0) return (i = t.cast(e, String)), new l(i, null, null, null);
          i = t.cast(e.substr(0, a), String);
          var r,
            s = e.substr(a + 1);
          if ((a = s.indexOf(String.fromCharCode(44))) < 0)
            return new l(i, (n = s), null, null);
          n = s.substr(0, a);
          var o = s.substr(a + 1);
          if ((a = o.indexOf(String.fromCharCode(44))) < 0)
            return new l(i, n, (r = o), null);
          r = o.substr(0, a);
          var u = o.substr(a + 1);
          return (
            (l.lastResponseMessage = e),
            'api.GetClientInfoCommand' === i &&
              (l.lastClientInfoResponseMessage = e),
            new l(i, n, r, u)
          );
        }),
        (e.tab._ApiCommand = l);
      var u = function () {};
      (u.__typeName = 'tab._ApiObjectRegistry'),
        (u.registerApiMessageRouter = function (e) {
          ...
          return function () {
            ...
            return (
              t.isNullOrUndefined(a) &&
                ((a = u.$createType(e).call(null)), (i[n] = a)),
              a
            );
          };
        }),
      ...
      (c.__typeName = 'tab._ApiServerNotification'),
        ...
        (e.tab._ApiServerNotification = c);
      var h = function (e) {
      ...
      (h.__typeName = 'tab._ApiServerResultParser'),
        (e.tab._ApiServerResultParser = h);
      var m = function () {
        (this.$items = []), (this.$itemMap = {});
      };
      (m.__typeName = 'tab._CollectionImpl'), (e.tab._CollectionImpl = m);
      var d = function (e, i, n, a) {
        (this.$fieldName = null),
          (this.$dataType = null),
          (this.$isReferenced = !1),
          (this.$index = 0),
          $.verifyString(e, 'Column Field Name'),
          (this.$fieldName = e),
          (this.$dataType = i),
          (this.$isReferenced = t.coalesce(n, !1)),
          (this.$index = a);
      };
      (d.__typeName = 'tab._ColumnImpl'), (e.tab._ColumnImpl = d);
      ...
      (p.__typeName = 'tab._DataTableImpl'), (e.tab._DataTableImpl = p);
      var f = function () {
        (this.$promise = null),
          (this.$thenFunc = null),
          (this.$listeners = []),
          (this.$resolveFunc = null),
          (this.$promise = new _(t.mkdel(this, this.then))),
          (this.$thenFunc = t.mkdel(this, this.$preResolutionThen)),
          (this.$resolveFunc = t.mkdel(this, this.$transitionToFulfilled));
      };
      (f.__typeName = 'tab._DeferredImpl'), (e.tab._DeferredImpl = f);
      var g = function () {};
      (g.__typeName = 'tab._jQueryShim'),
        ...
        (g.isArray = function (e) {
          return t.isValue(Array.isArray)
            ...
            : t.referenceEquals(g.type(e), g.$arrayType);
        }),
        (g.type = function (e) {
          return t.isNullOrUndefined(e)
            ? String(e)
            : g.$class2type[t.cast(g.$toString.call(e), String)] ||
                g.$objectType;
        }),
        (g.trim = function (e) {
          return t.isValue(g.$trim)
            ? t.isNullOrUndefined(e)
              ? ''
              : t.cast(g.$trim.call(e), String)
            : t.isNullOrUndefined(e)
            ? ''
            : e.toString().replace(g.$trimLeft, '').replace(g.$trimRight, '');
        }),
        (g.parseJSON = function (e) {
          if ('string' != typeof e || t.isNullOrUndefined(e)) return null;
          if (((e = g.trim(e)), t.isValue(JSON) && t.isValue(JSON.parse)))
            return JSON.parse(e);
          if (
            g.$rvalidchars.test(
              e
                .replace(g.$rvalidescape, '@')
        ...
        (e.tab._jQueryShim = g);
      var $ = function () {};
      ($.__typeName = 'tab._Param'),
        ($.verifyString = function (e, i) {
          if (t.isNullOrUndefined(e) || 0 === e.length)
            throw y.createInternalStringArgumentException(i);
        }),
        ($.verifyValue = function (e, i) {
          if (t.isNullOrUndefined(e))
            throw y.createInternalNullArgumentException(i);
        }),
        (e.tab._Param = $);
      var _ = function (e) {
        (this.then = null), (this.then = e);
      };
      (_.__typeName = 'tab._PromiseImpl'), (e.tab._PromiseImpl = _);
      ...
      (v.__typeName = 'tab._Rect'), (e.tab._Rect = v);
      var y = function () {};
      (y.__typeName = 'tab._TableauException'),
        ...
        (e.tab._TableauException = y);
      var w = function () {};
      (w.__typeName = 'tab._Utility'),
        (w.isNullOrEmpty = function (e) {
        ...
        (w.toInt = function (e) {
          if (w.isNumber(e)) return t.Int32.trunc(e);
        ...
        (w.findParentWithClassName = function (e, n, a) {
          var r = t.isValue(e) ? t.cast(e.parentNode, i) : null;
          for (a = a || document.body; t.isValue(r); ) {
            if (w.hasClass(r, n)) return r;
            r = t.referenceEquals(r, a) ? null : t.cast(r.parentNode, i);
          }
          return r;
        }),
        ...
        (w.elementToString = function (e) {
          ...
          if (
            ...
            w.isNullOrEmpty(e.id) || i.append('#').append(e.id),
            !w.isNullOrEmpty(e.className))
          ) {
        ...
        (w.visibleContentRectInDocumentCoordinates = function (e) {
          for (
            var i = w.contentRectInDocumentCoordinates(e), n = e.parentElement;
            t.isValue(n) && t.isValue(n.parentElement);
            n = n.parentElement
          ) {
            var a = w.$getComputedStyle(n).overflow;
            ('auto' !== a && 'scroll' !== a && 'hidden' !== a) ||
              (i = i.intersect(w.contentRectInDocumentCoordinates(n)));
          }
          var r = w.$getViewportRect();
        ...
        (w.getVisualViewportRect = function (e) {
          ...
          return t.isValue(i)
            ? new v(
                t.Int32.trunc(i.pageLeft),
                t.Int32.trunc(i.pageTop),
                t.Int32.trunc(i.width),
                t.Int32.trunc(i.height),
              )
            : null;
        }),
        (w.$getViewportRect = function () {
          var e = w.getVisualViewportRect(window.self);
          if (t.isValue(e)) return e;
          var i = w.contentRectInDocumentCoordinates(document.documentElement),
            n = new a.WindowHelper(window.self);
          return (
            n.isQuirksMode() &&
              ((i.height = document.body.clientHeight - i.left),
              (i.width = document.body.clientWidth - i.top)),
            (i.left += n.get_pageXOffset()),
            (i.top += n.get_pageYOffset()),
            i
          );
        }),
        (w.contentRectInDocumentCoordinates = function (e) {
          var t = w.getBoundingClientRect(e),
            ...
            h = t.top + r + o + u.get_pageYOffset();
          return new v(c, h, l.width, l.height);
        }),
        ...
        (w.getDataValue = function (e) {
          return t.isNullOrUndefined(e)
            ? q.$ctor(null, null, null)
            : q.$ctor(
                w.convertRawValue(e.value, e.type),
                e.formattedValue,
                e.aliasedValue,
              );
        }),
        ...
        (w.computeContentSize = function (e) {
          var t = w.$getComputedStyle(e),
            ...
            o = e.clientHeight - Math.round(n + r);
          return ae.$ctor(s, o);
        }),
        ...
        (w.noResultPromiseHelper = function (e, i, n) {
          var r = new a._Deferred(),
            s = new (t.makeGenericType(j, [Object]))(
              e,
              1,
              function (e) {
                r.resolve();
        ...
        (e.tab._Utility = w);
      var b = function () {};
      (b.__typeName = 'tab.ApiDashboardObjectType'),
        (e.tab.ApiDashboardObjectType = b);
      var S = function () {};
      (S.__typeName = 'tab.ApiDateRangeType'), (e.tab.ApiDateRangeType = S);
      var C = function () {};
      (C.__typeName = 'tab.ApiDeviceType'), (e.tab.ApiDeviceType = C);
      var I = function () {};
      (I.__typeName = 'tab.ApiEnumConverter'),
        ...
        (e.tab.ApiEnumConverter = I);
      var E = function () {};
      (E.__typeName = 'tab.ApiErrorCode'), (e.tab.ApiErrorCode = E);
      var N = function () {};
      (N.__typeName = 'tab.ApiFieldAggregationType'),
        (e.tab.ApiFieldAggregationType = N);
      var A = function () {};
      (A.__typeName = 'tab.ApiFieldRoleType'), (e.tab.ApiFieldRoleType = A);
      var T = function () {};
      (T.__typeName = 'tab.ApiFilterType'), (e.tab.ApiFilterType = T);
      var V = function () {};
      (V.__typeName = 'tab.ApiFilterUpdateType'),
        (e.tab.ApiFilterUpdateType = V);
      var k = function () {};
      (k.__typeName = 'tab.ApiMessageHandler'), (e.tab.ApiMessageHandler = k);
      var O = function (e, t) {
        (this.$router = null),
          (this.$handler = null),
          $.verifyValue(e, 'router'),
          (this.$router = e),
          (this.$handler = t);
      };
      (O.__typeName = 'tab.ApiMessagingOptions'),
        (e.tab.ApiMessagingOptions = O);
      var F = function () {};
      (F.__typeName = 'tab.ApiNullOption'), (e.tab.ApiNullOption = F);
      var R = function () {};
      (R.__typeName = 'tab.ApiParameterAllowableValuesType'),
        (e.tab.ApiParameterAllowableValuesType = R);
      var D = function () {};
      (D.__typeName = 'tab.ApiParameterDataType'),
        (e.tab.ApiParameterDataType = D);
      var z = function () {};
      (z.__typeName = 'tab.ApiPeriodType'), (e.tab.ApiPeriodType = z);
      var x = function () {};
      (x.__typeName = 'tab.ApiSelectionUpdateType'),
        (e.tab.ApiSelectionUpdateType = x);
      var P = function () {};
      (P.__typeName = 'tab.ApiSheetSizeBehavior'),
        (e.tab.ApiSheetSizeBehavior = P);
      var U = function () {};
      (U.__typeName = 'tab.ApiSheetType'), (e.tab.ApiSheetType = U);
      var M = function () {};
      (M.__typeName = 'tab.ApiTableauEventName'),
        (e.tab.ApiTableauEventName = M);
      var H = function () {};
      (H.__typeName = 'tab.ApiToolbarButtonName'),
        (e.tab.ApiToolbarButtonName = H);
      var L = function () {};
      (L.__typeName = 'tab.ApiToolbarPosition'), (e.tab.ApiToolbarPosition = L);
      var j = function (e) {
      ...
      (j.__typeName = 'tab.CommandReturnHandler$1'),
        t.initGenericClass(j, r, 1),
        (e.tab.CommandReturnHandler$1 = j);
      var W = function (e) {
        if (
        ...
        else if (w.hasDocumentAttachEvent()) {
      ...
      (W.__typeName = 'tab.CrossDomainMessager'),
        (e.tab.CrossDomainMessager = W);
      var B = function () {};
      (B.__typeName = 'tab.DataType'), (e.tab.DataType = B);
      var q = function () {};
      (q.__typeName = 'tab.DataValue'),
        (q.$ctor = function (e, t, i) {
          var n = new Object();
          return (
            (n.value = null),
        ...
        (e.tab.DataValue = q);
      var G = function () {};
      (G.__typeName = 'tab.FilterCommandsBuilder'),
        (e.tab.FilterCommandsBuilder = G);
      var Q = function () {};
      (Q.__typeName = 'tab.GetDataCommandsBuilder'),
        (e.tab.GetDataCommandsBuilder = Q);
      var J = function () {
        (this.$2$StateReadyForQueryField = null), k.call(this);
      };
      (J.__typeName = 'tab.HostedApiMessageHandler'),
        (e.tab.HostedApiMessageHandler = J);
      var K = function () {
        (this.$crossDomainMessager = null),
          (this.$crossDomainMessager = new W(null));
      };
      (K.__typeName = 'tab.HostedApiMessageRouter'),
        (e.tab.HostedApiMessageRouter = K);
      var Y = function (e) {
        if (
          ((this.$clonedPairs = null),
          (this.$collection = new a._Collection()),
          (this.$tupleId = 0),
          g.isArray(e))
        )
          for (var i = e, n = 0; n < i.length; n++) {
            var r = i[n];
            if (!t.isValue(r.fieldName))
              throw y.createInvalidParameter('pair.fieldName');
            if (!t.isValue(r.value))
              throw y.createInvalidParameter('pair.value');
            var s = new ce(r.fieldName, r.value);
            this.$collection._add(s.fieldName, s);
          }
        else this.$tupleId = e;
      };
      (Y.__typeName = 'tab.MarkImpl'),
        (Y.processActiveMarks = function (e) {
          var i = new a._Collection();
          if (t.isNullOrUndefined(e) || w.isNullOrEmpty(e.marks)) return i;
          for (var n = 0; n < e.marks.length; n++) {
            var r = e.marks[n],
              s = r.tupleId,
              o = new oe(s);
            i._add(s.toString(), o);
            for (var l = 0; l < r.pairs.length; l++) {
              var u = r.pairs[l],
                c = w.convertRawValue(u.value, u.valueDataType),
                h = new ce(u.fieldName, c);
      ...
      (X.__typeName = 'tab.NonApiCommand'),
        (X.parse = function (e) {
        ...
        (e.tab.NonApiCommand = X);
      var Z = function () {};
      (Z.__typeName = 'tab.Point'),
        (Z.$ctor = function (e, t) {
          var i = new Object();
        ...
        (e.tab.Point = Z);
      var ee = function () {};
      (ee.__typeName = 'tab.PublicEnums'),
        (ee.tryNormalizeEnum = function (e) {
          return function (i, n) {
            if (t.isValue(i))
              for (
                var a = i.toString().toUpperCase(),
                  r = t.Enum.getValues(e),
                  s = 0;
                s < r.length;
                s++
              ) {
                var o = r[s],
                  l = o.toUpperCase();
                if (t.referenceEquals(a, l)) return (n.$ = o), !0;
              }
        ...
        (ee.normalizeEnum = function (e) {
          return function (t, i) {
            var n = {};
            if (!ee.tryNormalizeEnum(e).call(null, t, n))
              throw y.createInvalidParameter(i);
            return n.$;
          };
        }),
        ...
        (e.tab.PublicEnums = ee);
      var te = function () {};
      (te.__typeName = 'tab.SharedUtils'), (e.tab.SharedUtils = te);
      var ie = function () {};
      (ie.__typeName = 'tab.SheetSize'),
        (ie.$ctor = function (e, i, n) {
          var a = new Object();
          return (
            (a.behavior = null),
            (a.minSize = null),
            (a.maxSize = null),
            (a.behavior = t.coalesce(e, 'automatic')),
            t.isValue(i) ? (a.minSize = i) : delete a.minSize,
            t.isValue(n) ? (a.maxSize = n) : delete a.maxSize,
            a
          );
        }),
        ...
        (e.tab.SheetSize = ie);
      var ne = function () {};
      (ne.__typeName = 'tab.SheetSizeFactory'),
        (ne.createAutomatic = function () {
        ...
        (ne.fromSizeConstraints = function (e) {
          ...
          return (
            0 === t && 0 === i
              ? (0 === n && 0 === a) || ((r = 'atmost'), (o = ae.$ctor(a, n)))
              : 0 === n && 0 === a
              ? ((r = 'atleast'), (s = ae.$ctor(i, t)))
              : n === t && a === i && i > 0
              ? ((r = 'exactly'), (s = ae.$ctor(i, t)), (o = ae.$ctor(i, t)))
              : ((r = 'range'),
                0 === i && 0 === a && (a = 2147483647),
                (s = ae.$ctor(i, t)),
                (o = ae.$ctor(a, n))),
            ie.$ctor(r, s, o)
          );
        }),
        (e.tab.SheetSizeFactory = ne);
      var ae = function () {};
      (ae.__typeName = 'tab.Size'),
        (ae.$ctor = function (e, t) {
          var i = new Object();
          return (
      ...
      (re.__typeName = 'tableauSoftware.Column'),
        (e.tableauSoftware.Column = re);
      var se = function (e) {
        (this.$impl = null), (this.$impl = e);
      };
      (se.__typeName = 'tableauSoftware.DataTable'),
        (e.tableauSoftware.DataTable = se);
      var oe = function (e) {
        (this.impl = null), (this.impl = new Y(e));
      };
      (oe.__typeName = 'tableauSoftware.Mark'), (e.tableauSoftware.Mark = oe);
      var le,
        ue,
        ce = function (e, i) {
          (this.fieldName = null),
      ...
      (ce.__typeName = 'tableauSoftware.Pair'),
        (e.tableauSoftware.Pair = ce),
        t.initClass(s, r, {}),
        t.initClass(o, r, {
        ...
        t.initClass(l, r, {
          ...
          serialize: function () {
            ...
            var i = e.join(',');
            return (l.lastRequestMessage = i), i;
          },
        }),
        t.initClass(u, r, {}),
        t.initClass(c, r, {
        ...
        t.initClass(m, r, {
          ...
          $verifyUniqueKeyParameter: function (e) {
            if (w.isNullOrEmpty(e)) throw new t.Exception('Null key');
            if (this._has(e))
        ...
        t.initClass(f, r, {
          ...
          all: function (e) {
            var t = new f(),
              ...
              n = i,
              a = [];
            if (0 === i) return t.resolve(a), t.get_promise();
            for (
              var r = function (e, i) {
                  s.$coerceToTrustedPromise(e).then(
                    function (e) {
          ...
          $preResolutionThen: function (e, i) {
            var n = new f();
            return (
              this.$listeners.push(function (a) {
          ...
          $transitionToFulfilled: function (e) {
            var t = s.$coerceToTrustedPromise(e);
            (this.$thenFunc = t.then),
              (this.$resolveFunc = s.$coerceToTrustedPromise);
        ...
        t.initClass(v, r, {
          intersect: function (e) {
            var t = Math.max(this.left, e.left),
              ...
              a = Math.min(this.top + this.height, e.top + e.height);
            return n <= t || a <= i
              ? new v(0, 0, 0, 0)
              : new v(t, i, n - t, a - i);
          },
        ...
        t.initEnum(R, r, { all: 'all', list: 'list', range: 'range' }, !0),
        t.initEnum(
          D,
          r,
          {
        ...
        t.initEnum(H, r, { redo: 'redo', undo: 'undo' }, !0),
        t.initEnum(L, r, { top: 'top', bottom: 'bottom' }, !0),
        t.initClass(W, r, {
            ...
            if (!t.isNullOrUndefined(i.data)) {
              ...
              if (
                ((!t.isNullOrUndefined(s) &&
                  t.referenceEquals(s.get_hostId(), a.get_hostId())) ||
                  (s = this.$findHostIdByDomComparison(i)),
                a.get_isApiCommandName())
              )
                if (
                  t.referenceEquals(
                    a.get_commandId(),
                    l.crossDomainEventNotificationId,
                  )
                ) {
                  if (
                    ...
                    'api.FirstVizSizeKnownEvent' === a.get_name())
                  ) {
                    var o = new X('tableau.bootstrap', []);
                    i.source.postMessage(o.serialize(), '*');
                  }
                } else this.$handleCrossDomainResponse(a);
              else if (!t.isNullOrUndefined(this.$legacyHandler)) {
                var u = X.parse(i.data.toString());
                this.$legacyHandler(u, s);
              }
            }
          },
        ...
        t.initClass(q, r, {}, Object),
        t.initClass(G, r, {
          buildApplyFiltersCommandParams: function (e, i, n, a) {
            if (w.isNullOrEmpty(e))
              throw y.createNullOrEmptyParameter('fieldName');
            n = ee.normalizeEnum(V).call(null, n, 'updateType');
            var r = [];
            if (g.isArray(i))
              for (var s = 0; s < i.length; s++) r.push(i[s].toString());
            else t.isValue(i) && r.push(i.toString());
            var o = {};
            return (
              (o['api.fieldCaption'] = e),
              (o['api.filterUpdateType'] = n),
              (o['api.exclude'] = !(!t.isValue(a) || !a.isExcludeMode)),
              'all' !== n && (o['api.filterCategoricalValues'] = r),
              o
            );
          },
          buildRangeFilterCommandParams: function (e, i) {
            ...
            if (t.isNullOrUndefined(i))
              throw y.createNullOrEmptyParameter('filterOptions');
            var n = {};
            if (((n['api.fieldCaption'] = e), t.isValue(i.min)))
              if (w.isDate(i.min)) {
                var a = t.cast(i.min, t.JsDate);
                if (!w.isDateValid(a))
                  throw y.createInvalidDateParameter('filterOptions.min');
                n['api.filterRangeMin'] = w.serializeDateForServer(a);
              } else n['api.filterRangeMin'] = i.min;
            if (t.isValue(i.max))
              if (w.isDate(i.max)) {
                var r = t.cast(i.max, t.JsDate);
                if (!w.isDateValid(r))
                  throw y.createInvalidDateParameter('filterOptions.max');
                n['api.filterRangeMax'] = w.serializeDateForServer(r);
          ...
          buildRelativeDateFilterCommandParams: function (e, i) {
            if (w.isNullOrEmpty(e)) throw y.createInvalidParameter('fieldName');
            if (t.isNullOrUndefined(i))
              throw y.createInvalidParameter('filterOptions');
            var n = {};
            if (((n['api.fieldCaption'] = e), t.isValue(i))) {
              ...
              t.isValue(i.anchorDate) &&
                (n['api.filterDateArchorValue'] = w.serializeDateForServer(
                  i.anchorDate,
                ));
            }
            return n;
          },
          buildHierarchicalFilterCommandParams: function (e, i, n, a) {
            if (w.isNullOrEmpty(e))
              throw y.createNullOrEmptyParameter('fieldName');
            n = ee.normalizeEnum(V).call(null, n, 'updateType');
            var r = null,
            ...
            if (g.isArray(i)) {
              r = [];
              for (var o = i, l = 0; l < o.length; l++) r.push(o[l].toString());
            } else if (w.isString(i)) (r = []).push(i.toString());
            ...
            } else if (t.isValue(i)) throw y.createInvalidParameter('values');
            var m = {};
            return (
              (m['api.fieldCaption'] = e),
              (m['api.filterUpdateType'] = n),
              (m['api.exclude'] = !(!t.isValue(a) || !a.isExcludeMode)),
              t.isValue(r) &&
                (m['api.filterHierarchicalValues'] = JSON.stringify(r)),
              t.isValue(s) &&
                (m['api.filterHierarchicalLevels'] = JSON.stringify(s)),
              m
            );
          },
            ...
            if (t.isValue(i) && t.isValue(i.errorCode)) {
              ...
              switch (i.errorCode) {
                case 'invalidFilterFieldName':
                  return y.create('invalidFilterFieldName', n);
                case 'invalidFilterFieldValue':
                  return y.create('invalidFilterFieldValue', n);
                case 'invalidAggregationFieldName':
                  return y.createInvalidAggregationFieldName(n);
                default:
          ...
          normalizeRangeFilterOption: function (e) {
            ...
            return (
              ...
              t.isValue(e.nullOption) &&
                (i.nullOption = ee
                  .normalizeEnum(F)
                  .call(null, e.nullOption, 'filterOptions.nullOption')),
              i
            );
          },
          normalizeRelativeDateFilterOptions: function (e) {
            ...
            if (
              ((i.rangeType = ee
                .normalizeEnum(S)
                .call(null, e.rangeType, 'filterOptions.rangeType')),
              (i.periodType = ee
                .normalizeEnum(z)
                .call(null, e.periodType, 'filterOptions.periodType')),
              'lastn' === i.rangeType || 'nextn' === i.rangeType)
            ) {
              ...
              i.rangeN = w.toInt(e.rangeN);
            }
            if (t.isValue(e.anchorDate)) {
              if (!w.isDate(e.anchorDate) || !w.isDateValid(e.anchorDate))
                throw y.createInvalidDateParameter('filterOptions.anchorDate');
              i.anchorDate = e.anchorDate;
            }
            return i;
          },
          createFilterCommandReturnHandler: function (e, i, n) {
            return new (t.makeGenericType(j, [Object]))(
              e,
              0,
              t.mkdel(this, function (e) {
                var a = this.filterCommandError(e);
                t.isNullOrUndefined(a) ? n.resolve(i) : n.reject(a);
              }),
              function (e, t) {
                if (e) n.reject(y.createInvalidFilterFieldNameOrValue(i));
                else {
                  var a = y.create('filterCannotBePerformed', t);
                  n.reject(a);
                }
              },
            );
        ...
        t.initClass(Q, r, {
          ...
          processGetDataPresModel: function (e) {
            var t = this.$processUnderlyingTable(e.dataTable),
              ...
              n = new p(t, e.isSummary, t.length, i);
            return new se(n);
          },
        ...
        t.initClass(ie, r, {}, Object),
        t.initClass(ne, r, {}),
        t.initClass(ae, r, {}, Object),
        t.initClass(re, r, {
        ...
        t.initClass(ce, r, {}),
        (l.crossDomainEventNotificationId = 'xdomainSourceId'),
        (l.lastRequestMessage = null),
        (l.lastResponseMessage = null),
        (l.lastClientInfoResponseMessage = null),
        (l.$nextCommandId = 0),
        (le = window._ApiObjectRegistryGlobalState),
        t.isNullOrUndefined(le) && (le = new Object()),
        (window._ApiObjectRegistryGlobalState = le),
        (window._ApiObjectRegistryGlobalState.creationRegistry =
          window._ApiObjectRegistryGlobalState.creationRegistry || {}),
        (window._ApiObjectRegistryGlobalState.singletonInstanceRegistry =
          window._ApiObjectRegistryGlobalState.singletonInstanceRegistry || {}),
        (g.$arrayType = 'array'),
        (g.$booleanType = 'boolean'),
        (g.$dateType = 'date'),
        (g.$functionType = 'function'),
        (g.$numberType = 'number'),
        (g.$objectType = 'object'),
        (g.$regExpType = 'regexp'),
        (g.$stringType = 'string'),
        (g.$class2type = t.mkdict([
          '[object Boolean]',
          g.$booleanType,
          '[object Number]',
          g.$numberType,
        ...
        (g.$trim = t.cast(String.prototype.trim, Function)),
        (g.$toString = t.cast(Object.prototype.toString, Function)),
        (g.$trimLeft = new RegExp('^[\\s\\xA0]+')),
        (g.$trimRight = new RegExp('[\\s\\xA0]+$')),
        (g.$rvalidchars = new RegExp('^[\\],:{}\\s]*$')),
        (g.$rvalidescape = new RegExp(
          '\\\\(?:["\\\\\\/bfnrt]|u[0-9a-fA-F]{4})',
          'g',
        )),
        (g.$rvalidtokens = new RegExp(
          '"[^"\\\\\\n\\r]*"|true|false|null|-?\\d+(?:\\.\\d*)?(?:[eE][+\\-]?\\d+)?',
          'g',
        )),
        (g.$rvalidbraces = new RegExp('(?:^|:|,)(?:\\s*\\[)+', 'g')),
        ((ue = e.tableauSoftware).DeviceType = {
          DEFAULT: 'default',
          DESKTOP: 'desktop',
          TABLET: 'tablet',
          PHONE: 'phone',
        }),
        (ue.DashboardObjectType = {
          BLANK: 'blank',
          WORKSHEET: 'worksheet',
        ...
        (ue.ParameterAllowableValuesType = {
          ALL: 'all',
          LIST: 'list',
          RANGE: 'range',
        }),
        (ue.ParameterDataType = {
          FLOAT: 'float',
          INTEGER: 'integer',
          STRING: 'string',
          BOOLEAN: 'boolean',
        ...
        (ue.SelectionUpdateType = {
          REPLACE: 'replace',
          ADD: 'add',
          REMOVE: 'remove',
        }),
        (ue.SheetSizeBehavior = {
          AUTOMATIC: 'automatic',
          EXACTLY: 'exactly',
          RANGE: 'range',
          ATLEAST: 'atleast',
        ...
        (ue.ToolbarPosition = { TOP: 'top', BOTTOM: 'bottom' }),
        (ue.ToolbarButtonName = { REDO: 'redo', UNDO: 'undo' });
    })(),
    /*! API */
    (function () {
      var i = {};
      (e.tab = e.tab || {}),
        (e.tableauSoftware = e.tableauSoftware || {}),
        t.initAssembly(i, 'Tableau.JavaScript.Vql.Api');
      var n = function (e, t) {
        (this.$customViewImpl = null),
          E.call(this, e, null),
          (this.$customViewImpl = t);
      };
      n.__typeName = 'tab.$CustomViewEventContext';
      var r = function () {};
      (r.__typeName = 'tab.$DashboardZoneInfo'),
      ...
      s.__typeName = 'tab.$FilterEventContext';
      var o = function (e, t) {
        E.call(this, e, t);
      };
      o.__typeName = 'tab.$HighlightEventContext';
      var l = function (e, t) {
        E.call(this, e, t);
      };
      l.__typeName = 'tab.$MarksEventContext';
      var u = function (e, t) {
        (this.$parameterName = null),
          E.call(this, e, null),
          (this.$parameterName = t);
      };
      u.__typeName = 'tab.$ParameterEventContext';
      var c = function (e) {
        if (
          ((this.$parameter = null),
          (this.$name = null),
          ...
          (this.$name = e.name),
          (this.$currentValue = a._Utility.getDataValue(e.currentValue)),
          (this.$dataType = a.ApiEnumConverter.convertParameterDataType(
            e.dataType,
          )),
          (this.$allowableValuesType = a.ApiEnumConverter.convertParameterAllowableValuesType(
          ...
          for (var i = 0; i < e.allowableValues.length; i++) {
            ...
            this.$allowableValues.push(a._Utility.getDataValue(n));
          }
        }
        'range' === this.$allowableValuesType &&
          ((this.$minValue = a._Utility.getDataValue(e.minValue)),
          (this.$maxValue = a._Utility.getDataValue(e.maxValue)),
          (this.$stepSize = e.stepSize),
          ('date' === this.$dataType || 'datetime' === this.$dataType) &&
            t.isValue(this.$stepSize) &&
            t.isValue(e.dateStepPeriod) &&
            (this.$dateStepPeriod = a.ApiEnumConverter.convertPeriodType(
              e.dateStepPeriod,
            )));
      };
      c.__typeName = 'tab.$ParameterImpl';
      var h = function () {};
      (h.__typeName = 'tab._ApiBootstrap'),
        (h.initialize = function () {
          a._ApiObjectRegistry.registerApiMessageRouter(function () {
            return new k();
          });
        }),
        (e.tab._ApiBootstrap = h);
      ...
      (m.__typeName = 'tab._CustomViewImpl'),
        (m._getAsync = function (e) {
          var t = new a._Deferred();
          return (
        ...
        (m._createNew = function (e, i, n, a) {
          var r = new m(e, n.name, i);
          return (
            (r.$isPublic = n.isPublic),
            (r.$url = n.url),
            (r.$ownerName = n.owner.friendlyName),
            (r.$isDefault = t.isValue(a) && t.unbox(a) === n.id),
            (r.$presModel = n),
            r
          );
        }),
        (m._saveNewAsync = function (e, i, n) {
          ...
          var o = m.$createCustomViewCommandReturnHandler(
            'api.SaveNewCustomViewCommand',
            r,
            function (n) {
              m._processCustomViewUpdate(e, i, n, !0);
              var a = null;
              t.isValue(e.get_$updatedCustomViews()) &&
                (a = e.get_$updatedCustomViews().get_item(0)),
                r.resolve(a);
            },
          );
        ...
        (m._makeCurrentCustomViewDefaultAsync = function (e, t) {
          var i = new a._Deferred(),
            n = m.$createCustomViewCommandReturnHandler(
        ...
        (m._getCustomViewsAsync = function (e, i) {
          var n = new a._Deferred(),
            r = new (t.makeGenericType(a.CommandReturnHandler$1, [Object]))(
              'api.FetchCustomViewsCommand',
              0,
              function (t) {
                m._processCustomViews(e, i, t),
        ...
        (m._processCustomViewUpdate = function (e, i, n, r) {
          if (
            ...
            e.set_$customViews(new a._Collection()),
            r &&
              (e.set_$updatedCustomViews(new a._Collection()),
              t.isValue(n.newView) &&
                m.$processOneCustomViewUpdate(e, i, n, n.newView, r)),
            t.isValue(n.customViews))
          )
            for (var s = 0; s < n.customViews.length; s++) {
              var o = n.customViews[s];
              m.$processOneCustomViewUpdate(e, i, n, o, r);
            }
        }),
        (m.$processOneCustomViewUpdate = function (e, i, n, a, r) {
          ...
          t.isValue(n.currentView) &&
            ((s = n.currentView.name), (o = n.currentView.owner.friendlyName));
          var l = n.defaultCustomViewId,
            u = m._createNew(e, i, a, l),
            c = u.get_$name();
          e.get_$customViews()._has(c) && (c += '/' + a.owner),
            e.get_$customViews()._add(c, u.get_$customView()),
            e.get_$removedCustomViews()._has(c)
              ? e.get_$removedCustomViews()._remove(c)
              : r &&
                !e.get_$updatedCustomViews()._has(c) &&
                e.get_$updatedCustomViews()._add(c, u.get_$customView()),
            t.isValue(s) &&
              t.referenceEquals(u.get_$name(), s) &&
              t.referenceEquals(u.get_$ownerName(), o) &&
              e.set_$currentCustomView(u.get_$customView());
        }),
        (m.$createCustomViewCommandReturnHandler = function (e, i, n) {
          return new (t.makeGenericType(a.CommandReturnHandler$1, [Object]))(
            e,
            0,
            n,
            function (e, t) {
      ...
      var d = function (e, t, i) {
        (this.$dashboard = null),
          (this.$worksheets = new a._Collection()),
          (this.$dashboardObjects = new a._Collection()),
          f.call(this, e, t, i);
      };
      (d.__typeName = 'tab._DashboardImpl'), (e.tab._DashboardImpl = d);
      var p = function (e, t) {
        (this.$name = null),
          (this.$fields = new a._Collection()),
          (this.$isPrimary = !1),
          (this.$dataSource = null),
          a._Param.verifyString(e, 'name'),
          (this.$name = e),
          (this.$isPrimary = t);
      };
      (p.__typeName = 'tab._DataSourceImpl'),
        (p.processDataSource = function (e) {
          for (
            var i = new p(e.name, e.isPrimary),
            ...
            var s = n[r],
              ...
              u = new J(i.get_dataSource(), s.name, o, l);
            i.addField(u);
          }
          return i;
        }),
        (p.processDataSourcesForWorksheet = function (e) {
          for (
            var i = new a._Collection(), n = null, r = 0;
            r < e.dataSources.length;
            r++
          ) {
            var s = e.dataSources[r],
              o = p.processDataSource(s);
      ...
      var f = function (e, t, i) {
        (this.$name = null),
          ...
          (this.$zoneId = 0),
          a._Param.verifyValue(e, 'sheetInfoImpl'),
          a._Param.verifyValue(t, 'workbookImpl'),
          a._Param.verifyValue(i, 'messagingOptions'),
          (this.$name = e.name),
          (this.$index = e.index),
      ...
      (f.__typeName = 'tab._SheetImpl'),
        (f.$convertValueToIntIfValid = function (e) {
          return t.isValue(e) ? a._Utility.toInt(e) : e;
        }),
        (f.$normalizeSheetSize = function (e) {
          var i = a.PublicEnums.normalizeEnum(a.ApiSheetSizeBehavior).call(
              null,
              e.behavior,
              'size.behavior',
            ),
          ...
          t.isValue(n) &&
            (n = a.Size.$ctor(
              f.$convertValueToIntIfValid(e.minSize.width),
              f.$convertValueToIntIfValid(e.minSize.height),
            ));
          var r = e.maxSize;
          return (
            t.isValue(r) &&
              (r = a.Size.$ctor(
                f.$convertValueToIntIfValid(e.maxSize.width),
                f.$convertValueToIntIfValid(e.maxSize.height),
              )),
            a.SheetSize.$ctor(i, n, r)
          );
        }),
        (e.tab._SheetImpl = f);
      var g = function () {};
      (g.__typeName = 'tab._SheetInfoImpl'),
        (g.$ctor = function (e, t, i, n, a, r, s, o, l) {
          var u = new Object();
          return (
            (u.name = null),
            (u.index = 0),
      ...
      var $ = function (e, t, i, n, r) {
        (this.$activeStoryPointImpl = null),
          ...
          f.call(this, e, t, i),
          a._Param.verifyValue(n, 'storyPm'),
          a._Param.verifyValue(r, 'findSheetFunc'),
          (this.$findSheetFunc = r),
          this.update(n);
      };
      ($.__typeName = 'tab._StoryImpl'), (e.tab._StoryImpl = $);
      var _ = function (e, i) {
        if (
          ((this.$caption = null),
          (this.$index = 0),
          ...
          for (
            var n = t.cast(this.$containedSheetImpl, d), a = 0;
            a < n.get_worksheets().get__length();
            a++
          ) {
            n.get_worksheets().get_item(a)._impl.set_parentStoryPointImpl(this);
          }
      };
      (_.__typeName = 'tab._StoryPointImpl'),
        (_.createContainedSheet = function (e, i, n, r) {
          if (t.isNullOrUndefined(e) || t.isNullOrUndefined(e.name))
            return null;
          var s = a.ApiEnumConverter.convertSheetType(e.sheetType),
            o = a.SheetSizeFactory.createAutomatic(),
            l = r(e.name),
            u = t.isNullOrUndefined(l),
            c = u ? '' : l.getUrl(),
            h = g.$ctor(e.name, s, -1, o, i.get_workbook(), c, !1, u, e.zoneId);
          if ('worksheet' === e.sheetType) {
            return new C(h, i, n, null);
          }
          if ('dashboard' === e.sheetType) {
            var m = new d(h, i, n),
              p = S.$createDashboardZones(e.dashboardZones);
            return m.$addObjects(p, r), m;
          }
          throw 'story' === e.sheetType
            ? a._TableauException.createInternalError(
        ...
        (e.tab._StoryPointImpl = _);
      var v = function () {};
      (v.__typeName = 'tab._StoryPointInfoImpl'),
        (v.$ctor = function (e, t, i, n, a, r) {
          var s = new Object();
          return (
            (s.storyPointId = 0),
      ...
      (y.__typeName = 'tab._ToolbarStateImpl'), (e.tab._ToolbarStateImpl = y);
      var w = function () {};
      (w.__typeName = 'tab._VizManagerImpl'),
        (w.get_$clonedVizs = function () {
        ...
        (w.$verifyVizNotAlreadyParented = function (e) {
          for (
            var i = e.getParentElement(), n = 0, r = w.$vizs.length;
            n < r;
            n++
          )
            if (t.referenceEquals(w.$vizs[n].getParentElement(), i)) {
              var s =
                ...
                a._Utility.elementToString(i) +
                "'.";
              throw a._TableauException.create('vizAlreadyInManager', s);
            }
        });
      var b = function (e, i, n) {
        ...
        t.isNullOrUndefined(n) &&
          ...
          t.isValue(n.height) || t.isValue(n.width)
            ? ((this.fixedSize = !0),
              a._Utility.isNumber(n.height) &&
                (n.height = n.height.toString() + 'px'),
              a._Utility.isNumber(n.width) &&
                (n.width = n.width.toString() + 'px'),
              (this.height = t.isValue(n.height)
                ? a._Utility.roundVizSizeInPixels(n.height.toString())
                : null),
              (this.width = t.isValue(n.width)
                ? a._Utility.roundVizSizeInPixels(n.width.toString())
                : null))
            : (this.fixedSize = !1),
          ...
          (this.iframeSizedToWindow = n.iframeSizedToWindow),
        ...
        if (
          ...
          throw a._TableauException.create('invalidUrl', 'Invalid url');
        (this.host_url = s[0].toLowerCase()),
          (this.name = this.$urlFromApi.replace(s[0], '')),
          (this.name = this.name.replace('views/', ''));
      };
      (b.__typeName = 'tab._VizParameters'), (e.tab._VizParameters = b);
      var S = function (e, t, i) {
        (this.$workbook = null),
          ...
          (this.$publishedSheetsInfo = new a._Collection()),
          (this.$isDownloadAllowed = !1),
          (this.$messagingOptions = null),
          (this.$currentCustomView = null),
          (this.$customViews = new a._Collection()),
          (this.$updatedCustomViews = new a._Collection()),
          (this.$removedCustomViews = new a._Collection()),
          (this.$parameters = null),
      ...
      (S.__typeName = 'tab._WorkbookImpl'),
        (S.$createDashboardZones = function (e) {
          e = t.coalesce(e, []);
        ...
        (S.$extractSheetName = function (e) {
          if (t.isNullOrUndefined(e)) return null;
          if (a._Utility.isString(e)) return e;
          var i = t.safeCast(e, te);
        ...
        (S.$createSheetSize = function (e) {
          return t.isNullOrUndefined(e)
            ? a.SheetSizeFactory.createAutomatic()
            : a.SheetSizeFactory.fromSizeConstraints(e.sizeConstraints);
        }),
        (S.$processParameters = function (e) {
          for (
            var t = new a._Collection(), i = 0;
            i < e.parameters.length;
            i++
          ) {
            var n = e.parameters[i],
              r = new c(n);
            t._add(r.get_$name(), r.get_$parameter());
          }
          return t;
        }),
        (S.$findAndCreateParameterImpl = function (e, i) {
          for (var n = 0; n < i.parameters.length; n++) {
            var a = i.parameters[n];
            if (t.referenceEquals(a.name, e)) return new c(a);
          }
          return null;
        }),
        (e.tab._WorkbookImpl = S);
      var C = function (e, t, i, n) {
        (this.$worksheet = null),
          (this.$parentDashboardImpl = null),
          (this.$getDataCommandsBuilder = new a.GetDataCommandsBuilder()),
          (this.$filterCommandsBuilder = new a.FilterCommandsBuilder()),
          (this.$sharedUtils = new a.SharedUtils()),
          (this.$filters = new a._Collection()),
          (this.$selectedMarks = new a._Collection()),
          (this.highlightedMarks = null),
          f.call(this, e, t, i),
          (this.$parentDashboardImpl = n);
      };
      (C.__typeName = 'tab._WorksheetImpl'),
        (C.$filterCommandError = function (e) {
          var i = e;
          if (t.isValue(i) && t.isValue(i.errorCode)) {
            var n = t.isValue(i.additionalInformation)
              ? i.additionalInformation.toString()
            ...
            switch (i.errorCode) {
              case 'invalidFilterFieldName':
                return a._TableauException.create('invalidFilterFieldName', n);
              case 'invalidFilterFieldValue':
                return a._TableauException.create('invalidFilterFieldValue', n);
              case 'invalidAggregationFieldName':
                return a._TableauException.createInvalidAggregationFieldName(n);
              default:
          ...
          if (t.isValue(i) && t.isValue(i.errorCode)) {
            ...
            switch (i.errorCode) {
              case 'invalidSelectionFieldName':
                return a._TableauException.create(
                  'invalidSelectionFieldName',
                  n,
                );
              case 'invalidSelectionValue':
                return a._TableauException.create('invalidSelectionValue', n);
        ...
        (e.tab._WorksheetImpl = C);
      var I = function (e, t, i) {
        (this.$context = null),
          x.call(this, e, t),
          (this.$context = new n(t._impl.get__workbookImpl(), i));
      };
      (I.__typeName = 'tab.CustomViewEvent'), (e.tab.CustomViewEvent = I);
      var E = function (e, t) {
        (this.$workbookImpl = null),
      ...
      (E.__typeName = 'tab.EventContext'), (e.tab.EventContext = E);
      var N = function (e, t, i, n, a) {
        (this.$filterCaption = null),
          (this.$context = null),
          j.call(this, e, t, i),
          (this.$filterCaption = a),
          (this.$context = new s(t._impl.get__workbookImpl(), i, n, a));
      };
      (N.__typeName = 'tab.FilterEvent'), (e.tab.FilterEvent = N);
      var A = function (e, t, i) {
        (this.$vizSize = null), x.call(this, e, t), (this.$vizSize = i);
      };
      (A.__typeName = 'tab.FirstVizSizeKnownEvent'),
        (e.tab.FirstVizSizeKnownEvent = A);
      var T = function (e, t, i) {
        (this.$context = null),
          j.call(this, e, t, i),
          (this.$context = new o(t._impl.get__workbookImpl(), i));
      };
      (T.__typeName = 'tab.HighlightEvent'), (e.tab.HighlightEvent = T);
      var V = function () {};
      (V.__typeName = 'tab.IJsApiMessageHandler'),
        (e.tab.IJsApiMessageHandler = V);
      var k = function () {
        (this.$customViewLoadCallbacks = {}),
          (this.$crossDomainMessager = null);
        var e = t.mkdel(this, function (e, i) {
          var n = t.safeCast(i, V);
          t.isValue(n) && this.$handleLegacyNotifications(e, n);
        });
        this.$crossDomainMessager = new a.CrossDomainMessager(e);
      };
      (k.__typeName = 'tab.JsApiMessageRouter'), (e.tab.JsApiMessageRouter = k);
      var O = function (e, t) {
        (this.$router = null),
          (this.$handler = null),
          a._Param.verifyValue(e, 'router'),
          a._Param.verifyValue(t, 'handler'),
          (this.$router = e),
          (this.$handler = t);
      };
      (O.__typeName = 'tab.JsApiMessagingOptions'),
        (e.tab.JsApiMessagingOptions = O);
      var F = function (e, t, i) {
        (this.$context = null),
          j.call(this, e, t, i),
          (this.$context = new l(t._impl.get__workbookImpl(), i));
      };
      (F.__typeName = 'tab.MarksEvent'), (e.tab.MarksEvent = F);
      var R = function (e, t, i) {
        (this.$context = null),
          x.call(this, e, t),
          (this.$context = new u(t._impl.get__workbookImpl(), i));
      };
      (R.__typeName = 'tab.ParameterEvent'), (e.tab.ParameterEvent = R);
      var D = function () {};
      (D.__typeName = 'tab.StoryPointInfoImplUtil'),
        (D.clone = function (e) {
          return v.$ctor(
            e.caption,
            e.index,
        ...
        (e.tab.StoryPointInfoImplUtil = D);
      ...
      (z.__typeName = 'tab.StoryPointSwitchEvent'),
        (e.tab.StoryPointSwitchEvent = z);
      var x = function (e, t) {
        (this.$viz = null),
          (this.$eventName = null),
          (this.$viz = t),
      ...
      (x.__typeName = 'tab.TableauEvent'), (e.tab.TableauEvent = x);
      var P = function (e, t, i, n) {
        (this.$oldName = null),
          (this.$newName = null),
          x.call(this, e, t),
      ...
      (P.__typeName = 'tab.TabSwitchEvent'), (e.tab.TabSwitchEvent = P);
      var U = function (e, t, i) {
        (this.$toolbarStateImpl = null),
          x.call(this, e, t),
          (this.$toolbarStateImpl = i);
      };
      (U.__typeName = 'tab.ToolbarStateEvent'), (e.tab.ToolbarStateEvent = U);
      var M = function (e, i, n, r, s) {
        if (
          ...
          !a._Utility.hasWindowPostMessage() || !a._Utility.hasJsonParse())
        )
          throw a._TableauException.createBrowserNotCapable();
        (this.$messagingOptions = new O(e, this)),
          (this.$viz = i),
          (t.isNullOrUndefined(n) || 1 !== n.nodeType) && (n = document.body),
          (this.$parameters = new b(n, r, s)),
          t.isValue(s) &&
            ((this.$onFirstInteractiveCallback = s.onFirstInteractive),
            (this.$onFirstVizSizeKnownCallback = s.onFirstVizSizeKnown));
      };
      (M.__typeName = 'tab.VizImpl'), (e.tab.VizImpl = M);
      var H = function (e, t, i) {
        (this.$availableSize = null),
          x.call(this, e, t),
          (this.$availableSize = i);
      };
      (H.__typeName = 'tab.VizResizeEvent'), (e.tab.VizResizeEvent = H);
      var L = function () {};
      (L.__typeName = 'tab.VizSize'),
        (L.$ctor = function (e, t) {
          var i = new Object();
          return (
            (i.sheetSize = null),
      ...
      (j.__typeName = 'tab.WorksheetEvent'), (e.tab.WorksheetEvent = j);
      var W = function (e, t) {
        (this.$isExclude = !1),
      ...
      (W.__typeName = 'tableauSoftware.CategoricalFilter'),
        (e.tableauSoftware.CategoricalFilter = W);
      var B = function (e) {
        (this._impl = null), (this._impl = e);
      };
      (B.__typeName = 'tableauSoftware.CustomView'),
        (e.tableauSoftware.CustomView = B);
      var q = function (e) {
        (this._impl = null), te.call(this, e);
      };
      (q.__typeName = 'tableauSoftware.Dashboard'),
        (e.tableauSoftware.Dashboard = q);
      var G = function (e, i, n) {
        if (
          ...
          throw a._TableauException.createInternalError(
      ...
      (G.__typeName = 'tableauSoftware.DashboardObject'),
        (e.tableauSoftware.DashboardObject = G);
      var Q = function (e) {
        (this.$impl = null), (this.$impl = e);
      };
      (Q.__typeName = 'tableauSoftware.DataSource'),
        (e.tableauSoftware.DataSource = Q);
      ...
      (J.__typeName = 'tableauSoftware.Field'), (e.tableauSoftware.Field = J);
      var K = function (e, t) {
        (this.$worksheetImpl = null),
          (this.$type = null),
          (this.$caption = null),
      ...
      (K.__typeName = 'tableauSoftware.Filter'),
        (K.$createFilter = function (e, t) {
          switch (t.filterType) {
            case 'categorical':
              return new W(e, t);
            case 'relativedate':
        ...
        (K.processFiltersList = function (e, t) {
          for (var i = new a._Collection(), n = 0; n < t.filters.length; n++) {
            var r = t.filters[n];
            i._has(r.caption) || i._add(r.caption, r.caption);
          }
          for (var s = new a._Collection(), o = 0; o < t.filters.length; o++) {
            var l = t.filters[o],
              u = K.$createFilter(e, l);
            if (s._has(l.caption)) {
              for (
        ...
        (e.tableauSoftware.Filter = K);
      var Y = function (e, t) {
        (this.$levels = 0), K.call(this, e, t), this.$initializeFromJson$1(t);
      };
      (Y.__typeName = 'tableauSoftware.HierarchicalFilter'),
        (e.tableauSoftware.HierarchicalFilter = Y);
      var X = function (e) {
        (this._impl = null), (this._impl = e);
      };
      (X.__typeName = 'tableauSoftware.Parameter'),
        (e.tableauSoftware.Parameter = X);
      var Z = function (e, t) {
        (this.$domainMin = null),
          (this.$domainMax = null),
          (this.$min = null),
      ...
      (Z.__typeName = 'tableauSoftware.QuantitativeFilter'),
        (e.tableauSoftware.QuantitativeFilter = Z);
      var ee = function (e, t) {
      ...
      (ee.__typeName = 'tableauSoftware.RelativeDateFilter'),
        (e.tableauSoftware.RelativeDateFilter = ee);
      var te = function (e) {
        (this._impl = null),
          a._Param.verifyValue(e, 'sheetImpl'),
          (this._impl = e);
      };
      (te.__typeName = 'tableauSoftware.Sheet'), (e.tableauSoftware.Sheet = te);
      var ie = function (e) {
        (this.$impl = null), (this.$impl = e);
      };
      (ie.__typeName = 'tableauSoftware.SheetInfo'),
        (e.tableauSoftware.SheetInfo = ie);
      var ne = function (e) {
        (this._impl = null), te.call(this, e);
      };
      (ne.__typeName = 'tableauSoftware.Story'), (e.tableauSoftware.Story = ne);
      var ae = function (e) {
        (this.$impl = null), (this.$impl = e);
      };
      (ae.__typeName = 'tableauSoftware.StoryPoint'),
        (e.tableauSoftware.StoryPoint = ae);
      var re = function (e) {
        (this._impl = null), (this._impl = e);
      };
      (re.__typeName = 'tableauSoftware.StoryPointInfo'),
        (e.tableauSoftware.StoryPointInfo = re);
      var se = function (e) {
        (this._impl = null), (this._impl = e);
      };
      (se.__typeName = 'tableauSoftware.ToolbarState'),
        (e.tableauSoftware.ToolbarState = se);
      var oe = function (e, i, n, a) {
        (this.$major = 0),
          (this.$minor = 0),
          (this.$patch = 0),
          (this.$metadata = null),
          ...
          (this.$minor = i),
          (this.$patch = n),
          (this.$metadata = t.coalesce(a, null));
      };
      (oe.__typeName = 'tableauSoftware.Version'),
        (oe.getCurrent = function () {
          return oe.$currentVersion;
        }),
        (e.tableauSoftware.Version = oe);
      var le = function (e, t, i) {
        this._impl = null;
        var n = a._ApiObjectRegistry.getApiMessageRouter();
        (this._impl = new M(n, this, e, t, i)), this._impl.$create();
      };
      (le.__typeName = 'tableauSoftware.Viz'),
        (le.getLastRequestMessage = function () {
        ...
        (e.tableauSoftware.Viz = le);
      var ue = function () {};
      (ue.__typeName = 'tableauSoftware.VizManager'),
        (ue.getVizs = function () {
          return w.get_$clonedVizs();
        }),
        (e.tableauSoftware.VizManager = ue);
      var ce = function (e) {
        (this.$workbookImpl = null), (this.$workbookImpl = e);
      };
      (ce.__typeName = 'tableauSoftware.Workbook'),
        (e.tableauSoftware.Workbook = ce);
      var he = function (e) {
        (this._impl = null), te.call(this, e);
      };
      (he.__typeName = 'tableauSoftware.Worksheet'),
        (e.tableauSoftware.Worksheet = he),
        t.initClass(E, i, {
        ...
        t.initClass(m, i, {
          ...
          $saveAsync: function () {
            ...
            var n = m.$createCustomViewCommandReturnHandler(
              'api.UpdateCustomViewCommand',
              e,
              t.mkdel(this, function (t) {
                m._processCustomViewUpdate(
                  this.$workbookImpl,
        ...
        t.initClass(f, i, {
          ...
          get_url: function () {
            if (this.$isHidden)
              throw a._TableauException.createNoUrlForHiddenWorksheet();
            return this.$url;
          },
          get_size: function () {
            return this.$size;
          ...
          changeSizeAsync: function (e) {
            if (
              ((e = f.$normalizeSheetSize(e)),
              'worksheet' === this.$sheetType && 'automatic' !== e.behavior)
            )
              throw a._TableauException.createInvalidSizeBehaviorOnWorksheet();
            var i = new a._Deferred();
            if (
            ...
            var n = this.$processSheetSize(e),
              r = {};
            (r['api.setSheetSizeName'] = this.$name),
              (r['api.minWidth'] = n['api.minWidth']),
              (r['api.minHeight'] = n['api.minHeight']),
              (r['api.maxWidth'] = n['api.maxWidth']),
              (r['api.maxHeight'] = n['api.maxHeight']);
            var s = new (t.makeGenericType(a.CommandReturnHandler$1, [Object]))(
          ...
          $processSheetSize: function (e) {
            ...
            if (
              ...
              throw a._TableauException.createInvalidSheetSizeParam();
            var n = 0,
              r = 0,
              s = 0,
              o = 0,
            ...
            if ('automatic' === e.behavior)
              i = a.SheetSize.$ctor('automatic', void 0, void 0);
              ...
              if (
                ...
                throw a._TableauException.createMissingMaxSize();
              if (e.maxSize.width < 0 || e.maxSize.height < 0)
                throw a._TableauException.createInvalidSizeValue();
              (l['api.maxWidth'] = e.maxSize.width),
                (l['api.maxHeight'] = e.maxSize.height),
                (i = a.SheetSize.$ctor('atmost', void 0, e.maxSize));
              ...
              if (
                ...
                throw a._TableauException.createMissingMinMaxSize();
              if (
                e.minSize.width < 0 ||
                e.minSize.height < 0 ||
                e.maxSize.width < 0 ||
                ...
                throw a._TableauException.createInvalidRangeSize();
              (l['api.minWidth'] = e.minSize.width),
                (l['api.minHeight'] = e.minSize.height),
                (l['api.maxWidth'] = e.maxSize.width),
                (l['api.maxHeight'] = e.maxSize.height),
                (i = a.SheetSize.$ctor('range', e.minSize, e.maxSize));
              ...
              if (
                ...
                if (
                  ...
                  throw a._TableauException.createSizeConflictForExactly();
              } else
                t.isValue(e.minSize) &&
                t.isValue(e.minSize.width) &&
                t.isValue(e.minSize.height)
                  ? ((s = n = e.minSize.width), (o = r = e.minSize.height))
                  : t.isValue(e.maxSize) &&
                    t.isValue(e.maxSize.width) &&
                    t.isValue(e.maxSize.height) &&
                    ((n = s = e.maxSize.width), (r = o = e.maxSize.height));
              (l['api.minWidth'] = n),
                (l['api.minHeight'] = r),
                (l['api.maxWidth'] = s),
                (l['api.maxHeight'] = o),
          ...
          i,
          {
            ...
            $addObjects: function (e, i) {
              ...
              for (var n = 0; n < e.length; n++) {
                ...
                var f = new G(r, this.get_dashboard(), s);
        ...
        t.initClass(
          ...
          i,
          {
            ...
            update: function (e) {
              ...
              for (var a = 0; a < e.storyPoints.length; a++) {
                var r = e.storyPoints[a],
                  s = r.caption,
                  o = a === e.activeStoryPointIndex,
                  l = v.$ctor(s, a, r.storyPointId, o, r.isUpdated, this);
                if (t.isNullOrUndefined(this.$storyPointsInfo[a]))
                  this.$storyPointsInfo[a] = new re(l);
                else if (
                  this.$storyPointsInfo[a]._impl.storyPointId === l.storyPointId
                ) {
                  var u = this.$storyPointsInfo[a]._impl;
                  (u.caption = l.caption),
                    (u.index = l.index),
                    (u.isActive = o),
                    (u.isUpdated = l.isUpdated);
                } else this.$storyPointsInfo[a] = new re(l);
                o && ((i = r.containedSheetInfo), (n = l));
              }
              ...
              if (h) {
                var d = _.createContainedSheet(
                  i,
                  this.get_workbookImpl(),
                  this.get_messagingOptions(),
                  this.$findSheetFunc,
                );
                this.$activeStoryPointImpl = new _(n, d);
              } else
            ...
            activateStoryPointAsync: function (e) {
              ...
              if (e < 0 || e >= this.$storyPointsInfo.length)
                throw a._TableauException.createIndexOutOfRange(e);
              var n = {};
              n['api.storyPointIndex'] = e;
              var r = new (t.makeGenericType(a.CommandReturnHandler$1, [
                Object,
              ]))(
            ...
            $activatePreviousNextStoryPointAsync: function (e) {
              ...
              var i = new a._Deferred(),
                n = new (t.makeGenericType(a.CommandReturnHandler$1, [Object]))(
                  e,
                  0,
                  t.mkdel(this, function (e) {
                    this.$updateActiveState(e),
              ...
              return (
                this.sendCommand(Object).call(this, {}, n), i.get_promise()
              );
            },
            ...
            $updateActiveState: function (e) {
              ...
              if (t.get_index() !== i) {
                ...
                (a.isActive = !0),
                  (this.$activeStoryPointImpl = new _(a, r)),
                  t.set_isActive(!1),
                  (n._impl.isActive = !1),
                  this.$raiseActiveStoryPointChange(
                    n,
            ...
            try {
              for (; n.moveNext(); ) {
                ...
                'embed' !== a.key &&
                  ...
                  'hideTabs' !== a.key &&
                  'hideToolbar' !== a.key &&
                  'onFirstInteractive' !== a.key &&
                  'onFirstVizSizeKnown' !== a.key &&
                  'toolbarPosition' !== a.key &&
                  'instanceIdToClone' !== a.key &&
                  'navType' !== a.key &&
                  'display_static_image' !== a.key &&
                  (e.push('&'),
                  e.push(encodeURIComponent(a.key)),
                  e.push('='),
                  e.push(encodeURIComponent(a.value.toString())));
              }
            } finally {
              n.dispose();
            }
        ...
        t.initClass(S, i, {
          ...
          $findActiveSheetOrSheetWithinActiveDashboard: function (e) {
            ...
            if (this.$activeSheetImpl.get_isDashboard()) {
              var n = t.cast(this.$activeSheetImpl, d).get_worksheets()._get(i);
          ...
          _setActiveSheetAsync: function (e) {
            if (a._Utility.isNumber(e)) {
              ...
              throw a._TableauException.createIndexOutOfRange(i);
            }
            var n = S.$extractSheetName(e),
              r = this.$publishedSheetsInfo._get(n);
            if (t.isValue(r)) return this.$activateSheetWithInfoAsync(r.$impl);
            if (this.$activeSheetImpl.get_isDashboard()) {
              var s = t.cast(this.$activeSheetImpl, d).get_worksheets()._get(n);
              if (t.isValue(s)) {
                this.$activatingHiddenSheetImpl = null;
                var o = '';
                return (
                  s.getIsHidden()
                    ? (this.$activatingHiddenSheetImpl = s._impl)
                    : (o = s._impl.get_url()),
                  this.$activateSheetInternalAsync(s._impl.get_name(), o)
                );
              }
            }
            throw a._TableauException.create(
          ...
          _revertAllAsync: function () {
            var e = new a._Deferred(),
              i = new (t.makeGenericType(a.CommandReturnHandler$1, [Object]))(
            ...
            return (
              this.$sendCommand(Object).call(this, null, i), e.get_promise()
            );
          },
          _update: function (e) {
          ...
          $activateSheetInternalAsync: function (e, i) {
            ...
            var r = {};
            (r['api.switchToSheetName'] = e),
              (r['api.switchToRepositoryUrl'] = i),
              (r['api.oldRepositoryUrl'] = this.$activeSheetImpl.get_url());
            var s = new (t.makeGenericType(a.CommandReturnHandler$1, [Object]))(
          ...
          _updateActiveSheetAsync: function () {
            ...
            var n = new (t.makeGenericType(a.CommandReturnHandler$1, [Object]))(
          ...
          $getClientInfo: function (e) {
            var i = new (t.makeGenericType(a.CommandReturnHandler$1, [Object]))(
          ...
          $initializeActiveSheet: function (e) {
            ...
            if (
              ...
              if (t.isValue(this.$activatingHiddenSheetImpl)) {
                ...
                for (
                  var o = null, l = 0, u = e.publishedSheets.length;
                  l < u;
                  l++
                )
                  if (t.referenceEquals(e.publishedSheets[l].name, i)) {
                    o = e.publishedSheets[l];
                    break;
                  }
                ...
                var c = t.mkdel(this, function (e) {
                  return this.$publishedSheetsInfo._get(e);
                });
                if ('dashboard' === o.sheetType) {
                  var h = new d(n.$impl, this, this.$messagingOptions);
                  this.$activeSheetImpl = h;
                  var m = S.$createDashboardZones(e.dashboardZones);
                  h.$addObjects(m, c);
                  ...
                  (this.$activeSheetImpl = p),
                    p.add_activeStoryPointChange(
                      t.mkdel(
                        this.$vizImpl,
            ...
            if (!t.isNullOrUndefined(i))
              for (var n = 0; n < i.length; n++) {
                ...
                if (t.isNullOrUndefined(o)) {
                  ...
                  (o = new ie(h)), this.$publishedSheetsInfo._add(s, o);
                } else o.$impl.size = l;
              }
          },
          ...
          $showCustomViewAsync: function (e) {
            if (t.isNullOrUndefined(e) || a._Utility.isNullOrEmpty(e))
              return m._showCustomViewAsync(this, this.$messagingOptions, null);
            var i = this.$customViews._get(e);
            if (t.isNullOrUndefined(i)) {
              var n = new a._Deferred();
              return (
                n.reject(a._TableauException.createInvalidCustomViewName(e)),
                n.get_promise()
              );
            }
          ...
          $removeCustomViewAsync: function (e) {
            if (a._Utility.isNullOrEmpty(e))
              throw a._TableauException.createNullOrEmptyParameter(
                'customViewName',
              );
            var i = this.$customViews._get(e);
            if (t.isNullOrUndefined(i)) {
          ...
          $rememberCustomViewAsync: function (e) {
            if (a._Utility.isNullOrEmpty(e))
              throw a._TableauException.createInvalidParameter(
                'customViewName',
              );
            return m._saveNewAsync(this, this.$messagingOptions, e);
          },
          $setActiveCustomViewAsDefaultAsync: function () {
            return m._makeCurrentCustomViewDefaultAsync(
              this,
              this.$messagingOptions,
            );
          },
          ...
          $getSingleParameterAsync: function (e) {
            ...
            var n = new (t.makeGenericType(a.CommandReturnHandler$1, [Object]))(
              ...
              0,
              t.mkdel(this, function (t) {
                var n = S.$findAndCreateParameterImpl(e, t);
          ...
          $getParametersAsync: function () {
            var e = new a._Deferred(),
              i = new (t.makeGenericType(a.CommandReturnHandler$1, [Object]))(
                ...
                0,
                t.mkdel(this, function (t) {
                  (this.$parameters = S.$processParameters(t)),
          ...
          $changeParameterValueAsync: function (e, i) {
            ...
            if (t.isValue(this.$parameters)) {
              ...
              if (
                ((r = this.$parameters._get(e)._impl), t.isNullOrUndefined(r))
              )
                return (
                  n.reject(a._TableauException.createInvalidParameter(e)),
                  n.get_promise()
            ...
            if (
              ((s['api.setParameterName'] = t.isValue(this.$parameters)
                ? r.get_$name()
                : e),
              t.isValue(i) && a._Utility.isDate(i))
            ) {
              var o = t.cast(i, t.JsDate),
                l = a._Utility.serializeDateForServer(o);
              s['api.setParameterValue'] = l;
            } else
              s['api.setParameterValue'] = t.isValue(i) ? i.toString() : null;
            this.$lastChangedParameterImpl = null;
            var u = new (t.makeGenericType(a.CommandReturnHandler$1, [Object]))(
              'api.SetParameterValueCommand',
              0,
              t.mkdel(this, function (i) {
                if (t.isNullOrUndefined(i))
                  n.reject(
                    a._TableauException.create('serverError', 'server error'),
                  );
        ...
        t.initClass(
          ...
          i,
          {
            ...
            $getDataSourcesAsync: function () {
              ...
              var n = new (t.makeGenericType(a.CommandReturnHandler$1, [
                Object,
              ]))(
                'api.GetDataSourcesCommand',
                0,
                function (t) {
                  var i = p.processDataSourcesForWorksheet(t);
            ...
            $getDataSourceAsync: function (e) {
              ...
              var r = new (t.makeGenericType(a.CommandReturnHandler$1, [
                ...
                0,
                function (n) {
                  var r = p.processDataSource(n);
                  t.isValue(r)
                    ? i.resolve(r.get_dataSource())
                    : i.reject(
                        a._TableauException.createServerError(
              ...
              var e = this.get_isActive(),
                ...
                n =
                  ...
                  this.get_parentStoryPointImpl()
                    ...
                    .get_isActive();
              if (!e && !i && !n)
                throw a._TableauException.createNotActiveSheet();
            },
            ...
            $getFilterAsync: function (e, i, n) {
              if (!a._Utility.isNullOrEmpty(e) && !a._Utility.isNullOrEmpty(i))
                throw a._TableauException.createInternalError(
              ...
              this.$addVisualIdToCommand(s),
                !a._Utility.isNullOrEmpty(i) &&
                  a._Utility.isNullOrEmpty(e) &&
                  (s['api.fieldCaption'] = i),
                a._Utility.isNullOrEmpty(e) || (s['api.fieldName'] = e),
                (s['api.filterHierarchicalLevels'] = 0),
                (s['api.ignoreDomain'] = n.ignoreDomain || !1);
              var o = new (t.makeGenericType(a.CommandReturnHandler$1, [
                Object,
              ]))(
                'api.GetOneFilterInfoCommand',
                0,
                t.mkdel(this, function (e) {
                  var i = C.$filterCommandError(e);
                  if (t.isNullOrUndefined(i)) {
                    var n = e,
                      a = K.$createFilter(this, n);
                    r.resolve(a);
                  } else r.reject(i);
                }),
                function (e, t) {
            ...
            $getFiltersAsync: function (e) {
              ...
              var r = new (t.makeGenericType(a.CommandReturnHandler$1, [
                ...
                0,
                t.mkdel(this, function (e) {
                  this.set__filters(K.processFiltersList(this, e)),
            ...
            $applyHierarchicalFilterAsync: function (e, i, n, r) {
              if (t.isNullOrUndefined(i) && 'all' !== n)
                throw a._TableauException.createInvalidParameter('values');
              return this.$applyHierarchicalFilterInternalAsync(e, i, n, r);
            },
            $clearFilterInternalAsync: function (e) {
              this.$verifyActiveSheetOrEmbeddedInActiveDashboard();
              var t = new a._Deferred(),
                i = this.$filterCommandsBuilder.buildClearFilterCommandsParam(
                  e,
                );
              this.$addVisualIdToCommand(i);
              var n = this.$filterCommandsBuilder.createFilterCommandReturnHandler(
            ...
            $applyFilterWithValuesInternalAsync: function (e, t, i, n) {
              this.$verifyActiveSheetOrEmbeddedInActiveDashboard();
              var r = new a._Deferred(),
            ...
            $applyRangeFilterInternalAsync: function (e, t) {
              this.$verifyActiveSheetOrEmbeddedInActiveDashboard();
              var i = this.$filterCommandsBuilder.buildRangeFilterCommandParams(
                e,
                t,
              );
              this.$addVisualIdToCommand(i);
              var n = new a._Deferred(),
                r = this.$filterCommandsBuilder.createFilterCommandReturnHandler(
                  'api.ApplyRangeFilterCommand',
                  e,
                  n,
                );
              return this.sendCommand(Object).call(this, i, r), n.get_promise();
            },
            $applyRelativeDateFilterInternalAsync: function (e, t) {
              this.$verifyActiveSheetOrEmbeddedInActiveDashboard();
              var i = this.$filterCommandsBuilder.buildRelativeDateFilterCommandParams(
                e,
                t,
              );
              this.$addVisualIdToCommand(i);
            ...
            $applyHierarchicalFilterInternalAsync: function (e, t, i, n) {
              this.$verifyActiveSheetOrEmbeddedInActiveDashboard();
              var r = this.$filterCommandsBuilder.buildHierarchicalFilterCommandParams(
                e,
                t,
                i,
                n,
            ...
            $selectMarksAsync: function (e, i, n) {
              return (
                ...
                t.isNullOrUndefined(e) && t.isNullOrUndefined(i)
                  ...
                  : a._Utility.isString(e) &&
                    (a._jQueryShim.isArray(i) ||
                      a._Utility.isString(i) ||
                      !a.PublicEnums.isValidEnum(a.ApiSelectionUpdateType).call(
                        null,
                        i,
                      ))
            ...
            $getSelectedMarksAsync: function () {
              ...
              var n = new (t.makeGenericType(a.CommandReturnHandler$1, [
                ...
                0,
                t.mkdel(this, function (t) {
                  (this.$selectedMarks = a.MarkImpl.processActiveMarks(t)),
            ...
            $selectMarksWithFieldNameAndValueAsync: function (e, t, i) {
              var n = [],
                ...
                l = [];
              return (
                this.$parseMarksParam(n, a, r, s, o, l, e, t),
                this.$selectMarksWithValuesAsync(null, n, a, r, s, o, l, i)
              );
            },
            $selectMarksWithMultiDimOptionAsync: function (e, i) {
              var n = e,
                ...
                u = [],
                c = [],
                h = new t.ObjectEnumerator(n);
              try {
                for (; h.moveNext(); ) {
                  var m = h.current();
                  e.hasOwnProperty(m.key) &&
                    (a._jQueryShim.isFunction(n[m.key]) ||
                      this.$parseMarksParam(r, s, o, l, u, c, m.key, m.value));
                }
              } finally {
                h.dispose();
              }
                ...
                if (t.isValue(m.impl.get_tupleId()) && m.impl.get_tupleId() > 0)
                  ...
                  for (
                    ...
                    f.hasOwnProperty('fieldName') &&
                      ...
                      !a._jQueryShim.isFunction(f.fieldName) &&
                      !a._jQueryShim.isFunction(f.value) &&
            ...
            $parseMarksParam: function (e, i, n, r, s, o, l, u) {
              var c = u;
              if (C.$regexHierarchicalFieldName.test(l))
                this.$addToParamLists(n, r, l, u);
              else if (t.isValue(c.min) || t.isValue(c.max)) {
                var h = new Object();
                if (t.isValue(c.min))
                  if (a._Utility.isDate(c.min)) {
                    var m = t.cast(c.min, t.JsDate);
                    if (!a._Utility.isDateValid(m))
                      throw a._TableauException.createInvalidDateParameter(
                        'options.min',
                      );
                    h.min = a._Utility.serializeDateForServer(m);
                  } else h.min = c.min;
                if (t.isValue(c.max))
                  if (a._Utility.isDate(c.max)) {
                    var d = t.cast(c.max, t.JsDate);
                    if (!a._Utility.isDateValid(d))
                      throw a._TableauException.createInvalidDateParameter(
                        'options.max',
                      );
                    h.max = a._Utility.serializeDateForServer(d);
                  } else h.max = c.max;
                if (t.isValue(c.nullOption)) {
                  var p = a.PublicEnums.normalizeEnum(a.ApiNullOption).call(
                    null,
                    c.nullOption,
                    'options.nullOption',
                  );
            ...
            $addToParamLists: function (e, i, n, r) {
              var s = [];
              if (a._jQueryShim.isArray(r))
                for (var o = t.cast(r, Array), l = 0; l < o.length; l++)
                  s.push(o[l].toString());
              else s.push(r.toString());
              i.push(s), e.push(n);
            },
            $selectMarksWithValuesAsync: function (e, i, n, r, s, o, l, u) {
              var c = {};
              if (
                (this.$addVisualIdToCommand(c),
                (u = a.PublicEnums.normalizeEnum(a.ApiSelectionUpdateType).call(
                  null,
                  u,
                  'updateType',
                )),
                ...
                !a._Utility.isNullOrEmpty(i) && !a._Utility.isNullOrEmpty(n))
              ) {
              ...
              if (
                !a._Utility.isNullOrEmpty(r) &&
                !a._Utility.isNullOrEmpty(s)
              ) {
                c['api.hierarchicalFieldCaption'] = JSON.stringify(r);
              ...
              if (
                !a._Utility.isNullOrEmpty(o) &&
                !a._Utility.isNullOrEmpty(l)
              ) {
                c['api.rangeFieldCaption'] = JSON.stringify(o);
                for (var $ = [], _ = 0; _ < l.length; _++) {
                  var v = JSON.stringify(l[_]);
                  $.push(v);
                }
                c['api.rangeMarkValues'] = JSON.stringify($);
              }
              if (
                a._Utility.isNullOrEmpty(c['api.tupleIds']) &&
                a._Utility.isNullOrEmpty(c['api.categoricalFieldCaption']) &&
                a._Utility.isNullOrEmpty(c['api.hierarchicalFieldCaption']) &&
                a._Utility.isNullOrEmpty(c['api.rangeFieldCaption'])
              )
                throw a._TableauException.createInvalidParameter(
                  'fieldNameOrFieldValuesMap',
                );
              var y = new a._Deferred(),
                w = new (t.makeGenericType(a.CommandReturnHandler$1, [Object]))(
                  'api.SelectMarksCommand',
                  0,
                  function (e) {
                    var i = C.$createSelectionCommandError(e);
                    t.isNullOrUndefined(i) ? y.resolve() : y.reject(i);
                  },
                  function (e, t) {
            ...
            $getSummaryDataAsync: function (e) {
              this.$verifyActiveSheetOrEmbeddedInActiveDashboard();
              var t = new a._Deferred(),
                i = this.$getDataCommandsBuilder.getSummaryDataCommandParams(e);
              this.$addVisualIdToCommand(i);
              var n = this.$getDataCommandsBuilder.getSummaryDataResponseHandler(
                t,
              );
              return this.sendCommand(Object).call(this, i, n), t.get_promise();
            },
            $getUnderlyingDataAsync: function (e) {
              this.$verifyActiveSheetOrEmbeddedInActiveDashboard();
              var t = new a._Deferred(),
                i = this.$getDataCommandsBuilder.getUnderlyingDataCommandParams(
                  e,
                );
              this.$addVisualIdToCommand(i);
              var n = this.$getDataCommandsBuilder.getUnderlyingDataResponseHandler(
                t,
              );
              return this.sendCommand(Object).call(this, i, n), t.get_promise();
            },
            ...
            $highlightMarksAsync: function (e, i) {
              a._Param.verifyString(e, 'fieldName'),
                this.$verifyActiveSheetOrEmbeddedInActiveDashboard();
              var n = new a._Deferred(),
                r = {};
              (r['api.fieldCaption'] = e),
                (r['api.ObjectTextIDs'] = i),
                this.$addVisualIdToCommand(r);
              var s = new (t.makeGenericType(a.CommandReturnHandler$1, [
                Object,
              ]))(
            ...
            $highlightMarksByPatternMatchAsync: function (e, i) {
              a._Param.verifyString(e, 'fieldName'),
                a._Param.verifyString(i, 'patternMatch'),
                this.$verifyActiveSheetOrEmbeddedInActiveDashboard();
              var n = new a._Deferred(),
                r = { 'api.filterUpdateType': 'replace' };
              (r['api.fieldCaption'] = e),
                (r['api.Pattern'] = i),
                this.$addVisualIdToCommand(r);
              var s = new (t.makeGenericType(a.CommandReturnHandler$1, [
            ...
            $getHighlightedMarksAsync: function () {
              ...
              var n = new (t.makeGenericType(a.CommandReturnHandler$1, [
                ...
                0,
                t.mkdel(this, function (t) {
                  (this.highlightedMarks = a.MarkImpl.processActiveMarks(t)),
          ...
          sendCommand: function (e) {
            return function (i, n, a) {
              if (
                (this.$crossDomainMessager
                  .sendCommand(e)
                  .call(this.$crossDomainMessager, i, n, a),
                'api.ShowCustomViewCommand' === a.get_commandName())
              ) {
                var r = this.$customViewLoadCallbacks[i.get_hostId()];
                t.isNullOrUndefined(r) &&
                  ((r = []),
                  (this.$customViewLoadCallbacks[i.get_hostId()] = r)),
                  r.push(a);
              }
            };
          },
          $handleCustomViewsListLoad: function (e) {
            ...
            if (!t.isNullOrUndefined(n)) {
              for (var a = 0; a < n.length; a++) {
                var r = n[a];
                t.staticEquals(r.get_successCallback(), null) ||
                  r.get_successCallback()(null);
              }
              delete this.$customViewLoadCallbacks[i];
            }
          },
          $handleLegacyNotifications: function (e, i) {
            if ('layoutInfoReq' === e.get_name()) w.$sendVisibleRects();
            else if (
        ...
        t.initClass(
          ...
          i,
          {
            ...
            getCurrentUrlAsync: function () {
              var e = new a._Deferred(),
                i = new (t.makeGenericType(a.CommandReturnHandler$1, [String]))(
              ...
              if ('exactly' === o.behavior)
                ...
                switch (o.behavior) {
                  case 'range':
                    (t = o.minSize.width),
                      (i = o.maxSize.width),
                      (n = o.minSize.height + s),
                      (r = o.maxSize.height + s),
                      (l = Math.max(t, Math.min(i, e.width))),
                      (u = Math.max(n, Math.min(r, e.height)));
                    break;
                  case 'atleast':
                    (t = o.minSize.width),
                      (n = o.minSize.height + s),
                      (l = Math.max(t, e.width)),
                      (u = Math.max(n, e.height));
                    break;
                  case 'atmost':
                    (i = o.maxSize.width),
                      (r = o.maxSize.height + s),
                      (l = Math.min(i, e.width)),
                      (u = Math.min(r, e.height));
                    break;
                  case 'automatic':
              ...
              return (
                t.isValue(this.$initialAvailableSize)
                  ? ((e = this.$initialAvailableSize),
                    (this.$initialAvailableSize = null))
                  : (e = a._Utility.computeContentSize(
            ...
            handleEventNotification: function (e, t) {
              var i = a._ApiServerNotification.deserialize(t);
              switch (e) {
                ...
                case 'api.ToolbarStateChangedEvent':
                  this.$handleToolbarStateChangeEvent(i);
                  break;
            ...
            addEventListener: function (e, i) {
              var n = {};
              if (
                !a.PublicEnums.tryNormalizeEnum(a.ApiTableauEventName).call(
                  null,
                  e,
                  n,
                )
              )
                throw a._TableauException.createUnsupportedEventName(
                  e.toString(),
                );
              switch (n.$) {
                case 'marksselection':
                ...
                case 'toolbarstatechange':
                  this.add_$toolbarStateChange(t.cast(i, Function));
                  break;
                case 'vizresize':
            ...
            removeEventListener: function (e, i) {
              ...
              switch (n.$) {
                ...
                case 'tabswitch':
                  ...
                  break;
                case 'toolbarstatechange':
                  this.remove_$toolbarStateChange(t.cast(i, Function));
                  break;
                case 'storypointswitch':
            ...
            $revertAllAsync: function () {
              return a._Utility.noResultPromiseHelper(
                'api.RevertAllCommand',
                null,
                this.$messagingOptions,
              );
            ...
            $setFrameSizeAndUpdate: function (e, i) {
              this.$raiseVizResizeEvent(a.Size.$ctor(-1, -1)),
                this.$setFrameSize(e, i),
            ...
            $create: function () {
              ...
              this.$parameters.fixedSize
                ? (this.$parameters.displayStaticImage &&
                  ...
                  this.$show())
                : ((this.$initialAvailableSize = a._Utility.computeContentSize(
                    this.get_$parentElement(),
                  )),
                  (0 !== this.$initialAvailableSize.width &&
                    0 !== this.$initialAvailableSize.height) ||
                    (this.$initialAvailableSize = a.Size.$ctor(800, 600)),
                  (this.$iframe = this.$createIframe()),
                  this.$makeInvisible(),
                  this.$parameters.displayStaticImage &&
                    ((this.$staticImage = this.$createStaticImageElement(
                    ...
                    (this.$staticImage.style.display = 'block'))),
                a._Utility.hasWindowPostMessage() ||
                  (a._Utility.isIE()
            ...
            $sendVisibleRect: function () {
              ...
              var e = a._Utility.visibleContentRectInDocumentCoordinates(
                  this.get_iframe(),
                ),
                i = a._Utility.contentRectInDocumentCoordinates(
                  this.get_iframe(),
                ),
                n = new a.NonApiCommand('layoutInfoResp', [
                  (e.left - i.left).toString(),
                  (e.top - i.top).toString(),
                  e.width.toString(),
                  e.height.toString(),
                ]);
              this.$iframe.contentWindow.postMessage(n.serialize(), '*');
            },
            ...
            $raiseParameterValueChange: function (e) {
              t.staticEquals(this.$1$ParameterValueChangeField, null) ||
                this.$1$ParameterValueChangeField(
                  new R('parametervaluechange', this.$viz, e),
                );
            },
            ...
            $raiseTabSwitch: function (e, i) {
              t.staticEquals(this.$1$TabSwitchField, null) ||
                this.$1$TabSwitchField(new P('tabswitch', this.$viz, e, i));
            },
            raiseStoryPointSwitch: function (e, i) {
              t.staticEquals(this.$1$StoryPointSwitchField, null) ||
                this.$1$StoryPointSwitchField(
                  new z('storypointswitch', this.$viz, e, i),
                );
            },
            ...
            $raiseVizResizeEvent: function (e) {
              t.staticEquals(this.$1$VizResizeField, null) ||
                this.$1$VizResizeField(new H('vizresize', this.$viz, e));
            },
            ...
            $invokeAutomaticUpdatesCommandAsync: function (e) {
              if (
                ...
                throw a._TableauException.createInternalError(null);
              var i = {};
              ...
              return (
                this._sendCommand(Object).call(this, i, r), n.get_promise()
              );
            },
            ...
            $handleMarksSelectionChangedEvent: function (e) {
              if (
                ...
                if (
                  ...
                  i = t.cast(n, d).get_worksheets()._get(e.get_worksheetName())
                    ._impl;
                }
                t.isValue(i) &&
            ...
            $handleMarksHighlightChangedEvent: function (e) {
              if (
                ...
                t.isValue(i) &&
                  ...
                  this.$1$MarksHighlightField(
                    new T('markshighlight', this.$viz, i),
                  ));
              }
            },
              ...
              if (
                ...
                if (t.referenceEquals(n.get_name(), e.get_worksheetName()))
                  ...
                  var a = t
                    ...
                    .get_activeStoryPointImpl()
                    .get_containedSheetImpl();
                  if (a.get_isDashboard())
                    i = t
                      .cast(a, d)
                      .get_worksheets()
                      ._get(e.get_worksheetName())._impl;
                  else
                    t.referenceEquals(a.get_name(), e.get_worksheetName()) &&
                      (i = t.cast(a, C));
                }
                if (t.isValue(i)) {
                  var r = t.cast(
                    ...
                    o = r[1];
                  this.$1$FilterChangeField(
                    new N('filterchange', this.$viz, i, s, o),
                  );
                }
              }
            },
            ...
            $handleCustomViewSetDefaultEvent: function (e) {
              ...
              if (
                ...
                for (
                  var n = this.$workbookImpl.get_$customViews(), a = 0;
                  a < n.get__length();
                  a++
                ) {
                  var r = n.get_item(a);
                  if (r.getDefault()) {
                    this.$raiseCustomViewSetDefault(r);
                    break;
                  }
                }
            },
            ...
            $handleStorytellingStateChangedEvent: function (e) {
              var i = t.cast(this.$workbookImpl.get_activeSheetImpl(), $);
                  ...
                  t.mkdel(this, function () {
                    this.$onFirstInteractiveAlreadyCalled ||
                      (t.staticEquals(i, null) ||
                        i(new x('firstinteractive', this.$viz)),
              ...
              return (
                ...
                this.$parameters.fixedSize
                  ? ((i.style.width = this.$parameters.width),
                    ...
                    this.$parameters.iframeSizedToWindow &&
            ...
            $handleInitialVizSize: function (e) {
              var i = a.SheetSizeFactory.fromSizeConstraints(e.sizeConstraints);
              (this.$vizSize = L.$ctor(i, e.chromeHeight)),
            ...
            $removeWindowResizeHandler: function () {
              t.isNullOrUndefined(this.$windowResizeHandler) ||
                (a._Utility.hasWindowAddEventListener()
        ...
        t.initClass(K, i, {
          ...
          $initializeFromJson: function (e) {
            (this.$caption = e.caption),
              (this.$type = a.ApiEnumConverter.convertFilterType(e.filterType)),
              (this.$field = null),
              (this.$dataSourceName = e.dataSourceName),
              (this.$fieldRole = a.ApiEnumConverter.convertFieldRole(
                t.coalesce(e.fieldRole, 'unknown'),
              )),
              (this.$fieldAggregation = a.ApiEnumConverter.convertFieldAggregation(
        ...
        t.initClass(
          ...
          i,
          {
            ...
            $initializeFromJson$1: function (e) {
              if (
                ((this.$isExclude = e.isExclude), t.isValue(e.appliedValues))
              ) {
                this.$appliedValues = [];
                for (var i = 0; i < e.appliedValues.length; i++) {
                  var n = e.appliedValues[i];
                  this.$appliedValues.push(a._Utility.getDataValue(n));
                }
              }
            },
          },
        ...
        t.initClass(
          ...
          i,
          {
            ...
            $initializeFromJson$1: function (e) {
              (this.$domainMin = a._Utility.getDataValue(e.domainMinValue)),
                (this.$domainMax = a._Utility.getDataValue(e.domainMaxValue)),
                (this.$min = a._Utility.getDataValue(e.minValue)),
                (this.$max = a._Utility.getDataValue(e.maxValue)),
          ...
          i,
          {
            ...
            $initializeFromJson$1: function (e) {
              t.isValue(e.periodType) &&
                (this.$periodType = a.ApiEnumConverter.convertPeriodType(
                  t.unbox(e.periodType),
                )),
                t.isValue(e.rangeType) &&
                  (this.$rangeType = a.ApiEnumConverter.convertDateRange(
                    t.unbox(e.rangeType),
                  )),
        ...
        t.initClass(le, i, {
          ...
          setFrameSize: function (e, t) {
            var i = e,
              n = t;
            a._Utility.isNumber(e) && (i = e.toString() + 'px'),
              a._Utility.isNumber(t) && (n = t.toString() + 'px'),
        ...
        (w.$vizs = []),
        (f.noZoneId = 4294967295),
        (C.$regexHierarchicalFieldName = new RegExp('\\[[^\\]]+\\]\\.', 'g')),
        (oe.$currentVersion = new oe(2, 2, 2, 'null'));
    })(),
    (window.tableau = window.tableauSoftware = e.tableauSoftware),
    (tableauSoftware.Promise = a._PromiseImpl),
    (a._Deferred = a._DeferredImpl),
    (a._Collection = a._CollectionImpl),
    a._ApiBootstrap.initialize(),
