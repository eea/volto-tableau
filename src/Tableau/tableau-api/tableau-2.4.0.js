...
!(function () {
  ...
  !(function (e) {
    ...
    (a.sxb = function (e) {
      ...
      (a.ck = function (e, t) {
        if (a.isValue(e) && !t.isInstanceOfType(e)) throw new x();
        return e;
      }),
      (a.trunc = function (e) {
    ...
    a.initClass(E);
    var A = (a.NotImplementedException = a.mkType(
      a,
    ...
    a.initClass(F, O);
    var R = (a.ArgumentOutOfRangeException = a.mkType(
      a,
    ...
    a.initClass(R, O);
    var D = (a.FormatException = a.mkType(a, 'ss.FormatException', function (
      e,
      t,
    ) {
    ...
    a.initClass(D, E);
    var z = (a.ArithmeticException = a.mkType(
      a,
    ...
    a.initClass(z, E);
    var x = (a.OverflowException = a.mkType(
      a,
      'ss.OverflowException',
      function (e, t) {
        z.call(this, e || 'Arithmetic operation resulted in an overflow.', t);
      },
    ));
    a.initClass(x, z);
    var P = (a.DivideByZeroException = a.mkType(
      a,
      'ss.DivideByZeroException',
      function (e, t) {
        z.call(this, e || 'Division by 0.', t);
      },
    ));
    a.initClass(P, z);
  ...
  (e.tableauSoftware = e.tableauSoftware || {}),
    ...
    (function () {
      ...
      var r = t.mkType(n, 'tab.$DeferredUtil', null, null, {
          $coerceToTrustedPromise: function (e) {
            var i;
            if (e instanceof tableauSoftware.Promise) i = t.cast(e, g);
            else if (
              (t.isValue(e) &&
              ...
              var n = new d();
              t.cast(e, g).then(t.mkdel(n, n.resolve), t.mkdel(n, n.reject)),
                (i = n.get_promise());
            } else i = r.$resolved(e);
            return i;
          },
          $reject: function (e) {
            return r.$coerceToTrustedPromise(e).then(function (e) {
              return r.$rejected(t.cast(e, t.Exception));
            }, null);
          },
          $resolved: function (e) {
            return new g(function (i, n) {
              try {
                return r.$coerceToTrustedPromise(t.isValue(i) ? i(e) : e);
              } catch (e) {
        ...
        s = (e.tab._ApiCommand = t.mkType(
          ...
          },
          {
            ...
            serialize: function () {
              ...
              var i = e.join(',');
              return (s.lastRequestMessage = i), i;
            },
          },
          {
            generateNextCommandId: function () {
              var e = 'cmd' + s.$nextCommandId;
              return s.$nextCommandId++, e;
            },
            parse: function (e) {
              var i,
                n,
              ...
              if (r < 0)
                return (i = t.cast(e, String)), new s(i, null, null, null);
              i = t.cast(e.substr(0, r), String);
              var a,
                o = e.substr(r + 1);
              if ((r = o.indexOf(String.fromCharCode(44))) < 0)
                return new s(i, (n = o), null, null);
              n = o.substr(0, r);
              var l = o.substr(r + 1);
              if ((r = l.indexOf(String.fromCharCode(44))) < 0)
                return new s(i, n, (a = l), null);
              a = l.substr(0, r);
              var u = l.substr(r + 1);
              return (
                (s.lastResponseMessage = e),
                'api.GetClientInfoCommand' === i &&
                  (s.lastClientInfoResponseMessage = e),
                new s(i, n, a, u)
              );
            },
          },
        )),
        o = (e.tab._ApiObjectRegistry = t.mkType(
          n,
          ...
          null,
          {
            registerApiMessageRouter: function (e) {
              return o.$registerType(Object).call(null, e);
            },
            getApiMessageRouter: function () {
              return o.$getSingleton(Object).call(null);
            },
            disposeApiMessageRouter: function () {
              o.$clearSingletonInstance(Object).call(null);
            },
              ...
              return function () {
                ...
                return (
                  t.isNullOrUndefined(r) &&
                    ((r = o.$createType(e).call(null)), (i[n] = r)),
                  r
                );
              };
            },
        ...
        l = (e.tab._ApiServerNotification = t.mkType(
          n,
        ...
        u = (e.tab._ApiServerResultParser = t.mkType(
          n,
        ...
        c = (e.tab._CollectionImpl = t.mkType(
          n,
          'tab._CollectionImpl',
          function () {
          ...
          },
          {
            ...
            $verifyUniqueKeyParameter: function (e) {
              if (y.isNullOrEmpty(e)) throw new t.Exception('Null key');
              if (this._has(e))
        ...
        h = (e.tab._ColumnImpl = t.mkType(
          ...
          function (e, i, n, r) {
            (this.$fieldName = null),
              ...
              (this.$isReferenced = !1),
              (this.$index = 0),
              f.verifyString(e, 'Column Field Name'),
              (this.$fieldName = e),
              (this.$dataType = i),
        ...
        m = (e.tab._DataTableImpl = t.mkType(
          n,
          'tab._DataTableImpl',
          function (e, t, i, n) {
            (this.$name = null),
        ...
        d = (e.tab._DeferredImpl = t.mkType(
          n,
          'tab._DeferredImpl',
          function () {
            (this.$promise = null),
              ...
              (this.$promise = new g(t.mkdel(this, this.then))),
          ...
          },
          {
            ...
            all: function (e) {
              ...
              for (
                var s = function (e, i) {
                    r.$coerceToTrustedPromise(e).then(
                      function (e) {
            ...
            reject: function (e) {
              return this.$resolveFunc(r.$rejected(e));
            },
            ...
            $transitionToFulfilled: function (e) {
              var t = r.$coerceToTrustedPromise(e);
              (this.$thenFunc = t.then),
                (this.$resolveFunc = r.$coerceToTrustedPromise);
        ...
        p = (e.tab._jQueryShim = t.mkType(n, 'tab._jQueryShim', null, null, {
          isFunction: function (e) {
            return t.referenceEquals(p.type(e), p.$functionType);
          },
          isArray: function (e) {
            return t.isValue(Array.isArray)
              ? t.unbox(t.cast(Array.isArray(e), Boolean))
              : t.referenceEquals(p.type(e), p.$arrayType);
          },
          type: function (e) {
            return t.isNullOrUndefined(e)
              ? String(e)
              : p.$class2type[t.cast(p.$toString.call(e), String)] ||
                  p.$objectType;
          },
          trim: function (e) {
            return t.isValue(p.$trim)
              ? t.isNullOrUndefined(e)
                ? ''
                : t.cast(p.$trim.call(e), String)
              : t.isNullOrUndefined(e)
              ? ''
              : e.toString().replace(p.$trimLeft, '').replace(p.$trimRight, '');
          },
          parseJSON: function (e) {
            if ('string' != typeof e || t.isNullOrUndefined(e)) return null;
            if (((e = p.trim(e)), t.isValue(JSON) && t.isValue(JSON.parse)))
              return JSON.parse(e);
            if (
              p.$rvalidchars.test(
                e
                  .replace(p.$rvalidescape, '@')
                  .replace(p.$rvalidtokens, ']')
                  .replace(p.$rvalidbraces, ''),
              )
            )
        ...
        f = (e.tab._Param = t.mkType(n, 'tab._Param', null, null, {
          verifyString: function (e, i) {
            if (t.isNullOrUndefined(e) || 0 === e.length)
              throw v.createInternalStringArgumentException(i);
          },
          verifyValue: function (e, i) {
            if (t.isNullOrUndefined(e))
              throw v.createInternalNullArgumentException(i);
          },
        })),
        g = (e.tab._PromiseImpl = t.mkType(
          n,
          'tab._PromiseImpl',
          function (e) {
          ...
          {
            always: function (e) {
              return t.cast(this.then(e, t.cast(e, Function)), g);
            },
            otherwise: function (e) {
              return t.cast(this.then(null, e), g);
            },
          },
        )),
        $ = (e.tab._Rect = t.mkType(
          n,
          'tab._Rect',
          function (e, t, i, n) {
            (this.left = 0),
        ...
        v = (e.tab._TableauException = t.mkType(
          n,
          ...
          null,
          {
            ...
            createInvalidParameter: function (e) {
              return v.create('invalidParameter', 'Invalid parameter: ' + e);
            },
            ...
            createInvalidSheetSizeParam: function () {
              return v.create('invalidSize', 'Invalid sheet size parameter');
            },
        ...
        y = (e.tab._Utility = t.mkType(n, 'tab._Utility', null, null, {
          ...
          toInt: function (e) {
            if (y.isNumber(e)) return t.trunc(e);
          ...
          elementToString: function (e) {
            ...
            if (
              ...
              y.isNullOrEmpty(e.id) || i.append('#').append(e.id),
              !y.isNullOrEmpty(e.className))
            ) {
          ...
          visibleContentRectInDocumentCoordinates: function (e) {
            for (
              var i = y.contentRectInDocumentCoordinates(e),
                n = e.parentElement;
              t.isValue(n) && t.isValue(n.parentElement);
              n = n.parentElement
            ) {
              var r = y.$getComputedStyle(n).overflow;
              ('auto' !== r && 'scroll' !== r && 'hidden' !== r) ||
                (i = i.intersect(y.contentRectInDocumentCoordinates(n)));
            }
            var a = y.$getViewportRect();
          ...
          $getViewportRect: function () {
            var e = y.getVisualViewportRect(window.self);
            if (t.isValue(e)) return e;
            var n = y.contentRectInDocumentCoordinates(
          ...
          contentRectInDocumentCoordinates: function (e) {
            var t = y.getBoundingClientRect(e),
              n = y.$getComputedStyle(e),
              r = y.toInt(n.paddingLeft),
              a = y.toInt(n.paddingTop),
              s = y.toInt(n.borderLeftWidth),
              o = y.toInt(n.borderTopWidth),
              l = y.computeContentSize(e),
              u = new i.WindowHelper(window.self),
              c = t.left + r + s + u.get_pageXOffset(),
              h = t.top + a + o + u.get_pageYOffset();
            return new $(c, h, l.width, l.height);
          },
          ...
          getDataValue: function (e) {
            return t.isNullOrUndefined(e)
              ...
              : N.$ctor(
                  y.convertRawValue(e.value, e.type),
                  e.formattedValue,
                  e.aliasedValue,
                );
          },
          ...
          noResultPromiseHelper: function (e, n, r) {
            var a = new i._Deferred(),
              s = new (t.makeGenericType(k, [Object]))(
                ...
                function (e, t) {
                  a.reject(v.createServerError(t));
                },
              );
      ...
      var E,
        ...
        V = (e.tab.CrossDomainMessager = t.mkType(
          ...
          function (e) {
            ...
            else if (y.hasDocumentAttachEvent()) {
          ...
          },
          {
            ...
            sendCommand: function (e) {
              return function (e, i, n) {
                var r = e.get_iframe(),
                  a = e.get_hostId();
                if (
                  y.hasWindowPostMessage() &&
                  !t.isNullOrUndefined(r) &&
                  !t.isNullOrUndefined(r.contentWindow)
                ) {
                  var o = s.generateNextCommandId(),
                    l = this.$commandCallbacks[a];
                  t.isNullOrUndefined(l) &&
                    ((l = {}), (this.$commandCallbacks[a] = l)),
                    (l[o] = n);
                  var u = n.get_commandName(),
                    c = null;
                  t.isValue(i) && (c = JSON.stringify(i));
                  var h = new s(u, o, a, c).serialize();
                  y.isPostMessageSynchronous()
            ...
            $handleCrossDomainMessage: function (e) {
              ...
              if (!t.isNullOrUndefined(i.data)) {
                var n = s.parse(i.data.toString()),
                  r = n.get_hostId(),
                  a = this.$handlers[r];
                if (
                  ((!t.isNullOrUndefined(a) &&
                    t.referenceEquals(a.get_hostId(), n.get_hostId())) ||
                    (a = this.$findHostIdByDomComparison(i)),
                  n.get_isApiCommandName())
                )
                  if (
                    t.referenceEquals(
                      n.get_commandId(),
                      s.crossDomainEventNotificationId,
                    )
                  ) {
                    if (
                      (a.handleEventNotification(
                        n.get_name(),
                        n.get_parameters(),
                      ),
                  ...
                  var l = x.parse(i.data.toString());
                  this.$legacyHandler(l, a);
                }
              }
            },
        ...
        O = (e.tab.FilterCommandsBuilder = t.mkType(
          ...
          function () {},
          {
            buildApplyFiltersCommandParams: function (e, i, n, r) {
              if (y.isNullOrEmpty(e))
                throw v.createNullOrEmptyParameter('fieldName');
            ...
            buildRangeFilterCommandParams: function (e, i) {
              ...
              if (t.isNullOrUndefined(i))
                throw v.createNullOrEmptyParameter('filterOptions');
              var n = {};
              if (((n['api.fieldCaption'] = e), t.isValue(i.min)))
                if (y.isDate(i.min)) {
                  var r = t.cast(i.min, t.JsDate);
                  if (!y.isDateValid(r))
                    throw v.createInvalidDateParameter('filterOptions.min');
                  n['api.filterRangeMin'] = y.serializeDateForServer(r);
                } else n['api.filterRangeMin'] = i.min;
              if (t.isValue(i.max))
                if (y.isDate(i.max)) {
                  var a = t.cast(i.max, t.JsDate);
                  if (!y.isDateValid(a))
                    throw v.createInvalidDateParameter('filterOptions.max');
                  n['api.filterRangeMax'] = y.serializeDateForServer(a);
            ...
            buildRelativeDateFilterCommandParams: function (e, i) {
              if (y.isNullOrEmpty(e))
                throw v.createInvalidParameter('fieldName');
              if (t.isNullOrUndefined(i))
                throw v.createInvalidParameter('filterOptions');
              var n = {};
              if (((n['api.fieldCaption'] = e), t.isValue(i))) {
                ...
                t.isValue(i.anchorDate) &&
                  (n['api.filterDateArchorValue'] = y.serializeDateForServer(
                    i.anchorDate,
                  ));
              }
              return n;
            ...
            buildHierarchicalFilterCommandParams: function (e, i, n, r) {
              ...
              if (p.isArray(i)) {
                ...
                for (var o = i, l = 0; l < o.length; l++)
                  a.push(o[l].toString());
              } else if (y.isString(i)) (a = []).push(i.toString());
              ...
              } else if (t.isValue(i)) throw v.createInvalidParameter('values');
              var m = {};
              return (
                (m['api.fieldCaption'] = e),
                (m['api.filterUpdateType'] = n),
                (m['api.exclude'] = !(!t.isValue(r) || !r.isExcludeMode)),
                t.isValue(a) &&
                  (m['api.filterHierarchicalValues'] = JSON.stringify(a)),
                t.isValue(s) &&
              ...
              if (t.isValue(i) && t.isValue(i.errorCode)) {
                ...
                switch (i.errorCode) {
                  case 'invalidFilterFieldName':
                    return v.create('invalidFilterFieldName', n);
                  case 'invalidFilterFieldValue':
                    return v.create('invalidFilterFieldValue', n);
                  case 'invalidAggregationFieldName':
                    return v.createInvalidAggregationFieldName(n);
                  default:
                    return v.createServerError(n);
                }
              }
              return null;
            },
            ...
            normalizeRelativeDateFilterOptions: function (e) {
              ...
              if (
                ...
                i.rangeN = y.toInt(e.rangeN);
              }
              if (t.isValue(e.anchorDate)) {
                if (!y.isDate(e.anchorDate) || !y.isDateValid(e.anchorDate))
                  throw v.createInvalidDateParameter(
            ...
            createFilterCommandReturnHandler: function (e, i, n) {
              return new (t.makeGenericType(k, [Object]))(
                ...
                function (e, t) {
                  if (e) n.reject(v.createInvalidFilterFieldNameOrValue(i));
                  else {
                    var r = v.create('filterCannotBePerformed', t);
                    n.reject(r);
                  }
                },
              );
          ...
          function () {},
          {
            ...
            getSummaryDataResponseHandler: function (e) {
              return new (t.makeGenericType(k, [Object]))(
                ...
                function (t, i) {
                  e.reject(v.createServerError(i));
                },
              );
            },
            ...
            processGetDataPresModel: function (e) {
              var t = this.$processUnderlyingTable(e.dataTable),
                ...
                n = new m(t, e.isSummary, t.length, i);
              return new G(n);
            },
        ...
        R = (e.tab.HostedApiMessageHandler = t.mkType(
          n,
        ...
        D = (e.tab.HostedApiMessageRouter = t.mkType(
          n,
        ...
        z = (e.tab.MarkImpl = t.mkType(
            ...
            if (
              ...
              for (var n = e, r = 0; r < n.length; r++) {
                ...
                if (!t.isValue(a.fieldName))
                  throw v.createInvalidParameter('pair.fieldName');
                if (!t.isValue(a.value))
                  throw v.createInvalidParameter('pair.value');
                var s = new B(a.fieldName, a.value);
          ...
          },
          {
            processActiveMarks: function (e) {
              ...
              if (t.isNullOrUndefined(e) || y.isNullOrEmpty(e.marks)) return n;
              for (var r = 0; r < e.marks.length; r++) {
                ...
                for (var l = 0; l < a.pairs.length; l++) {
                  var u = a.pairs[l],
                    c = y.convertRawValue(u.value, u.valueDataType),
                    h = new B(u.fieldName, c);
        ...
        x = (e.tab.NonApiCommand = t.mkType(
          n,
          'tab.NonApiCommand',
          function (e, t) {
        ...
        P = (e.tab.Point = t.mkType(n, 'tab.Point', null, null, {
          $ctor: function (e, t) {
            var i = new Object();
          ...
          normalizeEnum: function (e) {
            return function (t, i) {
              ...
              if (!U.tryNormalizeEnum(e).call(null, t, n))
                throw v.createInvalidParameter(i);
              return n.$;
            };
          },
        ...
        q = (e.tableauSoftware.Mark = t.mkType(
          ...
          function (e) {
            (this.impl = null), (this.impl = new z(e));
          },
          {
            getPairs: function () {
        ...
        B = (e.tableauSoftware.Pair = t.mkType(
          n,
      ...
      t.initClass(r),
        ...
        t.initClass(q),
        t.initClass(B),
        (s.crossDomainEventNotificationId = 'xdomainSourceId'),
        (s.lastRequestMessage = null),
        (s.lastResponseMessage = null),
        (s.lastClientInfoResponseMessage = null),
        (s.$nextCommandId = 0),
        (E = window._ApiObjectRegistryGlobalState),
        t.isNullOrUndefined(E) && (E = new Object()),
        (window._ApiObjectRegistryGlobalState = E),
        ...
        (p.$dateType = 'date'),
        (p.$functionType = 'function'),
        (p.$numberType = 'number'),
        (p.$objectType = 'object'),
        (p.$regExpType = 'regexp'),
        (p.$stringType = 'string'),
        (p.$class2type = t.mkdict([
          '[object Boolean]',
          p.$booleanType,
          '[object Number]',
          p.$numberType,
        ...
        (p.$trim = t.cast(String.prototype.trim, Function)),
        (p.$toString = t.cast(Object.prototype.toString, Function)),
        (p.$trimLeft = new RegExp('^[\\s\\xA0]+')),
        (p.$trimRight = new RegExp('[\\s\\xA0]+$')),
        (p.$rvalidchars = new RegExp('^[\\],:{}\\s]*$')),
        (p.$rvalidescape = new RegExp(
          '\\\\(?:["\\\\\\/bfnrt]|u[0-9a-fA-F]{4})',
          'g',
        )),
        (p.$rvalidtokens = new RegExp(
          '"[^"\\\\\\n\\r]*"|true|false|null|-?\\d+(?:\\.\\d*)?(?:[eE][+\\-]?\\d+)?',
          'g',
        )),
        (p.$rvalidbraces = new RegExp('(?:^|:|,)(?:\\s*\\[)+', 'g')),
        ((A = e.tableauSoftware).DeviceType = {
          DEFAULT: 'default',
          DESKTOP: 'desktop',
          TABLET: 'tablet',
          PHONE: 'phone',
        ...
        (A.ToolbarPosition = { TOP: 'top', BOTTOM: 'bottom' }),
        (A.ToolbarButtonName = { REDO: 'redo', UNDO: 'undo' });
    })(),
    /*! API */
    (function () {
      var n = {};
      ...
      var r = t.mkType(
        ...
        a = t.mkType(n, 'tab.$DashboardZoneInfo', null, null, {
          isInstanceOfType: function () {
            return !0;
          },
        }),
        ...
        o = t.mkType(n, 'tab.$HighlightEventContext', function (e, t) {
          T.call(this, e, t);
        }),
        l = t.mkType(n, 'tab.$MarksEventContext', function (e, t) {
          T.call(this, e, t);
        }),
        u = t.mkType(
          n,
        ...
        h = (e.tab._ApiBootstrap = t.mkType(
          n,
          'tab._ApiBootstrap',
          null,
          null,
        ...
        m = t.mkType(
          ...
          },
          {
            ...
            $saveAsync: function () {
              ...
              var r = m.$createCustomViewCommandReturnHandler(
          ...
          },
          {
            ...
            _saveNewAsync: function (e, n, r) {
              ...
              return n.sendCommand(Object).call(n, s, o), a.get_promise();
            },
            _showCustomViewAsync: function (e, n, r) {
              var a = new i._Deferred(),
                s = {};
              t.isValue(r) && (s['api.customViewParam'] = r);
              var o = m.$createCustomViewCommandReturnHandler(
            ...
            _makeCurrentCustomViewDefaultAsync: function (e, t) {
              var n = new i._Deferred(),
                r = m.$createCustomViewCommandReturnHandler(
            ...
            _getCustomViewsAsync: function (e, n) {
              ...
              return n.sendCommand(Object).call(n, null, a), r.get_promise();
            },
            _processCustomViews: function (e, t, i) {
              m._processCustomViewUpdate(e, t, i, !1);
            },
            _processCustomViewUpdate: function (e, n, r, a) {
              if (
                ...
                a &&
                  ...
                  t.isValue(r.newView) &&
                    m.$processOneCustomViewUpdate(e, n, r, r.newView, a)),
                t.isValue(r.customViews))
              )
                for (var s = 0; s < r.customViews.length; s++) {
                  var o = r.customViews[s];
                  m.$processOneCustomViewUpdate(e, n, r, o, a);
                }
            },
            $processOneCustomViewUpdate: function (e, i, n, r, a) {
              var s = null,
                o = null;
              t.isValue(n.currentView) &&
                ((s = n.currentView.name),
                (o = n.currentView.owner.friendlyName));
              var l = n.defaultCustomViewId,
                u = m._createNew(e, i, r, l),
                c = u.get_$name();
              e.get_$customViews()._has(c) && (c += '/' + r.owner),
        ...
        d = (e.tab._DashboardImpl = t.mkType(
          n,
          'tab._DashboardImpl',
          function (e, t, n) {
            (this.$dashboard = null),
              ...
              for (var r = 0; r < e.length; r++) {
                ...
                if ('worksheet' === e[r].objectType) {
                  ...
                  var l = this.$worksheets.get__length(),
                    u = i.SheetSizeFactory.createAutomatic(),
                    c = n(o),
                ...
                var f = new Q(a, this.get_dashboard(), s);
                this.$dashboardObjects._add(r.toString(), f);
              }
            },
          },
        )),
        p = (e.tab._DataSourceImpl = t.mkType(
          n,
          'tab._DataSourceImpl',
          function (e, t) {
            (this.$name = null),
          ...
          },
          {
            processDataSource: function (e) {
              for (
                var n = new p(e.name, e.isPrimary),
                ...
                var s = r[a],
                  o = i.ApiEnumConverter.convertFieldRole(s.role),
                  l = i.ApiEnumConverter.convertFieldAggregation(s.aggregation),
                  u = new K(n.get_dataSource(), s.name, o, l);
                n.addField(u);
              }
              return n;
            },
            processDataSourcesForWorksheet: function (e) {
              for (
                ...
                s.isPrimary ? (r = o) : n._add(s.name, o.get_dataSource());
              }
              return (
        ...
        g = (e.tab._SheetInfoImpl = t.mkType(
          n,
          'tab._SheetInfoImpl',
          null,
          null,
          ...
          },
          {
            ...
            update: function (e) {
              ...
              for (var r = 0; r < e.storyPoints.length; r++) {
                var a = e.storyPoints[r],
                  ...
                  l = y.$ctor(s, r, a.storyPointId, o, a.isUpdated, this);
              ...
              if (h) {
                var d = v.createContainedSheet(
                  i,
                  this.get_workbookImpl(),
                  this.get_messagingOptions(),
                  this.$findSheetFunc,
                );
                this.$activeStoryPointImpl = new v(n, d);
              } else
            ...
            $updateActiveState: function (e) {
              ...
              if (t.get_index() !== i) {
                ...
                (r.isActive = !0),
                  (this.$activeStoryPointImpl = new v(r, a)),
                  t.set_isActive(!1),
                  (n._impl.isActive = !1),
                  this.$raiseActiveStoryPointChange(
                    n,
        ...
        v = (e.tab._StoryPointImpl = t.mkType(
          n,
          'tab._StoryPointImpl',
          function (e, i) {
            if (
              ...
              for (
                var n = t.cast(this.$containedSheetImpl, d), r = 0;
          ...
          },
          {
            createContainedSheet: function (e, n, r, a) {
              if (t.isNullOrUndefined(e) || t.isNullOrUndefined(e.name))
                return null;
              var s = i.ApiEnumConverter.convertSheetType(e.sheetType),
                o = i.SheetSizeFactory.createAutomatic(),
                l = a(e.name),
        ...
        y = (e.tab._StoryPointInfoImpl = t.mkType(
          n,
        ...
        _ = (e.tab._ToolbarStateImpl = t.mkType(
          n,
        ...
        w = t.mkType(n, 'tab._VizManagerImpl', null, null, {
          ...
          $verifyVizNotAlreadyParented: function (e) {
            for (
              var n = e.getParentElement(), r = 0, a = w.$vizs.length;
              r < a;
              r++
            )
              if (t.referenceEquals(w.$vizs[r].getParentElement(), n)) {
                var s =
        ...
        b = (e.tab._VizParameters = t.mkType(
          n,
          'tab._VizParameters',
          function (e, n, r) {
            if (
        ...
        S = (e.tab._WorkbookImpl = t.mkType(
          n,
          'tab._WorkbookImpl',
          function (e, t, n) {
            (this.$workbook = null),
          ...
          },
          {
              ...
              if (
                ...
                if (t.isValue(this.$activatingHiddenSheetImpl)) {
                  ...
                  for (
                    ...
                    if (t.referenceEquals(e.publishedSheets[l].name, n)) {
                  ...
                  if ('dashboard' === o.sheetType) {
                    var h = new d(r.$impl, this, this.$messagingOptions);
              ...
              if (!t.isNullOrUndefined(n))
                for (var r = 0; r < n.length; r++) {
                  var a = n[r],
                    ...
                    l = S.$createSheetSize(a);
                  if (t.isNullOrUndefined(o)) {
                    var u = t.referenceEquals(s, e.currentSheetName),
                      c = i.ApiEnumConverter.convertSheetType(a.sheetType),
                      h = g.$ctor(
                        s,
                        c,
                        r,
                    ...
                    (o = new ne(h)), this.$publishedSheetsInfo._add(s, o);
                  } else o.$impl.size = l;
                }
            },
            ...
            $getSingleParameterAsync: function (e) {
              ...
              var r = new (t.makeGenericType(i.CommandReturnHandler$1, [
                ...
                0,
                t.mkdel(this, function (t) {
                  var i = S.$findAndCreateParameterImpl(e, t);
        ...
        C = (e.tab._WorksheetImpl = t.mkType(
          n,
          'tab._WorksheetImpl',
          function (e, t, n, r) {
            (this.$worksheet = null),
          ...
          },
          {
            ...
            $selectMarksWithValuesAsync: function (e, n, r, a, s, o, l, u) {
              ...
              var _ = new i._Deferred(),
                w = new (t.makeGenericType(i.CommandReturnHandler$1, [Object]))(
                  'api.SelectMarksCommand',
                  0,
                  function (e) {
                    var i = C.$createSelectionCommandError(e);
                    t.isNullOrUndefined(i) ? _.resolve() : _.reject(i);
                  },
                  function (e, t) {
                    _.reject(i._TableauException.createServerError(t));
                  },
                );
              return this.sendCommand(Object).call(this, c, w), _.get_promise();
            },
        ...
        I = (e.tab.CustomViewEvent = t.mkType(
          ...
          function (e, t, i) {
            (this.$context = null),
              x.call(this, e, t),
              (this.$context = new r(t._impl.get__workbookImpl(), i));
          },
          {
        ...
        k = (e.tab.FilterEvent = t.mkType(
          ...
          function (e, t, i, n, r) {
            (this.$filterCaption = null),
              ...
              (this.$context = new s(t._impl.get__workbookImpl(), i, n, r));
          },
          {
            getFieldName: function () {
              return this.$filterCaption;
        ...
        E = (e.tab.FirstVizSizeKnownEvent = t.mkType(
          n,
        ...
        A = (e.tab.HighlightEvent = t.mkType(
          n,
          'tab.HighlightEvent',
          function (e, t, i) {
            (this.$context = null),
        ...
        R = (e.tab.ParameterEvent = t.mkType(
          n,
          'tab.ParameterEvent',
          function (e, t, i) {
            (this.$context = null),
        ...
        D = (e.tab.StoryPointInfoImplUtil = t.mkType(
          n,
        ...
        z = (e.tab.StoryPointSwitchEvent = t.mkType(
          n,
        ...
        P = (e.tab.TabSwitchEvent = t.mkType(
          n,
          'tab.TabSwitchEvent',
          function (e, t, i, n) {
            (this.$oldName = null),
            ...
            $handleMarksHighlightChangedEvent: function (e) {
              if (
                ...
                t.isValue(i) &&
                  ...
                  this.$1$MarksHighlightField(
                    new A('markshighlight', this.$viz, i),
                  ));
              }
            },
              ...
              if (
                ...
                if (t.isValue(i)) {
                  var a = t.cast(
                    ...
                    o = a[1];
                  this.$1$FilterChangeField(
                    new k('filterchange', this.$viz, i, s, o),
                  );
                }
              }
            },
              ...
              (this.$vizSize = j.$ctor(n, e.chromeHeight)),
                t.isValue(this.$onFirstVizSizeKnownCallback) &&
                  this.$onFirstVizSizeKnownCallback(
                    new E('firstvizsizeknown', this.$viz, this.$vizSize),
                  ),
                this.$parameters.fixedSize ||
                  (this.$refreshSize(),
        ...
        q = (e.tableauSoftware.CustomView = t.mkType(
          n,
        ...
        B = (e.tableauSoftware.Dashboard = t.mkType(
          n,
      ...
      t.initClass(T),
        ...
        t.initClass(d, f),
        t.initClass(p),
        t.initClass(g, Object),
        t.initClass($, f),
        t.initClass(v),
        t.initClass(y, Object),
        t.initClass(_),
        t.initClass(w),
        t.initClass(b),
        t.initClass(S),
        ...
        (le.$currentVersion = new le(2, 4, 0, 'null'));
    })(),
